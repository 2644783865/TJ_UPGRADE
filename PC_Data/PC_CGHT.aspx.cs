        ...
        private void rptControl()//控制repeater的汇总和影藏项
        {
            ...
            if (rptDD.Items.Count > 0)
            {
                ...
                foreach (RepeaterItem item in rptDD.Controls)
                {
                    ...
                    {
                        if (username != "董治收" && username != "王福泉" && username != "姜中毅" && username != "赵宏观" && username != "周文轶" && username != lb_HT_ZDR.Text && username != "李洪清" && username != "于来义" && username != "曹卫亮" && username != "叶宝松" && username != "李利恒" && username != "陈永秀" && username != "李小婷")
                        {
