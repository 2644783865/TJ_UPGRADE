<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_Data_addto_list.aspx.cs"
    MasterPageFile="~/Masters/PopupBase.Master" Title="追加订单" Inherits="ZCZJ_DPF.PC_Data.PcJs.PC_Data_addto_list" %>
                    ...
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="orderno" HeaderText="单据编号" ItemStyle-HorizontalAlign="Center" />
                                ...
                                <asp:BoundField DataField="zdtime" HeaderText="制单日期" ItemStyle-HorizontalAlign="Center" />
                                <asp:TemplateField HeaderText="供应商" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="supplierid" runat="server" Text='<%#Eval("supplierid")%>' Visible="false"></asp:Label>
                                        <asp:Label ID="suppliernm" runat="server" Text='<%#Eval("suppliernm")%>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                            </Columns>
