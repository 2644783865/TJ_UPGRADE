<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_Date_chaifen.aspx.cs" Inherits="ZCZJ_DPF.PC_Data.PC_Date_chaifen"  MasterPageFile="~/Masters/PopupBase.Master" Title="物料拆分"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script src="PcJs/rowcolor.js" type="text/javascript" charset="GB2312" language="javascript">
       ...
       <div class="cpbox xscroll">
                        ...
                        <tr id="row" runat="server" class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" >
                               <td>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="PUR_RPNUM" AutoPostBack="true"  OnTextChanged="LinkButton1_Click" runat="server"  Text='<%#Eval("rpnum")%>' Width="70px"></asp:TextBox>
                                      

                                </td>
                                <td id="rpfznum2" runat="server">
                                    <%--<asp:Label ID="PUR_RPFZNUM" runat="server" Text='<%#Eval("rpfznum")%>'></asp:Label>--%>
                                    <asp:TextBox ID="PUR_RPFZNUM" AutoPostBack="true" OnTextChanged="LinkButton2_Click" runat="server" Text='<%#Eval("rpfznum")%>' Width="70px"></asp:TextBox>
            ...
            <tr>
            <td align="center">
                <asp:Button ID="btn_marclose" runat="server" Text="行关闭" onclick="btn_marclose_Click"  Visible="false"/>
                <asp:Button ID="btn_confirm" runat="server" Text="拆分" onclick="btn_confirm_Click" />
                 &nbsp; &nbsp; &nbsp;
