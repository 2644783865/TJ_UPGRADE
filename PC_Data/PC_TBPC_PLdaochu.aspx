<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_TBPC_PLdaochu.aspx.cs"
    Inherits="ZCZJ_DPF.PC_Data.PC_TBPC_PLdaochu" MasterPageFile="~/Masters/PopupBase.Master"
    Title="批量导出" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div>
        ...
        <table width="100%">
            <tr align="center">
                <td>
                    <asp:Button ID="btn_daochu" runat="server" Text="导出订单明细" ForeColor="Blue" OnClick="btn_daochu_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btn_weidaohuo" runat="server" Text="导出尚未到货明细清单" ForeColor="DarkBlue"
                        OnClick="btn_weidaohuo_Click" />
                </td>
            </tr>
        </table>
    </div>
