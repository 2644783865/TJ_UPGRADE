<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.Master" CodeBehind="PC_TBPC_Otherpur_Bill_Audit.aspx.cs" Inherits="ZCZJ_DPF.PC_Data.PC_TBPC_Otherpur_Bill_Audit" %>
            ...
            <div class="RightContent">
                <div class="box-inner">
                            ...
                            <table width="100%">
                                <tr>
                                    <td>
                                        ...
                                        &nbsp;&nbsp;
                                        项目名称：
                                        <asp:TextBox ID="tb_pjinfo" runat="server" OnTextChanged="tb_pjinfo_Textchanged" AutoPostBack="True"></asp:TextBox>
                 ...
                 CompletionListItemCssClass="autocomplete_listItem"  CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem" >
                                        ...
                                        &nbsp;&nbsp;
                                        设备名称：
                                        <asp:TextBox ID="tb_enginfo" runat="server" OnTextChanged="tb_enginfo_Textchanged" AutoPostBack="True"></asp:TextBox>
                            ...
                            <asp:Repeater ID="tbpc_otherpurbill_list_Repeater" runat="server" OnItemDataBound="tbpc_otherpurbill_list_Repeater_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                        ...
                                        <td>
                                            <asp:Label ID="MP_PCODE" runat="server" Text='<%#Eval("MP_PCODE")%>'></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="PJ_NAME" runat="server" Text='<%#Eval("MP_ENGID")%>'></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="SUBMITTM" runat="server" Text='<%#Eval("MP_SUBMITTM")%>'></asp:Label>
                                        </td>
