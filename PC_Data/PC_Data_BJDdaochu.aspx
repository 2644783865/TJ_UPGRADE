<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_Data_BJDdaochu.aspx.cs" Inherits="ZCZJ_DPF.PC_Data.PC_Data_BJDdaochu"   MasterPageFile="~/Masters/PopupBase.Master"  Title="比价单导出"%>
...
<script src="../JS/DatePicker.js" type="text/javascript" charset="GB2312"></script>
    ...
    <tr>
       <td align="center" colspan="8">
          状态：
          <asp:RadioButton ID="rad_quanbu" runat="server" Text="全部" TextAlign="Right" GroupName="select" Checked="true" />&nbsp;
          <asp:RadioButton ID="rad_weitijiao" runat="server" Text="未审核" TextAlign="Right" GroupName="select" />&nbsp;
          <asp:RadioButton ID="rad_shz" runat="server" Text="审核中" TextAlign="Right" GroupName="select" />&nbsp;
          <asp:RadioButton ID="rad_bh" runat="server" Text="驳回" TextAlign="Right" GroupName="select" />&nbsp;
          <asp:RadioButton ID="rad_tg" runat="server" Text="通过" TextAlign="Right" GroupName="select" />&nbsp;
       </td>
    </tr>
    </table>
    <table width="100%">
