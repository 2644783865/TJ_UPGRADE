<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="PC_ZHAOBIAOQUERY.aspx.cs" Inherits="ZCZJ_DPF.PC_Data.PC_ZHAOBIAOQUERY" Title="招标物料管理" %>
                    ...
                    <table width="100%">
                        <tr>
                            <td align="right" style="display:none">
                                ...
                                <input id="btn_PLdaochu" type="button" value="批量导出" onclick="PLdaochu()" />&nbsp;
                                 &nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td style="display:none">
                                ...
                                <asp:RadioButton ID="rad_all" runat="server" Text="全部单据" TextAlign="Right" GroupName="select00"
                                    OnCheckedChanged="rad_all_CheckedChanged" AutoPostBack="true" Checked="true" />&nbsp;
                                <asp:RadioButton ID="rad_mypart" runat="server" Text="我的任务" TextAlign="Right" GroupName="select00"
                                    OnCheckedChanged="rad_mypart_CheckedChanged" AutoPostBack="true" />&nbsp;
                            ...
                            <td>
                                <asp:RadioButton ID="rad_quanbu" runat="server" Text="全部" TextAlign="Right" GroupName="select"
                                    OnCheckedChanged="rad_quanbu_CheckedChanged" AutoPostBack="true" Checked="true" />&nbsp;
                                ...
                                <asp:RadioButton ID="rad_shenhezhong" runat="server" Text="审核中" TextAlign="Right"
                                    ...
                                    /><asp:Label runat="server" ID="WarnNum" ForeColor="Red" Visible="false"></asp:Label>&nbsp;
                            ...
                            <td>
                                <asp:CheckBox ID="chk_zhaobiao" runat="server" Text="招标物料" AutoPostBack="true" Checked="true" OnCheckedChanged="chk_zhaobiao_CheckedChanged" />
            ...
            <div>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tb_Gongyingshang" runat="server" Width="200px"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="tb_StartTime" runat="server" Width="150px"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="tb_EndTime" runat="server" Width="150px"></asp:TextBox>
                                <asp:CalendarExtender DaysModeTitleFormat="MM月,yyyy年" TodaysDateFormat="yyyy年MM月dd日"
