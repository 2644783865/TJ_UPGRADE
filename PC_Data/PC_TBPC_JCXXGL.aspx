<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="PC_TBPC_JCXXGL.aspx.cs" Inherits="ZCZJ_DPF.PC_Data.PC_TBPC_JCXXGL" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div class="RightContent">
        <div class="box-inner">
            <div class="box_right" visible="false">
                <div class="box-title" visible="false">
                    <table width="100%" visible="false">
                        <tr>
                            <td align="right">
                                <asp:Button ID="btn_AddHTSP" runat="server" Text="添加合同审批" ForeColor="DodgerBlue"
                                    Font-Bold="true" OnClick="btn_AddHTSP_Click"  Visible="false"/>&nbsp;
                                ...
                                <asp:Button ID="btn_PLdaochu" runat="server" Text="批量导出" OnClientClick="PLdaochu()"  Visible="false"/>&nbsp;
                                <asp:Button ID="btn_baojian" runat="server" Text="报检" OnClick="btn_baojian_Click"  Visible="false"/>&nbsp;
                                <asp:Button ID="btn_mianjian" runat="server" Text="免检" OnClick="btn_mianjian_Click"
                                    OnClientClick="return confirm('你确定提交吗?');"  Visible="false"/>&nbsp;
                ...
                <div class="box-title">
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                是否集采
                                <asp:RadioButton ID="rad_suoyou" runat="server" Text="全部" TextAlign="Right" GroupName="select01"
                                    OnCheckedChanged="rad_suoyou_CheckedChanged" AutoPostBack="true" />
                                &nbsp;
                                <asp:RadioButton ID="rad_jicai" runat="server" Text="集采" TextAlign="Right" GroupName="select01"
                                    OnCheckedChanged="rad_jicai_CheckedChanged" AutoPostBack="true" Checked="true" />&nbsp;
                                <asp:RadioButton ID="rad_fjicai" runat="server" Text="非集采" TextAlign="Right" GroupName="select01"
                                    OnCheckedChanged="rad_fjicai_CheckedChanged" AutoPostBack="true" />&nbsp;
                            </td>
                            <td>
                                ...
                                <asp:RadioButton ID="rad_weidaohuo" runat="server" Text="未到货" TextAlign="Right" GroupName="select"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="DropDownList2" runat="server">
                                        ...
                                        <asp:ListItem Text="板"></asp:ListItem>
                                        <asp:ListItem Text="采"></asp:ListItem>
                                        <asp:ListItem Text="采购成品"></asp:ListItem>
                                        <asp:ListItem Text="定尺板"></asp:ListItem>
                                        <asp:ListItem Text="锻"></asp:ListItem>
                                        <asp:ListItem Text="非"></asp:ListItem>
                                        <asp:ListItem Text="非定尺板"></asp:ListItem>
                                        <asp:ListItem Text="型"></asp:ListItem>
                                        <asp:ListItem Text="型材"></asp:ListItem>
                                        <asp:ListItem Text="油漆"></asp:ListItem>
                                        <asp:ListItem Text="圆"></asp:ListItem>
                                        <asp:ListItem Text="铸"></asp:ListItem>
