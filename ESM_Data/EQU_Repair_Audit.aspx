<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.Master"
    CodeBehind="EQU_Repair_Audit.aspx.cs" Inherits="ZCZJ_DPF.ESM_Data.EQU_Repair_Audit" %>
                ...
                <div class="box-wrapper">
                    <div class="box-outer">
                        <table width="100%" align="center" class="nowrap cptable fullwidth">
                            <asp:Repeater ID="EQU_Repair_Audit_Repeater" runat="server" OnItemDataBound="EQU_Repair_Audit_Repeater_ItemDataBound">
                                <HeaderTemplate>
