<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="EQU_ApplyDetail.aspx.cs" Inherits="ZCZJ_DPF.ESM.EQU_ApplyDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    {
        i = window.showModalDialog('EQU_Persons.aspx', '', "dialogHeight:400px;dialogWidth:660px;status:no;scroll:no;center:yes;toolbar=no;menubar=no");
        if(i!=null)
        {
            array = i.split(' ');
                        ...
                        <ContentTemplate>
                            <table id="Table1" align="center" cellpadding="4" cellspacing="1" runat="server"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTime1" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtshr" runat="server" Width="150px"></asp:TextBox><input id="shrid"
                                            type="text" runat="server" readonly="readonly" style="display: none" />
                                        <asp:HyperLink ID="hlSelect0" runat="server" CssClass="hand" OnClick="SelTechPersons0()">
                                            <asp:Image ID="AddImage0" ImageUrl="~/Assets/images/h1.gif" border="0" hspace="2"
                                                align="absmiddle" runat="server" />选择</asp:HyperLink><span id="span2" runat="server"
                                                    visible="false" class="Error">*</span>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="请选择审批人！"
                        ...
                        <ContentTemplate>
                            <div class="box-wrapper">
                                ...
                                <div class="box-outer">
                                            ...
                                            <td colspan="3">
                                                <table width="100%" cellpadding="4" cellspacing="1" border="1">
                                                    <tr style="height: 25px">
                                                        ...
                                                        <td style="width: 20%">
                                                            <asp:TextBox ID="txt_first" runat="server" Width="80px"></asp:TextBox><input id="firstid"
                                                                type="text" runat="server" readonly="readonly" style="display: none" />
                                                            <asp:HyperLink ID="hlSelect1" runat="server" CssClass="hand" onClick="SelTechPersons1()">
                                                                <asp:Image ID="AddImage1" ImageUrl="~/Assets/images/h1.gif" border="0" hspace="2"
                                                                    align="absmiddle" runat="server" />选择</asp:HyperLink>
                                                        </td>
                                                        <td align="center" style="width: 10%">
                                                            审核结论
                                                        </td>
                                            ...
                                            <td colspan="3">
                                                <table width="100%" cellpadding="4" cellspacing="1" border="1">
                                                    <tr style="height: 25px">
                                                        ...
                                                        <td style="width: 20%">
                                                            <asp:TextBox ID="txt_second" runat="server" Width="80px"></asp:TextBox><input id="secondid"
                                                                type="text" runat="server" readonly="readonly" style="display: none" />
                                    ...
                                    <asp:Label ID="lblState" runat="server" Text="" Visible="true"></asp:Label></div>
                            </div>
                        </ContentTemplate>
                    </cc1:TabPanel>
                </cc1:TabContainer>
