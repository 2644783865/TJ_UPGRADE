<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_WarehouseIn_Other_Manage.aspx.cs" MasterPageFile="~/Masters/SMBaseMaster.Master" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseIn_Other_Manage" Title="其他入库管理" %>
...
function ActivateAlertDiv(visstring, elem, msg){
 ...
 function tostorage() {
        ...
        window.open("SM_WarehouseIn_Other.aspx?FLAG=PUSHIN&id="+time,"pop","");
    }
    ...
    function chakan(tr) {
        ...
        window.open("SM_WarehouseIn_Other.aspx?FLAG=OPEN&&ID=" + id);
...
function inexport() {
     var date=new Date();
        var time=date.getTime();
        var retVal = window.showModalDialog("SM_WarehouseIn_Export.aspx?action=other&id="+time, "", "dialogWidth=900px;dialogHeight=600px;help=no;scroll=yes");
    }
                ...
                <table width="98%">
                    <tr>
                        <td align="right">
                            ...
                            <input id="btn1" type="button" value="其他入库" onclick="tostorage();" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelCondition" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <table width="98%" style="background-color: #CCCCFF; border: solid 1px black;">
                                ...
                                <tr>
                                    <td style="white-space: nowrap; width: 18%;" align="left">
                                        &nbsp;审&nbsp;核&nbsp;状&nbsp;态：
                                ...
                                <tr>
                                 <td style="width:50%;" colspan="2">
                                     <table>
                                        <tr>
                                            <td style="white-space: nowrap;" align="left">
                                               入库单编号：<asp:TextBox ID="TextBoxCodeWG" runat="server"></asp:TextBox>
                                            </td>
                                            <td style="white-space: nowrap; " align="left">
                                          ...
                                          <tr>
                                           <td style="white-space: nowrap; " align="left">
                                                物&nbsp;料&nbsp;编&nbsp;码：<asp:TextBox ID="TextBoxMCodeWG" runat="server"></asp:TextBox>
                                            </td>
                                            <td style="white-space: nowrap;" align="left">
                                                物&nbsp;料&nbsp;名&nbsp;称：<asp:TextBox ID="TextBoxMNameWG" runat="server"></asp:TextBox>
                                             </td>  
                                          </tr>
                                          <tr>
                                            <td style="white-space: nowrap;" align="left">
                                            ...
                                            <td style="white-space: nowrap; " align="left">
                                                规&nbsp;格&nbsp;型&nbsp;号：<asp:TextBox ID="TextBoxMStandardWG" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="white-space: nowrap; " align="left">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;批&nbsp;&nbsp;&nbsp;&nbsp;号：<asp:TextBox ID="TextBoxLotNum" runat="server"></asp:TextBox>
                                            </td>
                                            <td style="white-space: nowrap;" align="left">
                                                实&nbsp;收&nbsp;数&nbsp;量：<asp:TextBox ID="TextBoxSHnum" runat="server"></asp:TextBox>
                                           
                                            </td>
                                          </tr>
                                          <tr>
                                            <td style="white-space: nowrap; " align="left">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单&nbsp;&nbsp;&nbsp;&nbsp;价：<asp:TextBox ID="TextBoxUprice" runat="server"></asp:TextBox>
                                         ...
                                         <tr>
                                            ...
                                            <td style="white-space: nowrap; " align="left">
                                                制&nbsp;单&nbsp;日&nbsp;期：<asp:TextBox ID="TextBoxDateWG" runat="server"></asp:TextBox>
                                           ...
                                           <tr>
                                            <td style="white-space: nowrap;" align="left">
                                                &nbsp;审&nbsp;&nbsp;核&nbsp;&nbsp;人：
                                                <asp:TextBox ID="TextBoxVerifier" runat="server"></asp:TextBox>
                                            </td>
                                            <td style="white-space: nowrap; " align="left">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备&nbsp;&nbsp;&nbsp;&nbsp;注：<asp:TextBox ID="TextBoxNote" runat="server"></asp:TextBox>                                               
                                            </td>
                                           </tr>
                                           <tr>                                            
                                            <td style="white-space: nowrap;" align="left">
                                                开&nbsp;始&nbsp;日&nbsp;期：<asp:TextBox ID="TextBoxStartDate" runat="server"></asp:TextBox>
                                                <cc1:CalendarExtender ID="TextBoxStartDate_CalendarExtender" runat="server" Format="yyyy-MM-dd"
                                                    TargetControlID="TextBoxStartDate">
                                                </cc1:CalendarExtender>
                                            </td>
                                            <td style="white-space: nowrap;" align="left">
                                                截&nbsp;至&nbsp;日&nbsp;期：<asp:TextBox ID="TextBoxEndDate" runat="server"></asp:TextBox>
                                         ...
                                         <tr>
                                            <td style="white-space: nowrap;" align="left">
                                               收&nbsp;料&nbsp;仓&nbsp;库：<asp:DropDownList ID="drp_Warhouse" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drp_Warhouse_Changed"></asp:DropDownList>
                                            </td>
                                            <td style="white-space: nowrap; " align="left">
