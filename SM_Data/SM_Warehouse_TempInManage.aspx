<%@ Page Language="C#" MasterPageFile="~/Masters/SMBaseMaster.master" AutoEventWireup="true"
    CodeBehind="SM_Warehouse_TempInManage.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_Warehouse_TempInManage"
    Title="结转备库" %>
...
function ActivateAlertDiv(visstring, elem, msg){
 ...
 function tostorage() {
        ...
        window.open("SM_Warehouse_TempIn.aspx?FLAG=PUSHIN&id="+time,"pop","");
    }
    ...
    function chakan(tr) {
        ...
        window.open("SM_Warehouse_TempIn.aspx?FLAG=OPEN&&ID=" + id);
...
function inexport() {
     var date=new Date();
        var time=date.getTime();
        var retVal = window.showModalDialog("SM_WarehouseIn_Export.aspx?action=bk&id="+time, "", "dialogWidth=900px;dialogHeight=600px;help=no;scroll=yes");
    }
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <cc1:ModalPopupExtender ID="ModalPopupExtenderSearch" runat="server" TargetControlID="btnShowPopup"
                             ...
                             <input id="InExport" type="button" value="导出" onclick="inexport()" runat="server" visible="false"/>
                            <asp:Button ID="BtnShowExport" runat="server" Text="导出" OnClick="BtnShowExport_Click"/>&nbsp;&nbsp;&nbsp;
                            <input id="btn1" type="button" value="备库入库" onclick="tostorage();" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
                                   ...
                                   <td  valign="top" colspan="2" style="width:50%">
                                      <table width="100%">
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;物料编码：<asp:TextBox ID="TextBoxMCodeWG" runat="server"></asp:TextBox>
                                            </td>
                                         </tr>
                                         <tr>
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                            ...
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;规格型号：<asp:TextBox ID="TextBoxMStandardWG" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                            ...
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;实收数量：<asp:TextBox ID="TextBoxSHnum" runat="server"></asp:TextBox>
                                         ...
                                         <tr>
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单&nbsp;&nbsp;&nbsp;&nbsp;价：
                                                <asp:TextBox ID="TextBoxUprice" runat="server"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;制单日期：<asp:TextBox ID="TextBoxDateWG" runat="server"></asp:TextBox>
                                         ...
                                         <tr>
                                            ...
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;截至日期：<asp:TextBox ID="TextBoxEndDate" runat="server"></asp:TextBox>
                                         ...
                                         <tr>
                                            <td style="white-space: nowrap; width: 25%;" align="left">
                                                &nbsp;收&nbsp;料&nbsp;仓&nbsp;库：
                                               <asp:DropDownList ID="drp_Warhouse" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drp_Warhouse_Changed"></asp:DropDownList>                                            </td>
                                            <td style="white-space: nowrap; width: 25%;" align="left">
