<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_WarehouseIN_WG_WTB.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseIN_WG_WTB"
   MasterPageFile="~/Masters/SMBaseMaster.Master" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkRN(tb)
        {
            ...
            if (isNaN(realnum))
            {
                ...
                realnum = tb.value;
                var par = tb.parentNode.parentNode;
                var unitprice = parseFloat(par.getElementsByTagName("td")[15].getElementsByTagName("input")[0].value); //单价
                var ctup = parseFloat(par.getElementsByTagName("td")[17].getElementsByTagName("span")[0].innerHTML); //含税单价

                var amount = par.getElementsByTagName("td")[18].getElementsByTagName("input")[0]; //金额
                amount.value = (realnum * unitprice).toFixed(2);
                var cta = par.getElementsByTagName("td")[19].getElementsByTagName("input")[0]; //含税金额
            ...
            if ((color == "0") && (realnum < 0))
            {
                ...
                realnum = tb.value;
                var par = tb.parentNode.parentNode;
                var unitprice = parseFloat(par.getElementsByTagName("td")[15].getElementsByTagName("input")[0].value);
            ...
            if ((color == "1")&&(realnum>0))
            {
                ...
                realnum = tb.value;
                var par = tb.parentNode.parentNode;
                var unitprice = parseFloat(par.getElementsByTagName("td")[15].getElementsByTagName("span")[0].value);
                var ctup = parseFloat(par.getElementsByTagName("td")[17].getElementsByTagName("span")[0].ininputnerHTML);
            ...
            var par = tb.parentNode.parentNode;
            var unitprice = parseFloat(par.getElementsByTagName("td")[15].getElementsByTagName("input")[0].value); //单价 
            var ctup = parseFloat(par.getElementsByTagName("td")[17].getElementsByTagName("span")[0].innerHTML);//含税单价lable
        ...
        {           
            ...
            if (isNaN(unitprice))
            {
                ...
                var realnum = parseFloat(par.getElementsByTagName("td")[13].getElementsByTagName("input")[0].value);//数量
            ...
            else 
            {
                  ...
                  var taxrate=parseFloat(par.getElementsByTagName("td")[16].getElementsByTagName("span")[0].innerHTML);//税率
                  ...
                  if(isNaN(parseFloat(taxrate)))
                    ...
                    par.getElementsByTagName("td")[17].getElementsByTagName("span")[0].innerHTML=(unitprice*(1+taxrate/100)).toFixed(4);
                    
                    //含税金额
                    
                    par.getElementsByTagName("td")[19].getElementsByTagName("input")[0].value=(unitprice*(1+taxrate/100)*realnum).toFixed(2);
                 Statistic(); 
            }
            Statistic();
          ...
          if (isNaN(cost))
            {
                ...
                par.getElementsByTagName("td")[15].getElementsByTagName("input")[0].value= 0;//单价
           ...
           else 
            {
                  ...
                  par.getElementsByTagName("td")[15].getElementsByTagName("input")[0].value= (cost/realnum).toFixed(4);//单价
                  ...
                  if(isNaN(parseFloat(taxrate)))
                    ...
                    par.getElementsByTagName("td")[17].getElementsByTagName("span")[0].innerHTML=((cost/realnum)*(1+taxrate/100)).toFixed(4);
                    
                    //含税金额
                    
                    par.getElementsByTagName("td")[19].getElementsByTagName("input")[0].value=(cost*(1+taxrate/100)).toFixed(2);
                    ...
                    <tr>
                        <td align="left">
                           ...
                           <%-- <input id="btnSumPrint" runat="server" type="button" value="汇总打印" onclick="return btnPrint_onclick('sum')" />
                            ...
                            <asp:Button ID="btnorder" runat="server" Text="到订单" OnClick="torder_Click" Visible="false" />
                        ...
                        <td>
                           <%--<asp:UpdatePanel ID="UpdatePanelCompany" runat="server">
                                <ContentTemplate>--%>
                                    ...
                                    <cc1:AutoCompleteExtender ID="Company_AutoCompleteExtender" runat="server" CompletionSetCount="15"
                                    ...
                                    <asp:Button ID="btnthgys" runat="server" Text="替换" OnClick="replace_Click" />&nbsp;&nbsp;&nbsp;
                                <%--</ContentTemplate>
                            </asp:UpdatePanel>--%>
                        </td>
                    </tr>
                ...
                <yyc:SmartGridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="单价" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBoxUnitPrice" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "UnitPrice")%>' style="width: 60px" onkeyup="grControlFocus(this)" onblur="checkDJ(this)" ></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle Wrap="False" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="金额" HeaderStyle-Wrap="false" FooterStyle-Wrap="false" SortExpression="Amount">
                            <ItemTemplate>
                                <input type="text" id="InputAmount" value='<%#DataBinder.Eval(Container.DataItem, "Amount")%>'
                                     runat="server" style="width: 60px" onkeyup="grControlFocus(this)" onblur="checkJE(this)" />
                            </ItemTemplate>
                            <FooterTemplate>
