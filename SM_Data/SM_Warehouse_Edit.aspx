<%@ Page Language="C#" MasterPageFile="~/Masters/BaseMaster.master" AutoEventWireup="true" CodeBehind="SM_Warehouse_Edit.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_Warehouse_Edit" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <table width="100%" >
        <tr>
            <td>编辑仓库信息(带<span class="red">*</span>号的为必填项)</td>
        </tr>
    </table>
    </div>
    </div>
    ...
    <table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
        <tr>
            <td width="25%" height="25" align="right"> 仓库名称:</td>
        ...
        <tr>
            <td width="25%" height="25" align="right">上级仓库名称:</td>          
            ...
            <asp:RequiredFieldValidator ID="DropDownListParentRequiredFieldValidator" ControlToValidate="DropDownListParent" runat="server" ErrorMessage="上级仓库名不能为空"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
