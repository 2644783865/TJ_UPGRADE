<%@ Page Title="特殊退库" Language="C#" MasterPageFile="~/Masters/SMBaseMaster.Master"
    AutoEventWireup="true" CodeBehind="SM_WarehouseOUT_Red.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseOUT_Red" %>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td align="left" width="35%">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<asp:Label
                                    ID="LabelCode" runat="server" Style="display: none"></asp:Label>
                        ...
                        <tr>
                            <td align="left">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生产制号：
                                <asp:TextBox ID="TextBoxSCZH" runat="server" Width="170px" Enabled="false"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="批号" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"
                                ...
                                <ItemTemplate>
                                    <input id="ph" runat="server" style="border-style: none; width: 120px" type="text"
                                        value='<%#Eval("LotNumber") %>' onkeyup="grControlFocus(this)" onclick="getSelect(this)" />
                                </ItemTemplate>
