<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_Trans_GNFYEdit.aspx.cs"  MasterPageFile="~/Masters/BaseMaster.master" Inherits="ZCZJ_DPF.SM_Data.SM_Trans_GNFYEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <table class="edittable">
        ...
        <tbody>
            ...
            <tr>
                <td rowspan="2">运输合同</td>
                <td >合同编号</td>
                <td><asp:TextBox ID="TextBoxHTBH" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>合同金额</td>
                <td><asp:TextBox ID="TextBoxHTJE" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>车次</td>
                <td><asp:TextBox ID="TextBoxLLCC" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="TextBoxLLCCRequiredFieldValidator" runat="server" ErrorMessage="*" ControlToValidate="TextBoxLLCC"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td rowspan="2">过磅结算</td>
                <td>非大件重量（T）</td>
            ...
            <tr>
                <td colspan="2">最终结算金额（元）</td>
                <td><asp:TextBox ID="TextBoxZZJSJE" runat="server"></asp:TextBox>
