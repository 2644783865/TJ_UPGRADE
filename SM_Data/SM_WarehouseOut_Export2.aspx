<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_WarehouseOut_Export2.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseOut_Export2" %>
...
<script type="text/javascript" language="javascript">
    function closewin() {
      ...
      function DownloadFile() {
        var val = "SM_WarehouseOut_Export2.aspx?file=Files";
        ...
        <tr>
            ...
            <td>
                <asp:CheckBoxList ID="CheckBoxList1" runat="server">
                    <asp:ListItem Text="" Value="Code AS 委外出库单编号," Selected="True" Enabled="false"></asp:ListItem>
                </asp:CheckBoxList>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:CheckBoxList ID="CheckBoxList18" runat="server">
                    <asp:ListItem Text="" Value="RealNumber AS 实际发料重量," Selected="True" Enabled="false"></asp:ListItem>
                </asp:CheckBoxList>
            </td>
           ...
           <tr>
            ...
            <td>
                <asp:CheckBoxList ID="CheckBoxList2" runat="server">
                    <asp:ListItem Text="" Value="Company AS 加工单位," Selected="True"></asp:ListItem>
                </asp:CheckBoxList>
            </td>
            ...
            <td>
                <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" RepeatLayout="Table">
                    <asp:ListItem Text="升序" Value="Compangy ASC,"></asp:ListItem>
         ...
         <tr>
            ...
            <td>
                <asp:CheckBoxList ID="CheckBoxList4" runat="server">
                    <asp:ListItem Text="" Value="case when ProcessType=0 then '普通订单'  else '返修订单' end AS 委外类型," Selected="True"></asp:ListItem>
                </asp:CheckBoxList>
            </td>
