<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_WarehouseOut_Export.aspx.cs"
    Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseOut_Export" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="CheckBoxList25" runat="server">
                            <asp:ListItem Text="" Value="case when TotalNote='0' then '未选择' else TotalNote end AS 制作班组," Selected="True"></asp:ListItem>
                        </asp:CheckBoxList>
                    </td>
