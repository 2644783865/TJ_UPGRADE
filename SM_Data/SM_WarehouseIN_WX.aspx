<%@ Page Language="C#" MasterPageFile="~/Masters/SMBaseMaster.Master" AutoEventWireup="true"
    CodeBehind="SM_WarehouseIN_WX.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseIN_WX"
    Title="外委入库" %>
...
//                    par.getElementsByTagName("td")[16].getElementsByTagName("input")[0].value=(unitprice*(1+sl*0.01)).toFixed(4);//含税单价
                      ...
                      par.getElementsByTagName("td")[17].getElementsByTagName("input")[0].value=(num*unitprice*(1+sl*0.01)).toFixed(4);//含税金额
                   }
                   //单价
                   ...
                   if(tb==par.getElementsByTagName("td")[14].getElementsByTagName("input")[0])
                   {
                      if(num!=0)
                      {
                          ...
                          par.getElementsByTagName("td")[17].getElementsByTagName("input")[0].value=(je*(1+sl*0.01)).toFixed(4);//含税金额
                      }
                   }
        }
                ...
                <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnverity" runat="server" Text="审 核" CausesValidation="true" OnClick="Verify_Click" OnClientClick="ClientSideClick(this);" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <ContentTemplate>
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    &nbsp;&nbsp;&nbsp;仓&nbsp;&nbsp;&nbsp;位：
                                    <asp:DropDownList ID="DropDownListPosition" runat="server" AppendDataBoundItems="true"
                                        AutoPostBack="True" OnSelectedIndexChanged="DropDownListPosition_SelecedIndexChanged">
                            ...
                            <tr>
                                <td width="25%">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorCompany" runat="server" ErrorMessage="请填写供应商"
                                        ControlToValidate="TextBoxCompany"></asp:RequiredFieldValidator>
                                    <asp:AutoCompleteExtender ID="Company_AutoCompleteExtender" runat="server" CompletionSetCount="10"
                                        DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="getCompanyid"
            ...
            <asp:Panel ID="FooterPanel" runat="server" Width="100%">
                <table width="100%">
                    <tr>
                        ...
                        <td align="center" style="width: 25%;">
                            &nbsp;&nbsp;&nbsp;收&nbsp;&nbsp;&nbsp;料：<asp:DropDownList ID="DropDownListAccepter" runat="server">
                            </asp:DropDownList>
                         </td>
                    </tr>
                </table>
