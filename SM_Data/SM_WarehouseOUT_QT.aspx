<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SM_WarehouseOUT_QT.aspx.cs" Inherits="ZCZJ_DPF.SM_Data.SM_WarehouseOUT_QT" MasterPageFile="~/Masters/SMBaseMaster.Master"
Title="其他出库" %>
...
//            }
        ...
        function append() {
            var date=new Date();
            var time=date.getTime();
            var retVal = window.showModalDialog("SM_Warehouse_Query.aspx?FLAG=APPENDOUTQT&&id="+time,"", "dialogWidth=1200px;dialogHeight=750px;status=no;help=no;scroll=no");
            return retVal;
        }
...
//        }
    ...
    function tostorage() {
     var date=new Date();
        var time=date.getTime();
        window.open("SM_Warehouse_Query.aspx?FLAG=PUSHQTOUT&id="+time,'_self');
    }
                    ...
                    <tr>
                        <td>
                            ...
                            <%--<input id="OutStorage" type="button" value="生产领料单" onclick="outstorage()" runat="server" />--%>
                             ...
                             <asp:Button ID="ButtonSCHLL" runat="server" Text="生产领料单" OnClick="ButtonSCHLL_Click" Visible="false" />
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="font-size: x-large; text-align: center;"  colspan="2">
                            其他出库<asp:Image ID="ImageVerify" runat="server" ImageUrl="~/Assets/images/shenhe.gif"
                                Visible="false" /> &nbsp;&nbsp;&nbsp;
