<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MT_Index.aspx.cs" Inherits="ZCZJ_DPF.MT_Data.MT_Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
  <title>PMS项目管理系统-待办事宜</title>
</head>
<frameset id="mfrm" rows="70,*,5" cols="*" framespacing="0" frameborder="0" border="0" scrolling="yes">
		...
		<frameset rows="*" cols="150,*" framespacing="0" frameborder="0" border="0" id="frame" scrolling="yes">
			<frame src="MT_Menu.aspx" name='left' target="right"  scrolling="auto" noresize='noresize' />
            <frame src="MT_Desk.aspx" name='right'  target="_self" scrolling="auto" noresize='noresize' />
		</frameset>
