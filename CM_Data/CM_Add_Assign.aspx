<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="CM_Add_Assign.aspx.cs" Inherits="testpage.CM_Add_Assign" %>
     ...
     <div class="box-wrapper">
        <div class="box-outer">
           ...
           <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
                <tr>
                    <td class="tdleft1" style="width:15%;">合同编号:</td>          
                    ...
                    <td class="tdleft1" style="width:15%;">合同名称:</td>     
                    <td class="tdright1" style="width:20%;">
                ...
                <tr>
               <td colspan="6" align="right">任务设备数:
                   <input ID="num" runat="server" value="1" type="text" style="width:150px" onblur="CheckNum(this);" />&nbsp;&nbsp;
