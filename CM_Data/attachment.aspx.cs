...
namespace ZCZJ_DPF.CM_Data
{
    public partial class attachment : System.Web.UI.Page
    {
        ...
        {
            if (Request.QueryString["action"].ToString() == "look" || Request.QueryString["action"].ToString() == "sure")
            {
        ...
        private void UpFile()
        {
            ...
            string FilePath = @"E:\市场发货附件\" + Convert.ToString(System.DateTime.Now.Year);
            ...
            try
            {
                ...
                if (fileContentType == "application/vnd.ms-excel" || fileContentType == "application/msword" || fileContentType == "application/pdf" || fileContentType == "application/octet-stream" || fileContentType == "application/vnd.openxmlformats-officedocument.wordprocessingml.document" || fileContentType == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" || fileContentType == "application/vnd.ms-excel" || fileContentType == "image/jpg" || fileContentType == "image/jpeg" || fileContentType == "image/pjpeg")//传送文件类型
                {
