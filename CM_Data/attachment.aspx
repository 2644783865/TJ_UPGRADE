<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attachment.aspx.cs" Inherits="ZCZJ_DPF.CM_Data.attachment" %>
...
<body>
    ...
    <div style="text-align: center; width: 100%">
        <div style="margin: auto">
            ...
            <asp:FileUpload ID="FileUpload1" runat="server" Width="240px" /><asp:Button ID="btnAddFU"
                runat="server" Text="上传文件" OnClick="btnUp_Click" CausesValidation="False" OnClientClick="Click()" />
            <br />
