<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="CM_ZengBuPs.aspx.cs" Inherits="ZCZJ_DPF.CM_Data.CM_ZengBuPs" %>
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="序号" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="id" runat="server" Value='<%#Eval("CH_ID") %>' />
                                ...
                                <asp:BoundField DataField="ZDTIME" HeaderText="制单日期" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                                    ItemStyle-Wrap="false">
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlTask_look" CssClass="link" NavigateUrl='<%#"CM_ZengBuView.aspx?action=look&id="+Eval("ID")+"&chid="+Eval("CH_ID") %>'
                                            runat="server">
                                ...
                                <asp:TemplateField HeaderText="评审" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hlTask_ps" CssClass="link" NavigateUrl='<%#"CM_ZengBuView.aspx?action=ps&id="+Eval("ID")+"&chid="+Eval("CH_ID") %>'
                                            runat="server">
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="删除和修改" HeaderStyle-Wrap="false"
                                    ...
                                    <ItemTemplate>
                                        <span onclick="javascript:return confirm('修改后将清空历史\r审批记录重新开始审批！\r\r继续修改吗？');">
                                            <asp:HyperLink ID="lnkEdit" NavigateUrl='<%# "CM_ZhengBuTask.aspx?action=edit&id="+Eval("ID")+"&chid="+Eval("CH_ID") %>'
                                                runat="server">
                                                <asp:Image ID="Image11" ImageUrl="~/Assets/images/res.gif" runat="server" border="0"
                                                    hspace="2" align="absmiddle" />修改</asp:HyperLink></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandArgument='<%# Eval("CH_ID")%>'
