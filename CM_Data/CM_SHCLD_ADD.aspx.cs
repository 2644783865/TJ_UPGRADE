...
{
    public partial class CM_SHCLD_ADD : System.Web.UI.Page
    {
        ...
        protected void rptSHFWCLD_OnItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                {
                    if (dr["CLD_ZDR"].ToString()==username)
                    {
        ...
        {
            string cldid = ((LinkButton)sender).CommandArgument.ToString();
            string sql = "delete from CM_SHCLD where CLD_ID='" + cldid + "'";
            try
            {
