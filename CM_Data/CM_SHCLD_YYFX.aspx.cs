...
{
    public partial class CM_SHCLD_YYFX : System.Web.UI.Page
    {
        ...
        private string StrWhere()
        {
            ...
            {
                sql += string.Format("and (CLD_YYFX_TXR='{0}' and (CLD_YYFX is null or CLD_YYFX='')) and  CLD_SPZT in ('1y','2y','4y','y','cljg_y','fytj_y')", username);
            }
            return sql;
        }
        #endregion
