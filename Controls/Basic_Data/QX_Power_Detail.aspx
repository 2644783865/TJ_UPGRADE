<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.Master"  CodeBehind="QX_Power_Detail.aspx.cs" Inherits="ZCZJ_DPF.Basic_Data.QX_Power_Detail" %>
        ...
        <table cellpadding="4" cellspacing="1" class="toptable grid" border="1">
            ...
            <tr>
                <td colspan="4" align="center">
                    ...
                    <input id="Reset1" type="reset" value="   取消   " onclick="window.close()" />
                </td>
            </tr> 
        </table>
