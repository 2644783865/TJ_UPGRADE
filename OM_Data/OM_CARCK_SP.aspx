<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_CARCK_SP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_CARCK_SP" Title="无标题页" %>
                            ...
                            <ItemTemplate>
                                <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                    <asp:HyperLink ID="link_bh" runat="server" Visible="false" CssClass="link" NavigateUrl='<%#"OM_CARCK_detail.aspx?FLAG=check&id="+Eval("ZDR_SJ") %>'>
