<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OM_ZZEdit.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_ZZEdit" %>
    ...
    <div>
        <table cellpadding="4" cellspacing="1" style="background: #EEF7FD; white-space: nowrap;
            ...
            <tr align="center">
                ...
                <td>
                    <asp:Label ID="ST_INTIME" runat="server" Width="150px"></asp:Label>
                </td>
                <td>
                    转正时间：
                </td>
                <td>
                    <asp:TextBox ID="ST_ZHENG" runat="server" Width="150px" onclick="setday(this)" CssClass="center"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="center">
