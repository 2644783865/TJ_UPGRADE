<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_JXGZSYSPdetail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_JXGZSYSPdetail"
    Title="绩效工资使用审批明细" %>
                ...
                <div style="width: 100%">
                    <table width="100%">
                        <tr>
                            <td align="left">
                                部门：
                                <asp:DropDownList ID="drpdepartment" runat="server" Enabled="false">
                                </asp:DropDownList>
                            </td>
                            <td align="left">
                                年月：
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lbbyjxye" runat="server" Text="本月绩效使用"></asp:Label>
                                <asp:TextBox ID="txtJXSY" runat="server" Width="60px" onfocus="this.blur()"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
                <div>
                    <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid"
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:TextBox ID="txt_contents" runat="server" Width="80%" TextMode="MultiLine" Height="50px"
