<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_SALARYBASEDATADETAIL_EDIT.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_SALARYBASEDATADETAIL_EDIT" Title="无标题页" %>
                               ...
                               <asp:Repeater ID="rptProNumCost" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr id="row" class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" onclick="javascript:change(this);"
                                        ...
                                        <td>
                                            <asp:TextBox ID="BASEDATANEW" runat="server" BorderStyle="None" BackColor="Transparent"
                                                Width="50px" Text='<%#Eval("BASEDATANEW")%>'></asp:TextBox>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="NOTE" runat="server" Width="100px" Text='<%#Eval("NOTE")%>' BorderStyle="None" ToolTip='<%#Eval("NOTE")%>'></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="TOL_TYPE" runat="server" BorderStyle="None" BackColor="Transparent" Text='<%#Eval("TOL_TYPE").ToString().Trim()=="BINGJIA"?"病假工资基数":Eval("TOL_TYPE").ToString().Trim()=="JIABAN"?"加班工资基数":Eval("TOL_TYPE").ToString().Trim()=="NIANJIA"?"年假工资基数":"应扣岗位基数"%>'></asp:Label>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
