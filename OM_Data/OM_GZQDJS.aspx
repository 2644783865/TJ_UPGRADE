<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_GZQDJS.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GZQDJS" Title="无标题页" %>
        ...
        <div class="box-inner">
            <table style="width: 100%">
                <tr>
                    ...
                    <td width="17%">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:HyperLink ID="hpltixing" CssClass="hand" runat="server"><asp:Image ID="Image2" ImageUrl="../Assets/icon-fuction/388.gif" border="0" hspace="2" 
                                        align="absmiddle" runat="server" /><asp:Label ID="lb_tixing" runat="server" Text="当月计算工资提醒" ForeColor="Red"></asp:Label></asp:HyperLink>
                         <asp:PopupControlExtender ID="pcetixing" CacheDynamicResults="false" Position="Bottom"  Enabled="true" runat="server" OffsetX="-500"  OffsetY="8"  TargetControlID="hpltixing" PopupControlID="paneltixing">
                         </asp:PopupControlExtender>
                        <asp:Panel ID="paneltixing" Width="600px" style="display:none;visibility:hidden;border-style:solid;border-width:1px;border-color:blue;background-color:Menu;" runat="server"> 
                         <table width="100%" >
                             <tr>       
                                 <td>
                                      <div style="font-family: Verdana, Helvetica, Arial, sans-serif;line-height: 17px;font-size: 11px;font-weight: bold;position: absolute;top:8px;right: 10px;">
                             ...
                             <tr>
                                 <td align="left">
                                     休假超过5天(病假+事假+年休)：<asp:Label ID="lb_ts5" runat="server" ForeColor="Red"></asp:Label>
                                 </td>
                             </tr>
                             <tr>
                                 <td align="left">
                                     离职人员：<asp:Label ID="lb_lzry" runat="server" ForeColor="Red"></asp:Label>
                                 </td>
                             </tr>
                             <tr>
                                 <td align="left">
                                     年假天数达到上限：<asp:Label ID="lb_nianjia" runat="server" ForeColor="Red"></asp:Label>
                                 </td>
                             </tr>
                             <tr>
                                 <td align="left">
                                     入职转正提醒：<asp:Label ID="lb_zhuanzheng" runat="server" ForeColor="Red"></asp:Label>
                                 </td>
                             </tr>
                         </table>
                       </asp:Panel>   
                    ...
                    <td align="left">
                        <asp:Button ID="btngztz"  runat="server" Text="调整补发/补扣" OnClick="btngztz_OnClick" Visible="false"/>
                        <asp:FileUpload ID="FileUpload1" Width="100px" runat="server" ToolTip="导入" />&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="2">
                        <asp:RadioButton ID="radio_all" runat="server" Text="全部" GroupName="shenhe" OnCheckedChanged="radio_CheckedChanged"
                                            AutoPostBack="True" />
                        <asp:RadioButton ID="radio_weish" runat="server" Text="未提交" GroupName="shenhe" OnCheckedChanged="radio_CheckedChanged"
                                            AutoPostBack="True"/>
                        <asp:RadioButton ID="radio_shenhz" runat="server" Text="审核中" GroupName="shenhe" OnCheckedChanged="radio_CheckedChanged"
                                            AutoPostBack="True"/>
                        <asp:RadioButton ID="radio_yitg" runat="server" Text="已通过" GroupName="shenhe" OnCheckedChanged="radio_CheckedChanged"
                                            AutoPostBack="True"/>
                        <asp:RadioButton ID="radio_boh" runat="server" Text="已驳回" GroupName="shenhe" OnCheckedChanged="radio_CheckedChanged"
                                            AutoPostBack="True"/>
                    </td>
                    ...
                    <td align="left">
                        <asp:Button ID="btnscgzqd" runat="server" Text="计算本月工资" OnClientClick="gzqd(this);" OnClick="btnscgzqd_OnClick" />&nbsp;&nbsp;&nbsp;
                    </td>
                    <td align="right">
                        <asp:HyperLink ID="hplfjcb" runat="server" NavigateUrl="~/OM_Data/OM_GZQDeditJL.aspx" Target="_blank" Font-Underline="false"><asp:Image ID="AddImage2" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2" ImageAlign="AbsMiddle" runat="server" Width="20px" />查看修改记录</asp:HyperLink>&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btngzqdsh" runat="server" Text="生成工资清单" OnClick="btngzqdsh_OnClick" />&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
            ...
            <asp:Panel ID="PanelCondition" runat="server" Width="350px" Style="display: none">
                            <table width="90%" style="background-color: #CCCCFF; border: solid 1px black;">
                                <tr>
                                    <td>
                                        <strong>年月：</strong><asp:TextBox ID="tb_yearmonth" Width="160px" runat="server"></asp:TextBox>
                                        <asp:CalendarExtender DaysModeTitleFormat="MM月,yyyy年" TodaysDateFormat="yyyy年MM月"
                                            ID="DateTextBox_CalendarExtender" runat="server" Format="yyyy-MM" TargetControlID="tb_yearmonth">
                                ...
                                <tr>
                                    <td colspan="8" align="center">
                                        ...
                                        <asp:Button ID="btnimportfsjw" runat="server" OnClick="btnimportfsjw_Click" Text="防暑降温费导入" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnimportcnbt" runat="server" OnClick="btnimportcnbt_Click" Text="采暖补贴导入" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <tr>
                                    <td colspan="8" align="center">
                                        <asp:Button ID="btnsdfdr" runat="server" OnClick="btnsdfdr_Click" Text="代入水电费" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <asp:Repeater ID="rptGZQD" runat="server" OnItemDataBound="rptGZQD_ItemDataBound">
                                <HeaderTemplate>
                                    <tr align="center" style="background-color: #B9D3EE;">
                                        ...
                                        <td runat="server" id="tdXiugai" width="90px">
                                            修改
                                        </td>
                                        <td>
                                            扣税基数
                                ...
                                ondblclick="javascript:changeback(this);" onmouseout="this.className='baseGadget'">
                                        ...
                                        <td align="center">
                                            <asp:HyperLink ID="hlUpdate" CssClass="link" runat="server" NavigateUrl='<%#"OM_GZQDADD.aspx?action=update&id="+Eval("QD_ID")%>'>
                                                <asp:Image ID="AddImage2" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                                                    ImageAlign="AbsMiddle" runat="server" Width="20px" />
                                                修改
                                            </asp:HyperLink>
                                        </td>
                                        <td align="center">
