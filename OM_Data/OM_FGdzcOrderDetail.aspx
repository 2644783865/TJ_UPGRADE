<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_FGdzcOrderDetail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_FGdzcOrderDetail" %>
        ...
        <div class="box_right">
            <div class="box-title">
                <table width="100%">
                    <tr>
                        <td align="right">
                            <asp:Button ID="btnSave" runat="server" Text="保 存" OnClientClick="return btnSubmit_OnClientClick()"
                                CssClass="button-outer" OnClick="btnSave_OnClick" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <table width="100%">
                                <tr align="center">
                                    <td align="center" colspan="5">
                                        <asp:Label ID="lbltitle1" runat="server" Text="非固定资产入库单" Font-Bold="true" Font-Size="Large"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" colspan="5">
                                ...
                                <tr>
                                    <td align="center">
                                        制单人：<asp:Label ID="lbl_creater" runat="server" Text="Label"></asp:Label>
                                    </td>
                                    <td align="right">
                                        收料员：
                                    </td>
