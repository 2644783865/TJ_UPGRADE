<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_KaoHe_JXGZ_List.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_KaoHe_JXGZ_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    <table>
        <tr width="100%">
            ...
            <td>
                <asp:DropDownList ID="ddlDep" runat="server" Width="100px" AutoPostBack="true" OnSelectedIndexChanged="ddl_Year_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            ...
            <td>
                <asp:HyperLink ID="HyperLink1" CssClass="hand" runat="server" NavigateUrl="~/OM_Data/OM_KaoHe_JXGZFinal.aspx">
                    <asp:Image ID="AddImage" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                        align="absmiddle" runat="server" />查询绩效明细</asp:HyperLink>
            </td>
            <td>
                <asp:HyperLink ID="HyperLink2" CssClass="hand" runat="server" NavigateUrl="~/OM_Data/OM_KaoHe_JXGZ_Detail.aspx?action=add">
                    <asp:Image ID="Image1" ImageUrl="~/Assets/images/Add_new_img.gif" border="0" hspace="2"
                        align="absmiddle" runat="server" />添加记录</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td colspan="4">
            ...
            <td colspan="7" align="right">
                本月转正人员：<input type="text" id="ipt_zhuanzheng" runat="server" style="width:150px;border-style:none;color:Red" />
            </td>
        </tr>
    </table>
                ...
                <asp:Repeater ID="rep_Kaohe" runat="server">
                    ...
                    <ItemTemplate>
                        <tr class='baseGadget' onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                            ...
                            <td>
                                <asp:HyperLink NavigateUrl='<%#"~/OM_Data/OM_KaoHe_JXGZ_Detail.aspx?action=view&key="+Eval("Context")%>'
                            ...
                            <td>
                                <asp:HyperLink NavigateUrl='<%#"~/OM_Data/OM_KaoHe_JXGZ_Detail.aspx?action=edit&key="+Eval("Context")%>'
                                    runat="server" ID="HyperLink4">
                                    <asp:Image ID="Image4" ImageUrl="~/assets/images/res.gif" hspace="2" align="absmiddle"
                                        runat="server" />编辑
                                </asp:HyperLink>
                            </td>
                            <td width="100px">
                            ...
                            <td width="100px">
                                <asp:LinkButton ID="lnkDelete" OnClick="lnkDelete_OnClick" runat="server" CommandArgument='<%# Eval("Context")%>'
