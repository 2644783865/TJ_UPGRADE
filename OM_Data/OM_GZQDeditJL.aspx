<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_GZQDeditJL.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GZQDeditJL" Title="无标题页" %>
                        ...
                        <table id="tab" class="nowrap cptable fullwidth" align="center">
                            <asp:Repeater ID="rptGZQD" runat="server" OnItemDataBound="rptGZQD_ItemDataBound">
                                ...
                                ondblclick="javascript:changeback(this);" onmouseout="this.className='baseGadget'">
                                        ...
                                        <td align="center">
                                            <asp:Label ID="lbQD_edittime" runat="server" Text='<%#Eval("QD_edittime")%>'></asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:Label ID="lbQD_editname" runat="server" Text='<%#Eval("QD_editname")%>'></asp:Label>
                                        </td>
                                        <td align="center">
