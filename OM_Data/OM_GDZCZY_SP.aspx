<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_GDZCZY_SP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GDZCZY_SP" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_OnItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" title="双击查看详细信息">
                                ...
                                <td>
                                    <asp:HyperLink ID="link_bh" runat="server" Visible="false" CssClass="link" NavigateUrl='<%#"OM_GdzcTrans.aspx?action=check&id="+Eval("DH") %>'>
