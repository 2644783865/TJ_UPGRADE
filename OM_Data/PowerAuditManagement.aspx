<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PowerAuditManagement.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.PowerAuditManagement" %>
            ...
            <div class="box-outer">
                <table>
                    <tr>
                        ...
                        <td align="right">
                            <asp:HyperLink ID="HyperLinkAdd" runat="server" Target="_blank" NavigateUrl="~/OM_Data/PowerAudit.aspx?action=add&auditno=">
                                ...
                                <asp:Repeater ID="rptpower" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr class="baseGadget" onmouseover="this.className='highlight'" onclick="javascript:change(this);"
                                            ...
                                            <td align="center">
                                                <asp:Label ID="stname" runat="server" Text='<%#Eval("stname")%>'></asp:Label>
                                            </td>
                                            <td align="center">
                                                <asp:Label ID="DEP_POSITION" runat="server" Text='<%#Eval("DEP_POSITION")%>'></asp:Label>
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <asp:HyperLink ID="HyperLinkXG" Target="_blank" NavigateUrl='<%#"~/OM_Data/PowerAudit.aspx?action=edit&auditno="+Eval("auditno") %>'
                                                    runat="server">
                                            ...
                                            <td>
                                                <asp:HyperLink ID="HyperLinkCK" Target="_blank" NavigateUrl='<%#"~/OM_Data/PowerAudit.aspx?action=view&auditno="+Eval("auditno") %>'
                                                    runat="server">
                                                    <asp:Image ID="Image_chakan" ImageUrl="~/Assets/images/res.gif" border="0" hspace="2"
                                                        align="absmiddle" runat="server" />查看</asp:HyperLink>
                                            </td>
                                            <td>
                                                <asp:HyperLink ID="HyperLinkSH" Target="_blank" NavigateUrl='<%#"~/OM_Data/PowerAudit.aspx?action=audit&auditno="+Eval("auditno") %>'
                                                    runat="server">
