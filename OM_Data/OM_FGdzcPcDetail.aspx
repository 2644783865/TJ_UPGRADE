<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/BaseMaster.master" AutoEventWireup="true" CodeBehind="OM_FGdzcPcDetail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_FGdzcPcDetail" %>
    ...
    <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
            ...
            <div class="RightContent">
                ...
                <div class="box-wrapper">
                    <div class="box-outer">
                        <table id="Table1" align="center" cellpadding="4" cellspacing="1" runat="server" class="toptable grid"
                            border="1">
                            <tr align="center">
                                <td align="center" colspan="6" style="font-weight: bold; font-size: large">
                                    非固定资产购置申请表(No.<asp:Label ID="lblCode" runat="server"></asp:Label>)
                                </td>
                            </tr>
