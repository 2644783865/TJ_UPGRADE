<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_YongYinDetial_cw_new2.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_YongYinDetial_cw_new2"
    Title="无标题页" %>
                        ...
                        <asp:Panel ID="Panel0" runat="server">
                            <table width="1000px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTime" Enabled="false" runat="server" class="easyui-datebox" Width="120px"
                                            data-options="editable:false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                            ...
                                            <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlType" runat="server" SelectedValue='<%#Eval("Type") %>'>
                                                        ...
                                                        <asp:ListItem Text="营业执照正本" Value="1"></asp:ListItem>
                                                        <asp:ListItem Text="营业执照副本" Value="2"></asp:ListItem>
                                                        <asp:ListItem Text="营业执照正本(电子版)" Value="4"></asp:ListItem>
                                                        <asp:ListItem Text="营业执照副本(电子版)" Value="5"></asp:ListItem>
