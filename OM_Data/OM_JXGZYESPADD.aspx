<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_JXGZYESPADD.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_JXGZYESPADD" Title="新增绩效工资结余审批" %>
...
<script src="../JS/PickPersons.js" type="text/javascript"></script>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" AsyncPostBackTimeout="300">
        ...
        ActiveTabIndex="1" >
         <asp:TabPanel runat="server" ID="TabPanel1" HeaderText="人员绩效余额明细" TabIndex="0">
            <ContentTemplate>
              <div style="width: 100%">
                  <table width="100%">
                    <tr>
                        <td align="left">
                            部门：
                            <asp:DropDownList ID="drpdepartment" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpdepartment_OnSelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                    <td>
                        ...
                        &nbsp;月&nbsp;
                        <asp:Label ID="Label1" runat="server" Text="本月绩效余额"></asp:Label>
                        <asp:TextBox ID="txtJXYE" runat="server" Width="60px" ></asp:TextBox>
                    </td>
                    </tr>
                  </table>
              </div>
