<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_ZCKX.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_ZCKX" Title="无标题页" %>
            ...
            <div class="box-title">
                <table width="100%">
                    <tr>
                        <td>
                            使用人：
                            <asp:TextBox ID="txtPer" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                            使用部门：
                            <%--<asp:DropDownList ID="ddl_Depart" runat="server" Width="80px" AutoPostBack="true">
                            </asp:DropDownList>--%>
                            <asp:DropDownList ID="drpdepartment" runat="server" Width="80px" AutoPostBack="true"
                                OnSelectedIndexChanged="drpdepartment_OnSelectedIndexChanged">
                            </asp:DropDownList>
                            &nbsp;&nbsp;&nbsp; 固定资产编号：
                            <asp:TextBox ID="txtCode" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                            名称：
                            <asp:TextBox ID="txtName" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                            规格或参数：
                            <asp:TextBox ID="txtModel" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td>
                            固定资产类型1：
                            <asp:TextBox ID="txtType" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                            固定资产类型2：
                            <asp:TextBox ID="txtType2" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                            存放地点：
                            <asp:TextBox ID="txtAddress" runat="server" Width="80px" Text=""></asp:TextBox>&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </div>
