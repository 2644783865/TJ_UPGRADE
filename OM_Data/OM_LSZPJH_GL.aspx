<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_LSZPJH_GL.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_LSZPJH_GL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        function trClick(a) {
            window.open("OM_LSZPJH_SQ.aspx?action=read&id=" + a);
        }
    ...
    <div class="box-inner">
        <div class="box_right">
            <div class="box-title" align="right">
                <a runat="server" id="btnAdd" href="OM_LSZPJH_SQ.aspx?action=add" class="easyui-linkbutton"
                        ...
                        <asp:Repeater runat="server" ID="rptZPJH" OnItemDataBound="rptZPJH_OnItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" title="双击查看详细信息"
                                    ...
                                    <td>
                                        <asp:HyperLink runat="server" ID="hplAlter" NavigateUrl='<%#"OM_LSZPJH_SQ.aspx?action=alter&id="+Eval("JH_ID")%>'>
