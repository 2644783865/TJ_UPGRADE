<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_CBCX.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_CBCX" Title="餐补查询" %>
        ...
        <table width="60%">
            <tr>
                <td>
                    ...
                    &nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btncx" runat="server" Text="查询" OnClick="btncx_click" Height="30px"
                        Font-Size="Medium" />
                </td>
            </tr>
            <tr style="height: 80px">
                <td align="center" style="width: 25%">
                    <strong style="font-size: medium">餐补天数（天）：</strong>
                    <asp:TextBox runat="server" ID="txtCB_TS" BackColor="#98FB98" onfocus="this.blur()"
                        Font-Size="Medium" Height="30px"></asp:TextBox>
                </td>
            </tr>
            <tr style="height: 80px">
                <td align="center" style="width: 25%">
                    <strong style="font-size: medium">餐补标准（天/元）：</strong>
                    <asp:TextBox runat="server" ID="txtCB_BZ" BackColor="#98FB98" onfocus="this.blur()"
                        Height="30px" Font-Size="Medium"></asp:TextBox>
                </td>
            </tr>
            <tr style="height: 80px">
                <td align="center" style="width: 25%">
                    <strong style="font-size: medium">月度餐补（元）：</strong>
                    <asp:TextBox runat="server" ID="txtCB_LEIJI" BackColor="#98FB98" ForeColor="Red"
