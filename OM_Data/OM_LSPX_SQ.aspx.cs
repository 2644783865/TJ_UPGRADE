...
{
    public partial class OM_LSPX_SQ : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            else if (asd.action == "read")
            {
                ...
                string sql = " select * from OM_PXJH_SQ as a left join OM_SP as b on a.PX_SJID=b.SPFATHERID and b.SPLX='LSPX' where PX_SJID=" + asd.sjid;
        ...
        protected void btnSubmit_onserverclick(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "select count(SPID) from OM_SP where SPFATHERID='" + asd.sjid + "' and SPLX='LSPX'";
                ...
                sql += " where SPFATHERID='" + asd.sjid + "' and SPLX='LSPX'";
                try
                {
                ...
                Response.Redirect("OM_LSPX_GL.aspx");
            }
        }
        ...
        private List<string> alterlist()
        {
            ...
            //重置审批，确保驳回状态审批从头开始
            sql = "delete from OM_SP where SPFATHERID='" + asd.sjid + "' and SPLX='LSPX'";
            list.Add(sql);
            sql = string.Empty;
            sql = "insert into OM_SP (SPFATHERID,SPLX,ZDR,ZDRID,ZDR_SJ,SPZT) values ( ";
            sql += "'" + asd.sjid + "',";
