<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="Sta_StaffEdit.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.Sta_StaffEdit"
    Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#<%=ST_IDCARD.ClientID %>").keyup(function() {
                //  alert("aa");
                var birthdayValue;
                var val = $(this).val();
                var gender;
                ...
                if (val.length == 18 || val.length == 15) {
                    $("#<%=ST_BIRTHDAY.ClientID %>").datebox("setText", birthdayValue);
                    $("#<%=ST_GENDER.ClientID %>").val(gender);
                    var age=ages(birthdayValue);
                    $("#<%=ST_AGE.ClientID %>").val(age)
    ...
    <div class="box_right" style="height: 20px; padding-top: 5px;">
        &nbsp;&nbsp;&nbsp;填表日期：<asp:Label runat="server" ID="ST_FILLDATE">
        </asp:Label>
        &nbsp;&nbsp;&nbsp;维护人：<asp:Label runat="server" ID="ST_MANCLERK">
        </asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="confirm" runat="server" Text="提 交" OnClick="confirm_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btn_Back" runat="server" Text="返 回" OnClick="btn_Back_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
                        ...
                        <div class="box-outer">
                            <table cellpadding="4" cellspacing="1" style="background: #EEF7FD; white-space: nowrap;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="ST_BIRTHDAY" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                        出生地
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="ST_JRTIME" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                        籍贯
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_JOBTIME" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="DEP_NAME" runat="server" Width="120px" OnSelectedIndexChanged="DEP_NAME_SelectedIndexChanged"
                                            AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ST_XUELI" runat="server">
                                            ...
                                            <asp:ListItem Text="研究生" Value="10"></asp:ListItem>
                                            <asp:ListItem Text="在职研究生" Value="9"></asp:ListItem>
                                            <asp:ListItem Text="本科" Value="8"></asp:ListItem>
                                            <asp:ListItem Text="大普" Value="7"></asp:ListItem>
                                            <asp:ListItem Text="大专" Value="6"></asp:ListItem>
                                            <asp:ListItem Text="中专" Value="5"></asp:ListItem>
                                            <asp:ListItem Text="高中" Value="4"></asp:ListItem>
                                            <asp:ListItem Text="初中" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="小学" Value="2"></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_BIYETIME" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_BIYETIMEHI" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <!--===============职位信息=================-->
                                <tr>
                                    <td rowspan="5" style="text-align: center; width: 60px">
                                        职<br />
                                        称<br />
                                        技<br />
                                        能<br />
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ST_ZHICHDJ" runat="server">
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_EMPTIME" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_GETTIME" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ST_ZHIJIDJ" runat="server">
                                            <asp:ListItem Text="请选择" Value=""></asp:ListItem>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_EMPTIMEXU" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_INOUTNO" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_LYTIME" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_INTIME" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                        转正时间：
                                    </td>
                                    <td>
                                        <asp:TextBox ID="ST_ZHENG" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                        合同主体：
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_CONTRSTART" runat="server" class="easyui-datebox" editable="false"></asp:TextBox>
                                    </td>
                                    <td>
                                        合同终止时间：
                                    </td>
                                    <td>
                                        <asp:TextBox ID="ST_CONTREND" runat="server" class="easyui-datebox" editable="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_RETIRE" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                    <td>
                                        办理用工时间：
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="ST_LZSJ" runat="server" class="easyui-datebox"></asp:TextBox>
                                    </td>
                                </tr>
                                <!--===============工资信息=================-->
                                <tbody id="Salary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ST_ALLOW_IN" runat="server">
                                            <asp:ListItem Text="请选择" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="允许" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="不允许" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <!--===============角色==================-->
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <div style="width: 900px">
                            ...
                            <br />
                            <div>
                                <asp:Button ID="delete" runat="server" Text="删除" OnClick="delete_Click" Visible="false" /></div>
                        </div>
                        <br />
                        <br />
                        <div style="width: 900px">
                            教育及其培训记录经历：&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnadd1" runat="server" Text="增 加" OnClick="btnadd1_Click" />
                            ...
                            <br />
                            <div>
                                <asp:Button ID="delete1" runat="server" Text="删除" OnClick="delete1_Click" Visible="false" /></div>
                        </div>
                        <br />
                        <br />
                        <div style="width: 900px">
                            家庭成员：&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnadd2" runat="server" Text="增 加" OnClick="btnadd2_Click" />
                            ...
                            <br />
                            <div>
                                <asp:Button ID="delete2" runat="server" Text="删除" OnClick="delete2_Click" Visible="false" /></div>
                        </div>
                        <br />
                        <br />
                        <div style="width: 900px">
                            内部调动表：&nbsp;&nbsp;&nbsp;&nbsp;
                            <table id="Table3" align="center" cellpadding="4" cellspacing="1" class="toptable grid"
                                border="1">
                                <asp:Repeater ID="Det_Repeater3" runat="server">
                                    <HeaderTemplate>
                                        <tr align="center" class="tableTitle headcolor">
                                            <td width="50px">
                                                <strong>序号</strong>
                                    ...
                                    <ItemTemplate>
                                        <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                            ...
                                            <td>
                                                <%#Eval("MOVE_TYPE").ToString().Contains("0")?"调动":Eval("MOVE_TYPE").ToString().Contains("1")?"借调":"" %>
                                            </td>
                                            <td>
                                                <%#Eval("MOVE_PERNAME") %>
                                            </td>
                            ...
                            <asp:Panel ID="NoDataPanel3" runat="server" HorizontalAlign="Center">
                                没有记录!</asp:Panel>
                            <br />
                        </div>
                    </ContentTemplate>
