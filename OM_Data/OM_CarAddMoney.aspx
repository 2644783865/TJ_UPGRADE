<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_CarAddMoney.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_CarAddMoney" Title="无标题页" %>
...
var cardye=document.getElementById('<%=txt_czje.ClientID%>').value;
var bye=document.getElementById('<%=lbl_bye.ClientID%>').value;
 var  ss=changeTwoDecimal(cardye*1.0+bye*1.0);
...
<%--        <tr>
        ...
        <tr>
            ...
            <td>
                <input id="txt_czje" runat="server" onchange="change(this)" style="width: 300px" />
...
<%--        <tr>
        ...
        <tr>
            <td width="100px">
                <asp:Label ID="lbl_zzye" runat="server" Text="充值后卡金额："></asp:Label>
            </td>
            <td>
