...
{
    public partial class OM_LZFGDZC : System.Web.UI.Page
    {
        ...
        protected void btn_submit_click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('添加转移成功');window.location.href='OM_FGdzcStore.aspx';</script>");
            }
        }
