<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_TravelDelayDetail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_TravelDelayDetail"
    Title="差旅延期信息" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
     ...
     function fulltime(obj){
        ...
        var startdateplan = tr.getElementsByTagName("td")[5].getElementsByTagName("input")[0]; 
        var enddateplan = tr.getElementsByTagName("td")[6].getElementsByTagName("input")[0];
        var startdatereal = tr.getElementsByTagName("td")[10].getElementsByTagName("input")[0]; 
        var enddatereal = tr.getElementsByTagName("td")[11].getElementsByTagName("input")[0];
        var days=tr.getElementsByTagName("td")[12].getElementsByTagName("input")[0];
        var pattem = /^[1-9][0-9]*$/; //数量验证
            if (!pattem.test(days.value)) {
                alert("请输入正确的天数！");
                days.value="1";
                return;
            }
        var example='2015-11-20';
        var result = startdatereal.value.match(/((^((1[8-9]\d{2})|([2-9]\d{3}))(-)(10|12|0?[13578])(-)(3[01]|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))(-)(11|0?[469])(-)(30|[12][0-9]|0?[1-9])$)|(^((1[8-9]\d{2})|([2-9]\d{3}))(-)(0?2)(-)(2[0-8]|1[0-9]|0?[1-9])$)|(^([2468][048]00)(-)(0?2)(-)(29)$)|(^([3579][26]00)(-)(0?2)(-)(29)$)|(^([1][89][0][48])(-)(0?2)(-)(29)$)|(^([2-9][0-9][0][48])(-)(0?2)(-)(29)$)|(^([1][89][2468][048])(-)(0?2)(-)(29)$)|(^([2-9][0-9][2468][048])(-)(0?2)(-)(29)$)|(^([1][89][13579][26])(-)(0?2)(-)(29)$)|(^([2-9][0-9][13579][26])(-)(0?2)(-)(29)$))/);//验证日期格式2015-11-20
        if(result==null)
        {
            alert("请输入正确的实际开始日期");
            startdatereal.value=startdateplan.value;
        }
         var startdate = startdatereal.value.split("-");       
         var nDate = new Date(startdate); 
         var millSeconds = Math.abs(nDate) + ((days.value-1) * 24 * 60 * 60 * 1000); 
    ...
    <div style="float: right">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" id="btnBack" onclick="window.location.href='OM_TravelDelay.aspx';"
            value="返 回" />
        &nbsp;&nbsp;&nbsp;&nbsp;
    </div>
                    ...
                    <div class="box-wrapper1">
                        <div class="box-outer" style="text-align: center; overflow-x: hidden">
                            <div style="text-align: center;">
                                <h2>
                                    <asp:Label runat="server" ID="lblType" Text="差旅延期单"></asp:Label></h2>
                            </div>
                            <br />
                                ...
                                <table width="100%">
                                    <tr>
                                        <td style="width: 10%" align="center">
                                            &nbsp; &nbsp; &nbsp; 延期单号：
                                            <asp:Label ID="lbTD_Code" runat="server"></asp:Label>
                                        </td>
                                        <td style="width: 15%" align="center">
                                            &nbsp; &nbsp; &nbsp; &nbsp; 制单人姓名：
                                            <asp:Label ID="lbTD_ZDR" runat="server"></asp:Label>
                                            <input type="hidden" id="HidTD_ZDRID" runat="server" />
                                            &nbsp; &nbsp; &nbsp; &nbsp; 制单人部门：
                                            <asp:Label ID="lbTD_ZDRDep" runat="server"></asp:Label>
                                            <input type="hidden" id="HidTD_ZDRDepID" runat="server" />
                                        </td>
                                        <td style="width: 15%" align="center">
                                            制单时间：<asp:Label ID="lbTD_ZDTime" runat="server" Text=""></asp:Label>
                                            &nbsp; &nbsp;&nbsp;
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <ContentTemplate>
                                        <div style="text-align: center; overflow: auto; height: 355px">
                                            <table id="gr" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
                                                <asp:Repeater ID="rptTravelDelayDetail" runat="server" OnItemDataBound="rptTravelDelayDetail_ItemDataBound">
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                            ...
                                                            <td style="text-align: center">
                                                                <asp:TextBox ID="txtT_Code" runat="server" CssClass="center" Text='<%#Eval("TA_Code") %>'
                                                                    OnTextChanged="T_Code_TextChanged" AutoPostBack="true" Width="135px"></asp:TextBox>
                                                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" CompletionSetCount="10"
                                                                    DelimiterCharacters="" Enabled="True" MinimumPrefixLength="1" ServiceMethod="get_code_st_id"
                                                                    ServicePath="~/Ajax.asmx" FirstRowSelected="true" TargetControlID="txtT_Code"
                                                                    UseContextKey="True" CompletionListCssClass="autocomplete_completionListElement"
                                                                    CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem">
                                                                </asp:AutoCompleteExtender>
                                                            </td>
                                                            <td style="text-align: center">
                                                                <asp:TextBox ID="txtTD_SQR" runat="server" CssClass="center" onfocus="this.blur()"
                                                                    Width="80px" Text='<%#Eval("TD_SQR") %>'></asp:TextBox>
                                                                <asp:TextBox ID="txtTD_SQRID" runat="server" CssClass="center" Text='<%#Eval("TD_SQRID")%>'
                                                                    Visible="false"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_SQRDep" runat="server" CssClass="center" Text='<%#Eval("TD_SQRDep") %>'
                                                                    Width="90px" onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_SQRDepPos" runat="server" CssClass="center" Text='<%#Eval("TD_SQRDepPos") %>'
                                                                    onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_StartTimePlan" Text='<%#Eval("TD_StartTimePlan")%>' runat="server"
                                                                    CssClass="center" Width="80px" onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_EndTimePlan" Text='<%#Eval("TD_EndTimePlan")%>' runat="server"
                                                                    CssClass="center" Width="80px" onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_DaysPlan" runat="server" Text='<%#Eval("TD_DaysPlan")%>' onfocus="this.blur()"
                                                                    CssClass="center" Width="60px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_Event" TextMode="MultiLine" Text='<%#Eval("TD_Event")%>' runat="server"
                                                                    Width="240px" onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_Place" TextMode="MultiLine" Text='<%#Eval("TD_Place")%>' runat="server"
                                                                    Width="240px" onfocus="this.blur()"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_StartTimeReal" Text='<%#Eval("TD_StartTimeReal")%>' runat="server"
                                                                    onblur="fulltime(this)" CssClass="center" Width="80px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_EndTimeReal" Text='<%#Eval("TD_EndTimeReal")%>' runat="server"
                                                                    onfocus="this.blur()" CssClass="center" Width="80px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_DaysReal" runat="server" Text='<%#Eval("TD_DaysReal")%>' CssClass="center"
                                                                    onblur="fulltime(this)" Width="60px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTD_DelayNote" TextMode="MultiLine" Text='<%#Eval("TD_DelayNote")%>'
                                            ...
                                            <div style="float: left; padding-top: 10px">
                                                ...
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:Label
                                                    ID="lbtip" runat="server" ForeColor="Red" Text="* 表格原差旅单号处输入单号或制单人姓名"></asp:Label>
                                            </div>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
