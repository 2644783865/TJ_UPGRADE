...
{
    public partial class OM_GdzcPcPlan : BasicPage
    {
        string carrvwa = "";
        string carrvwb = "";
        ...
        {
            pager.TableName = "(select DISTINCT(a.CODE) AS CODE,DEPARTMENT,AGENT,AGENTID,ADDTIME,STATUS,REASON,CARRVWAID,CARRVWBID,a.NOTE,b.INCODE from View_TBOM_GDZCAPPLY as a left join TBOM_GDZCIN as b on a.code=b.code where PCType='0')a ";
