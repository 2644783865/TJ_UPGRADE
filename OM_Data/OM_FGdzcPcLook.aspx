<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_FGdzcPcLook.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_FGdzcPcLook" %>
            ...
            <div class="box_right">
                <div class="box-title">
                    <table width="100%">
                        <tr>
                            <td align="right">
                                <asp:Button ID="btnDown" runat="server" Text="下推到订单" CausesValidation="false" OnClick="btnDown_OnClick"
                            ...
                            <table id="Table1" align="center" cellpadding="4" cellspacing="1" runat="server"
                                ...
                                <tr align="center">
                                    <td align="center" colspan="6">
                                        <asp:Label ID="lbltitle1" runat="server" Text="非固定资产购置申请表" Font-Bold="true" Font-Size="Large"></asp:Label>
                                        <asp:Label ID="lbltitle2" runat="server" Text="非固定资产购置订单" Font-Bold="true" Font-Size="Large"
