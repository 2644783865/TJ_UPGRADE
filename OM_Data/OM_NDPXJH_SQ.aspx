<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_NDPXJH_SQ.aspx.cs" Inherits="ZCZJ_DPF.OM_NDPXJH_SQ" %>
            ...
            <div class="box-title" align="right">
                <a runat="server" id="btnSubmit" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'"
                    onserverclick="btnSubmit_onserverclick">提交审批</a> <a runat="server" id="btnSave" href="#"
                        ...
                        onclick="return btnSave_onclick();fzdctj();">保存</a> 
                        <a runat="server" id="btnbacklast" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'"
                    onserverclick="btnbacklast_onserverclick">驳回上一级</a>
                        <a runat="server" id="btnBack"
                    ...
                    <asp:Panel runat="server" ID="panJBXX">
                        ...
                        <table class="tab">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <asp:Label runat="server" ID="lbPX_SQR"></asp:Label>
                                </td>
                                <td width="25%">
                                    申请时间
                                </td>
                                <td width="25%">
                                    <asp:Label runat="server" ID="lbPX_SQSJ"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                ...
                <div style="width: 100%; background-color: #F0F8FF" align="center" id="div2">
                    <asp:Panel runat="server" ID="panZDR">
                        <table class="tab">
                            <tr>
                                <td colspan="4">
                                    <span style="color: Red">注： 默认二级审批---第一级为部门领导，第二级为主管领导，请正确选择审批人。</span>
                                </td>
                            </tr>
