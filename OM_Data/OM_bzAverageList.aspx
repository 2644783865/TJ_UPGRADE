<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_bzAverageList.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_bzAverageList" %>
    ...
    <table>
        <tr width="100%">
            ...
            <td align="right" width="15%">
                <asp:HyperLink ID="hpTask" NavigateUrl="OM_bzAverage_Detail.aspx?action=add" runat="server">
                ...
                <asp:Repeater ID="rep_Kaohe" runat="server">
                    ...
                    <ItemTemplate>
                        <tr class='baseGadget' onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                            ...
                            <td>
                                <%#Eval("State").ToString() == "0" ? "未提交" : Eval("State").ToString() == "4" ? "已通过" : Eval("State").ToString() == "3" ? "已驳回" : "审核中"%>
                            </td>
                            <td>
                                <asp:HyperLink NavigateUrl='<%#"~/OM_Data/OM_bzAverage_Detail.aspx?action=view&key="+Eval("Context")%>'
                            ...
                            <td width="100px">
                                <asp:HyperLink NavigateUrl='<%#"~/OM_Data/OM_bzAverage_Detail.aspx?action=edit&key="+Eval("Context")%>'
                            ...
                            <td width="100px">
                                <asp:HyperLink NavigateUrl='<%#"~/OM_Data/OM_bzAverage_Detail.aspx?action=audit&key="+Eval("Context")%>'
