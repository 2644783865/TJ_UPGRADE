<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_KaoHe.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_KaoHe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#gr input,#gr textarea").attr("readonly", "readonly");
            if (state == 1) { { $("#gr textarea").removeAttr("readonly"); $("#gr input[name*=kh_ScoreOwn]").removeAttr("readonly"); } }
            else if (state == 2) { $("#gr input[name*=kh_Score0]").removeAttr("readonly"); $("#gr textarea[name*=kh_BEIZHU]").removeAttr("readonly") }
            else if (state == 3) { $("#gr input[name*=kh_Score1]").removeAttr("readonly");  $("#gr textarea[name*=kh_BEIZHU]").removeAttr("readonly")}
            else if (state == 4) { $("#gr input[name*=kh_Score2]").removeAttr("readonly");  $("#gr textarea[name*=kh_BEIZHU]").removeAttr("readonly")}
            else if (state == 5) { $("#gr input[name*=kh_Score3]").removeAttr("readonly"); $("#gr textarea[name*=kh_BEIZHU]").removeAttr("readonly") }
...
//**********审核选人***********************
    ...
    <div style="float: right">
        <asp:Button ID="btnAudit" runat="server" Text="开始评价" OnClick="btnAudit_Click" OnClientClick="return confirm('您确定要提交审批吗，提交后将无法更改')" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnsubmit" runat="server" Text="保 存" OnClientClick="return Test();"
            OnClick="btnsubmit_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btninit" runat="server" Text="初始化" OnClick="btninit_Click" Visible="false"
            OnClientClick="return confirm('您确定要初始化吗，初始化后将回到未评价状态？')" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button runat="server" ID="btnSave" Text="提交" OnClick="btnSave_OnClick" Visible="false" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button runat="server" ID="btnbacklast" Text="驳回至上一级" OnClick="btnbacklast_OnClick" Visible="false" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:TabContainer ID="TabContainer1" runat="server" Width="100%" ActiveTabIndex="0">
        <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="考核信息" TabIndex="0">
            <ContentTemplate>
                <div class="box-wrapper1">
                        ...
                        <asp:Panel ID="Panel0" runat="server">
                            <table width="1150px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_Person" runat="server" Width="100px">
                                        </asp:DropDownList>
                                    </td>
                                    <td>
                                        考核时间：
                        ...
                        <div style="text-align: center; overflow: auto; height: 400px">
                            <table id="gr" cellpadding="4" cellspacing="1" class="toptable grid" border="1" style="white-space: normal">
                                <asp:Repeater ID="Det_Repeater" runat="server">
                                        ...
                                        <tr class="tableTitle headcolor">
                                            ...
                                            <td runat="server" id="col2">
                                                <div style="width: 150px">
                                                    <asp:Label ID="kh_Col2" runat="server" Font-Bold="true" Style="width: 150px"></asp:Label></div>
                                            </td>
                                            ...
                                            <td>
                                                <div style="width: 35px">
                                                    <asp:Label ID="Label2" runat="server" Font-Bold="true">自评分</asp:Label></div>
                                            </td>
                                            <td runat="server" id="thScore1">
                                                <div style="width: 35px">
                                                    <asp:Label ID="Label3" runat="server" Font-Bold="true">一级考核</asp:Label></div>
                                            </td>
                                            <td runat="server" id="thScore2">
                                                <strong>二级考核</strong>
                                            </td>
                                            <td runat="server" id="thScore3">
                                                <strong>三级考核</strong>
                                            </td>
                                            <td runat="server" id="thScore4">
                                                <strong>四级考核</strong>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label1" Text="权重" runat="server" Font-Bold="true"></asp:Label>
                                            </td>
                                            <td>
                                                <strong>备 注</strong>
                                            </td>
                                    ...
                                    <ItemTemplate>
                                        <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'"
                                            ...
                                            <td>
                                                <asp:TextBox ID="kh_Note" runat="server" Width="130px" Height="80px" TextMode="MultiLine"
                                                    Text='<%#Eval("kh_Note") %>'></asp:TextBox>
                                            </td>
                                            <td align="center">
                                                <asp:TextBox ID="kh_ScoreOwn" name="score0" runat="server" Text='<%#Eval("kh_ScoreOwn") %>'
                                                    onkeyup="Calculate()" onblur="Calculate()" Width="35px"></asp:TextBox>
                                            </td>
                                            <td runat="server" id="tdScore1">
                                                <asp:TextBox ID="kh_Score0" name="score0" runat="server" onkeyup="Calculate()" onblur="Calculate()"
                                                    Text='<%#Eval("kh_Score1") %>' Width="35px"></asp:TextBox>
                                                <input id="hidId" type="hidden" runat="server" value='<%#Eval("Id") %>' />
                                            </td>
                                            <td runat="server" id="tdScore2">
                                                <asp:TextBox ID="kh_Score1" name="score1" Width="35px" runat="server" onblur="Calculate()"
                                                    onkeyup="Calculate()" Text='<%#Eval("kh_Score2") %>'></asp:TextBox>
                                            </td>
                                            <td runat="server" id="tdScore3">
                                                <asp:TextBox ID="kh_Score2" name="score2" runat="server" Width="35px" CssClass="center"
                                                    onkeyup="Calculate()" onblur="Calculate()" Text='<%#Eval("kh_Score3") %>'></asp:TextBox>
                                            </td>
                                            <td runat="server" id="tdScore4">
                                                <asp:TextBox ID="kh_Score3" name="score3" runat="server" Width="35px" CssClass="center"
                                                    onkeyup="Calculate()" onblur="Calculate()" Text='<%#Eval("kh_Score4") %>'></asp:TextBox>
                                            </td>
                                            <td id="weight" runat="server" name="weight" align="center">
                                                <%#Eval("kh_Weight") %>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="kh_BEIZHU" runat="server" Width="130px" Height="80px" TextMode="MultiLine"
                                                    Text='<%#Eval("kh_BEIZHU") %>' name="kh_BEIZHU"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                                <tr runat="server" id="tr_foot" visible="false">
                                    ...
                                    <td>
                                        <asp:Label ID="lb_Result" runat="server" Width="35px" CssClass="center"></asp:Label>%
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtResult0" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td id="tfResult1" runat="server">
                                        <asp:TextBox ID="txtResult1" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td id="tfResult2" runat="server">
                                        <asp:TextBox ID="txtResult2" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td id="tfResult3" runat="server">
                                        <asp:TextBox ID="txtResult3" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td id="tfResult4" runat="server">
                                        <asp:TextBox ID="txtResult4" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txt_Result" runat="server" Width="35px" CssClass="center"></asp:TextBox>
                                    </td>
                                    <td colspan="2">
                                    </td>
                                </tr>
                    ...
                    <asp:Image ID="Image7" runat="server" Visible="false" ImageUrl="~/Assets/images/warning.png" />
            </ContentTemplate>
        </asp:TabPanel>
        <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="考核信息" TabIndex="0">
            <ContentTemplate>
                <div class="box-outer">
                    ...
                    <%--  <asp:Label ID="lbWarnOne" runat="server" Text="" CssClass="label"></asp:Label>--%>
                    <asp:Image ID="Image5" runat="server" Visible="false" ImageUrl="~/Assets/images/warning.png" />
                </div>
            </ContentTemplate>
        </asp:TabPanel>
        <asp:TabPanel runat="server" ID="TabPanel3" TabIndex="2" Width="100%" HeaderText="审核信息">
            <ContentTemplate>
                                    ...
                                    <table align="center" width="100%" cellpadding="4" cellspacing="1" border="1">
                                        <tr>
                                            ...
                                            <td style="width: 20%">
                                                ...
                                                <asp:HyperLink ID="Hylsh1" runat="server" CssClass="hand" onClick="SelPersonssh1()"
                                                    Visible="false">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <asp:TextBox ID="opinionsh1" runat="server" Height="42px" TextMode="MultiLine" Width="100%"
                                    ...
                                    <table align="center" width="100%" cellpadding="4" cellspacing="1" border="1">
                                        <tr>
                                            ...
                                            <td style="width: 20%">
                                                ...
                                                <asp:HyperLink ID="Hylsh2" runat="server" CssClass="hand" onClick="SelPersonssh2()"
                                                    Visible="false">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <asp:TextBox ID="opinionsh2" runat="server" TextMode="MultiLine" Width="100%" Height="42px"
                                                    Enabled="false"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table align="center" width="100%" cellpadding="4" cellspacing="1" border="1">
                                        <tr>
                                            ...
                                            <td style="width: 20%">
                                                ...
                                                <asp:HyperLink ID="Hylsh3" runat="server" CssClass="hand" onClick="SelPersonssh3()"
                                                    Visible="false">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <asp:TextBox ID="opinionsh3" runat="server" TextMode="MultiLine" Width="100%" Height="42px"
                                                    Enabled="false"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table align="center" width="100%" cellpadding="4" cellspacing="1" border="1">
                                        <tr>
                                            ...
                                            <td style="width: 20%">
                                                ...
                                                <asp:HyperLink ID="Hylsh4" runat="server" CssClass="hand" onClick="SelPersonssh4()"
                                                    Visible="false">
                                        ...
                                        <tr>
                                            <td colspan="6">
                                                <asp:TextBox ID="opinionsh4" runat="server" TextMode="MultiLine" Width="100%" Height="42px"
                                                    Enabled="false"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <%--<asp:Label ID="lbWarnTwo" runat="server" Text=""></asp:Label>--%>
                <asp:Image ID="Image6" runat="server" Visible="false" ImageUrl="~/Assets/images/warning.png" />
            </ContentTemplate>
        </asp:TabPanel>
    </asp:TabContainer>
    <div>
