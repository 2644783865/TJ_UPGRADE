    ...
    public partial class OM_KaoHeDetail_DepartMonth : BasicPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (action == "add")
                {
                    string sql = "select DEP_CODE as DepartId,DEP_NAME as DepartNM,'' as Score,'' as Note from dbo.TBDS_DEPINFO where DEP_CODE like '[0-9][0-9]' and DEP_CODE not in ('08','09','13','01','14') order by DEP_CODE";
