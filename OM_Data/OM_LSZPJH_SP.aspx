<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_LSZPJH_SP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_LSZPJH_SP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        //            alert(a);
        //            window.open("OM_RYXQJH_HZ.aspx?action=read&sjid=" + a);
        //        }
        $(function() {
            $("#tab tr:not(:first)").dblclick(function() {
                var sjid = $(this).find("input[name*=JH_HZSJ]").val();
                window.open("OM_LSZPJH_HZ.aspx?action=read&sjid=" + sjid);
            });
        })
    </script>
    ...
    <div class="box-inner">
        <div class="box_right">
            <div class="box-title" align="right">
                <a runat="server" id="btnDaoChu" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'"
                    onserverclick="btnDaoChu_onserverclick">导出</a>
            </div>
        </div>
    </div>
    <div>
        <table width="100%">
            <tr>
                ...
                <td>
                    <asp:DropDownList runat="server" ID="ddlSPZT" AutoPostBack="true" Visible="false"
                        OnSelectedIndexChanged="Query">
                        <asp:ListItem Text="-全部-" Value="0"></asp:ListItem>
                ...
                <td>
                    单号：<asp:TextBox runat="server" ID="txtDH"></asp:TextBox>
                </td>
                <td>
                        ...
                        <asp:Repeater runat="server" ID="rptZPJH" OnItemDataBound="rptZPJH_OnItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" title="双击查看详细信息">
                                    ...
                                    <td>
                                        <asp:HyperLink runat="server" ID="hplCheck" NavigateUrl='<%#"OM_LSZPJH_HZ.aspx?action=check&sjid="+Eval("JH_HZSJ")%>'>
