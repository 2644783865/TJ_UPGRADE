<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_CARRK.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_CARRK" Title="无标题页" %>
                ...
                <div class="box_right">
                    <div class="box-title">
                        <table width="100%">
                            ...
                            <td align="right">
                            <asp:HyperLink runat="server" ID="hplAdd" NavigateUrl="~/OM_Data/OM_CARRK_detail.aspx?FLAG=add&id=1">
