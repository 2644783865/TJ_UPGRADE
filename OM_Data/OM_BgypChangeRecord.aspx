<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_BgypChangeRecord.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_BgypChangeRecord"
    Title="以旧换新查询" %>
                ...
                <tr>
                    ...
                    <td width="400px">
                        <asp:RadioButtonList runat="server" ID="rblState" AutoPostBack="true" OnSelectedIndexChanged="ddlstate_click"
                            ...
                            <asp:ListItem Text="我的审核任务" Value="3"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td align="left">
                        <asp:CheckBox ID="ckbChange" runat="server" Checked="true" Text="以旧换新" AutoPostBack="true"
                            OnCheckedChanged="ckbChange_CheckedChanged" />
                    </td>
                    <td align="left">
