<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" 
    AutoEventWireup="true" CodeBehind="OM_YongYinDetail_cw.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_YongYinDetail_cw" Title=""%>
                                            ...
                                            <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlType" runat="server" SelectedValue='<%#Eval("Type") %>'>
                                                        ...
                                                        <asp:ListItem Text="财务用印" Value="0"></asp:ListItem>
                                ...
                                <tr>
                                    <td align="center" style="width: 70px;">
                                        一级审核</br></br><p style="color: Red">
                                            <asp:Label ID="lbtips1" runat="server" Text="请选择本部门部长"></asp:Label></p>
                                    </td>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td align="center" style="width: 70px;">
                                        二级审核</br></br><p style="color: Red">
                                            <asp:Label ID="lbtips2" runat="server" Text="请选择公司领导"></asp:Label>
                                        </p>
                                    </td>
                                    <td colspan="3">
                                        <table width="100%" cellpadding="4" cellspacing="1" border="1">
                                ...
                                <tr>
                                    <td align="center" style="width: 70px;">
                                        三级审核</br></br><p style="color: Red">
                                            <asp:Label ID="lbtips3" runat="server" Text="请选择财务部长"></asp:Label></p>
                                    </td>
                                    <td colspan="3">
                                        <table width="100%" cellpadding="4" cellspacing="1" border="1">
                                            <tr style="height: 25px">
