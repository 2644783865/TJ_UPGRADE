<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_YongYinDetial_cw_new3.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_YongYinDetial_cw_new3" Title="无标题页" %>
    ...
    <asp:TabContainer ID="TabContainer1" runat="server" Width="100%" ActiveTabIndex="0">
                                            ...
                                            <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlType" runat="server" SelectedValue='<%#Eval("Type") %>'>
                                                        ...
                                                        <asp:ListItem Text="法人姓名章" Value="1"></asp:ListItem>
        ...
        <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="审核信息" TabIndex="2">
            <ContentTemplate>
                            <div>
                    <p style="color: Red">
                        <asp:Label ID="Label1" runat="server" Text="审批人请依次选择本部门负责人,主管副总经理，财务部负责人，总经理"></asp:Label></p>
                </div>
                <div class="box-outer">
