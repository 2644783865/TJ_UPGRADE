<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_FGdzcBaofei_Detail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_FGdzcBaofei_Detail"
    Title="非固定资产报废" %>
...
//            });
    ...
    <asp:TabContainer runat="server" ID="TabContainer1" TabStripPlacement="Top" ActiveTabIndex="0">
        <asp:TabPanel runat="server" ID="TabPanel1" HeaderText="非固定资产报废明细" Width="100%" TabIndex="0">
            <HeaderTemplate>
                非固定资产报废明细
            </HeaderTemplate>
            <ContentTemplate>
                            ...
                            <div class="box-outer">
                                <div style="width: 100%; overflow: auto">
                                    <table width="100%" id="tab" align="center" cellpadding="2" cellspacing="1" class=" grid "
                                        border="1">
                                        <asp:Repeater ID="rptFGDZCBF" runat="server">
                                            <HeaderTemplate>
