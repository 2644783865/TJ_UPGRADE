<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_GDZCRK_SP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GDZCRK_SP" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr align="center" onmouseover="mover(this)" onmouseout="mout(this)" title="双击查看详细信息">
                                ...
                                <td>
                                    <asp:HyperLink ID="link_bh" runat="server" Visible="false" CssClass="link" NavigateUrl='<%#"OM_GdzcOrderDetail.aspx?FLAG=check&id="+Eval("INCODE") %>'>
