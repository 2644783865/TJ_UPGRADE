<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_JXGZSYSP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_JXGZSYSP" Title="绩效工资使用审批" %>
        ...
        <div class="box-outer">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td align="right">
                        <asp:HyperLink ID="hpladd" runat="server" NavigateUrl="~/OM_Data/OM_JXGZSYSPADD.aspx?"
                            Target="_blank" Font-Underline="false">
                    ...
                    <asp:Repeater ID="rpt1" runat="server">
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" onclick="javascript:change(this);"
                                ...
                                <td>
                                    <asp:HyperLink ID="hlContract3" Target="_blank" ToolTip="查看/审核" NavigateUrl='<%#"~/OM_Data/OM_JXGZSYSPdetail.aspx?spid="+Eval("bh") %>'
