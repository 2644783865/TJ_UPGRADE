<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_GDGZSCSP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GDGZSCSP" Title="固定工资删除审批" %>
    ...
    <%--   <script type="text/javascript">
      $(function() {
            $("#tab tr:not(:first)").dblclick(function() {
                ...
                window.open("OM_GDGZSCSP_detail.aspx?action=read&id=" + id);
            });
        })   
    </script>--%>
        ...
        <div class="box-outer">
            <div id="div_statistcs" style="width: 100%; height: auto; overflow: scroll; display: block;">
                <table id="tab" align="center" cellpadding="2" cellspacing="1" class="toptable grid nowrap"
                    border="1" width="100%">
                    <asp:Repeater ID="rptGDGZSP" runat="server" OnItemDataBound="rptGDGZSP_OnItemDataBound">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" title="">
                                <td>
                                ...
                                <td>
                                    <asp:HyperLink runat="server" ID="hlChaKan" Target="_blank" NavigateUrl='<%#"OM_GDGZSCSP_detail.aspx?action=read&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
                                ...
                                <td>
                                    <asp:HyperLink runat="server" ID="hlXiuGai" NavigateUrl='<%#"OM_GDGZSCSP_detail.aspx?action=alert&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
                                ...
                                <td>
                                    <asp:HyperLink ID="hlContract" runat="server" NavigateUrl='<%#"OM_GDGZSCSP_detail.aspx?action=check&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
