<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_YongYinDetail.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_YongYinDetail" %>
                                            ...
                                            <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlType" runat="server" SelectedValue='<%#Eval("Type") %>'>
                                                        ...
                                                        <asp:ListItem Text="合同用章" Value="0"></asp:ListItem>
                                                        <asp:ListItem Text="公章" Value="1"></asp:ListItem>
                                                        <asp:ListItem Text="营业执照（正本）" Value="2"></asp:ListItem>
                                                        <asp:ListItem Text="营业执照（副本）" Value="3"></asp:ListItem>
                                                        <asp:ListItem Text="组织机构代码证（正本）" Value="4"></asp:ListItem>
                                                        <asp:ListItem Text="组织机构代码证（副本）" Value="5"></asp:ListItem>
                                                        <asp:ListItem Text="税务登记证（正本）" Value="6"></asp:ListItem>
                                                        <asp:ListItem Text="税务登记证（副本）" Value="7"></asp:ListItem>
