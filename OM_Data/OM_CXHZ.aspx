<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_CXHZ.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_CXHZ" Title="查询汇总" %>
    ...
    <div align="center" style="width: 100%; height: 100%">
        ...
        <tr style="height: 80px">
            <td style="width: 25%" align="center">
                <asp:Button ID="btncx_nj" runat="server" Text="年假查询" OnClick="btncx_nj_click" Height="30px"
                    Font-Size="Medium" />
            </td>
        </tr>
        <tr>
            <td style="width: 25%" align="center">
                <asp:Button ID="btncx_cb" runat="server" Text="餐补查询" OnClick="btncx_cb_click" Height="30px"
                    Font-Size="Medium" />
            </td>
        </tr>
    </table>
