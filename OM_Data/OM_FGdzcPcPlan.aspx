<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_FGdzcPcPlan.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_FGdzcPcPlan" %>
            ...
            <div class="RightContent">
                           ...
                           <asp:Label ID="ControlFinder" runat="server" Visible="false"></asp:Label>
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:HyperLink ID="hplAddPC" NavigateUrl="~/OM_Data/OM_FGdzcPcDetail.aspx?action=add"
                ...
                <asp:BoundField DataField="XQTIME" HeaderText="需求时间" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />--%>
                                ...
                                <asp:TemplateField HeaderText="修改" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hplmod" runat="server" Visible="false" CssClass="link" NavigateUrl='<%#"OM_FGdzcPcDetail.aspx?action=mod&id="+Eval("CODE") %>'>
                                ...
                                <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hplview" runat="server" CssClass="link" NavigateUrl='<%#"OM_FGdzcPcLook.aspx?action=look&id="+Eval("CODE") %>'>
                                ...
                                <asp:TemplateField HeaderText="审核" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false"
                                    ItemStyle-Wrap="false">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="hplreview" runat="server" Visible="false" CssClass="link" NavigateUrl='<%#"OM_FGdzcPcLook.aspx?action=review&id="+Eval("CODE") %>'>
