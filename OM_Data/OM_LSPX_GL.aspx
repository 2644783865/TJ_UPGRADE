<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_LSPX_GL.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_LSPX_GL" %>
    ...
    <script type="text/javascript">
        $(function() {
            $("#tab tr:not(:first)").dblclick(function() {
                ...
                window.open("OM_LSPX_SQ.aspx?action=read&id=" + sjid);
            });
        })
    ...
    <div class="box-inner">
        <div class="box_right">
            <div class="box-title" align="right">
                <a runat="server" id="btnAdd" href="OM_LSPX_SQ.aspx?action=add" class="easyui-linkbutton"
                    ...
                    <div class="box-title" align="right">
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    培训季度：<asp:DropDownList runat="server" ID="ddlSJ" AutoPostBack="true" OnSelectedIndexChanged="Query">
                                        <asp:ListItem Text="-全部-" Value="0"></asp:ListItem>
                                ...
                                <asp:Repeater runat="server" ID="rptPXJH" OnItemDataBound="rptPXJH_OnItemDataBound">
                                    ...
                                    <ItemTemplate>
                                        <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" title="双击查看详细信息">
                                            ...
                                            <td>
                                                <asp:HyperLink runat="server" ID="hplCheck" NavigateUrl='<%#"OM_LSPX_SQ.aspx?action=check&id="+Eval("PX_SJID")%>'>
                                            ...
                                            <td>
                                                <asp:HyperLink runat="server" ID="hplAlter" NavigateUrl='<%#"OM_LSPX_SQ.aspx?action=alter&id="+Eval("PX_SJID")%>'>
