<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.Master"
    CodeBehind="OM_SHBX.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_SHBX" %>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="保存在职大额医疗救助" OnClick="btnSave_yl_Click" />
                    &nbsp;&nbsp;&nbsp;
                </td>
                <td>
            ...
            <tr>
                ...
                <td align="right">
                    <asp:HyperLink ID="hlUpdate" CssClass="link" runat="server" NavigateUrl="OM_SHBXBLEDIT.aspx">
                        <asp:Image ID="AddImage2" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                            ImageAlign="AbsMiddle" runat="server" />
                        修改缴费比例
                    </asp:HyperLink>
                    &nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="hlBLXGJL" CssClass="link" runat="server" NavigateUrl="OM_SHBXBLJL.aspx">
                ...
                <asp:Repeater ID="rptProNumCost" runat="server" OnItemDataBound="rptProNumCost_itemdatabind">
                    ...
                    <ItemTemplate>
                        <tr id="row" class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_JS" runat="server" align="center" BorderStyle="None" Width="120px"
                                    BackColor="Transparent" Text='<%#Eval("SH_JS")%>'></asp:TextBox>
                            </td>
                            <td runat="server" align="center">
                                <asp:Label ID="tb_TYPE" runat="server" align="center" Width="90px" Text='<%#Eval("ST_REGIST")%>'></asp:Label>
                            </td>
                            <td runat="server" align="center">
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_qyyldwb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_sybxdwb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_jbyldwb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_gsdwb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_sydwb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:Label ID="lb_dwbxhj" runat="server" align="center" Width="120px" BackColor="Transparent"
                                    Text='<%#Eval("SH_DWBXHJ").ToString()=="0"?"":Eval("SH_DWBXHJ").ToString()=="0.00"?"":Eval("SH_DWBXHJ").ToString()=="0.0000"?"":Eval("SH_DWBXHJ")%>'></asp:Label>
                            </td>
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_qyylgr" runat="server" Width="100px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_jbylgr" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_qyylgrb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_sybxgrb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_jbylgrb" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_deylgr" runat="server" Width="90px" align="center" BorderStyle="None"
                            ...
                            <td runat="server" align="center">
                                <asp:Label ID="lb_grbxhj" runat="server" BackColor="Yellow" Width="120px" align="center"
                                    Text='<%#Eval("SH_GRBXHJ").ToString()=="0"?"":Eval("SH_GRBXHJ").ToString()=="0.00"?"":Eval("SH_GRBXHJ").ToString()=="0.0000"?"":Eval("SH_GRBXHJ")%>'></asp:Label>
                            </td>
                            <td runat="server" align="center">
                                <asp:TextBox ID="tb_shqt" runat="server" Width="90px" align="center" BorderStyle="None"
