<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="OM_JXADDSP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_JXADDSP" Title="人员增加绩效审批" %>
            ...
            <table style="width: 100%;">
                <tr>
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        类型：<asp:DropDownList ID="drp_type" runat="server" OnSelectedIndexChanged="drp_type_SelectedIndexChanged"
                                            AutoPostBack="True">
                                            <asp:ListItem Value="" Selected="True">-请选择-</asp:ListItem>
                                            <asp:ListItem Value="1">绩效工资系数调整</asp:ListItem>
                                            <asp:ListItem Value="2">人员绩效减少</asp:ListItem>
                                            <asp:ListItem Value="3">新增人员绩效</asp:ListItem>
                              </asp:DropDownList>
                   </td>
                   <td>
                   ...
                   <td align="right">
                        <asp:HyperLink ID="hpladd" runat="server" NavigateUrl="~/OM_Data/OM_JXADDSPADD.aspx?" Target="_blank" Font-Underline="false"><asp:Image ID="AddImage2" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2" ImageAlign="AbsMiddle" runat="server" Width="20px" />添加</asp:HyperLink>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <asp:Repeater ID="rpt1" runat="server">
                                ...
                                <ItemTemplate>
                                    <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" onclick="javascript:change(this);"
                                        ...
                                        <td align="center">
                                            <asp:Label ID="lbtype" runat="server" Text='<%#Eval("type").ToString()=="1"?"绩效工资系数调整":Eval("type").ToString()=="2"?"人员绩效减少":Eval("type").ToString()=="3"?"新增人员绩效":"无"%>'></asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:Label ID="lbname" runat="server" Width="90px" Text='<%#Eval("jxaddstname")%>'></asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:Label ID="lbdepartment" runat="server" Width="50px" Text='<%#Eval("jxadddepartment")%>'></asp:Label>
                                        </td>
                                        <td align="center">
                                            <asp:Label ID="lbjxgzxs" runat="server" Width="90px" Text='<%#Eval("jxgzxs")%>'></asp:Label>
                                        </td>
                                        ...
                                        <td>
                                        <asp:HyperLink ID="hlContract3" Target="_blank" ToolTip="查看/审核" NavigateUrl='<%#"~/OM_Data/OM_JXADDSPdetail.aspx?spid="+Eval("bh") %>'
                                    ...
                                    查看/审核
                                        ...
                                        <td align="center">
                                            <asp:TextBox ID="things" Width="150px" runat="server" Text='<%#Eval("things")%>' TextMode="MultiLine" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
