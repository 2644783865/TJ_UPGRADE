<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_GdzcBaofeiSP.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_GdzcBaofeiSP"
    Title="固定资产报废审批" %>
        ...
        <div class="box-outer">
            <div id="div_statistcs" style="width: 100%; height: auto; overflow: scroll; display: block;">
                <table id="tab" align="center" cellpadding="2" cellspacing="1" class="toptable grid nowrap"
                    border="1" width="100%">
                    <asp:Repeater ID="rptGDZCBF" runat="server" OnItemDataBound="rptGDZCBF_OnItemDataBound">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'"
                                ...
                                <td>
                                    <asp:HyperLink runat="server" ID="hlChaKan" Target="_blank" NavigateUrl='<%#"OM_GdzcBaofei_Detail.aspx?action=read&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
                                ...
                                <td>
                                    <asp:HyperLink runat="server" ID="hlXiuGai" NavigateUrl='<%#"OM_GdzcBaofei_Detail.aspx?action=alter&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
                                ...
                                <td>
                                    <asp:HyperLink ID="hlContract" runat="server" NavigateUrl='<%#"OM_GdzcBaofei_Detail.aspx?action=check&id="+DataBinder.Eval(Container.DataItem,"SPBH").ToString()%>'>
