<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="OM_NJCX.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_NJCX" Title="查询" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div align="center" style="width: 100%">
        <table width="80%">
            <tr>
                <td align="left">
                    <strong style="font-size: medium">姓名/工号 ：</strong>
                    <asp:TextBox ID="txtCx" runat="server" Width="90px" Style="right" Height="30px" Font-Size="Medium"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <strong style="font-size: medium">请输入密码：</strong>
                    <asp:TextBox ID="txtpassword" runat="server" Width="90px" Style="right" Height="30px"
                        Font-Size="Medium" TextMode="Password"></asp:TextBox>
                    <asp:Button ID="btncx" runat="server" Text="登录" OnClick="btncx_click" Height="30px"
                        Font-Size="Medium" />
                </td>
            </tr>
        </table>
