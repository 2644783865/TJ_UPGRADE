<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_LSPX_SQ.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_LSPX_SQ" %>
                            ...
                            <tr>
                                <td align="center" style="font-size: x-large;">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPX_YEAR" onblur="nfyz(this)" Width="60px" Height="25px"
                                        Font-Size="Medium"></asp:TextBox><span style="color: Red">*</span> 临时培训计划申报表
                                </td>
                            </tr>
                        </table>
                        <table class="tab">
                ...
                <div style="width: 100%; background-color: #F0F8FF" align="center" id="div2">
                    <asp:Panel runat="server" ID="panZDR">
                        <table class="tab">
                            <tr>
                                <td colspan="4">
                                    <span style="color: Red">注： 默认一级审批---部门领导审批，请正确选择审批人。</span>
                                </td>
                            </tr>
