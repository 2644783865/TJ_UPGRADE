<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="OM_KaoHe_JXGZFinal.aspx.cs" Inherits="ZCZJ_DPF.OM_Data.OM_KaoHe_JXGZFinal" %>
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="mover(this)" onmouseout="mout(this)" onclick="javascript:change(this);"
                                ...
                                <td id="Td4" runat="server" align="center">
                                    <asp:Label ID="lblPosition" runat="server" Text='<%#Eval("PosName")%>'></asp:Label>
                                </td>
                                ...
                                <td id="Td7" runat="server" align="center">
                                    <asp:Label ID="DepScore" runat="server" Text='<%#Eval("DepartScore")%>'></asp:Label>
                                </td>
                                <td id="Td8" runat="server" align="center">
                                    <asp:Label ID="lblGWXS" runat="server" Text='<%#Eval("GangWeiXiShu")%>'></asp:Label>
                                </td>
                                <td id="Td9" align="center" runat="server">
                                    <asp:Label ID="lblScoreZong" runat="server" Text='<%#Eval("Score")%>' name="lblScoreZong"></asp:Label>
                                </td>
                                <td id="Td10" runat="server" align="center">
                                    <asp:Label ID="txtMoney" runat="server" align="center" Width="100px" BorderStyle="None"
                                        BackColor="Transparent" Text='<%#Eval("Money")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
