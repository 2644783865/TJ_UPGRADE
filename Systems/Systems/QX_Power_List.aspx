...
AutoEventWireup="true" CodeBehind="QX_Power_List.aspx.cs" Inherits="FSGD_PMS.Systems.QX_Power_List" %>
...
<asp:Content ID="Content2"  ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div class="box-inner">
        <div class="box_right">
            ...
            <tr><td>修改 / 删除权限信息</td>
                <td align=right><asp:HyperLink ID="HyperLink3" NavigateUrl="~/Systems/QX_Power_Detail.aspx?Action=Add" runat="server">添加权限</asp:HyperLink></td>
            </tr></table>
            </div>
        </div>
    </div>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="修改">
                                ...
                                <asp:HyperLink ID="hlDetail" CssClass="link" Target="_blank" 
                                 NavigateUrl='<%#Eval("QX_Power_Detail_URL")%>' runat="server">
                        ...
                        <asp:TemplateField HeaderText="删除">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lblattachdel" class="link" runat="server" CommandName="del" 
                                        onclientclick="return confirm(&quot;是否删除该权限页面？&quot;)">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                    </Columns>
    ...
    <div class="PageChange"><mb:Pager ID="Pager" runat="server" /> 
