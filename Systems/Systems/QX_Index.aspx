<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QX_Index.aspx.cs" Inherits="FSGD_PMS.Systems.QX_Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>佛山光电项目管理系统-->项目管理</title>
</head>
    <frameset id="mfrm" id = "mfrm" rows="63,*,32" cols="*" framespacing="0" frameborder="0" border="0" scrolling="yes">
