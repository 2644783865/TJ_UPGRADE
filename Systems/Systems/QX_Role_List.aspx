...
AutoEventWireup="true" CodeBehind="QX_Role_List.aspx.cs" Inherits="FSGD_PMS.Systems.QX_Role_List" %>
...
<asp:Content ID="Content2"  ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div class="box-inner">
        <div class="box_right">
            ...
            <tr><td>修改 / 删除角色信息</td>
                <td align=right><asp:HyperLink ID="HyperLink3" NavigateUrl="~/Systems/QX_Role_Detail.aspx?Action=Add" runat="server">添加角色</asp:HyperLink></td>
            </tr></table>
            </div>
        </div>
    </div>
