<%@ Page Language="C#" MasterPageFile="~/Masters/PopupBase.master" AutoEventWireup="true"
    CodeBehind="CM_SW_Payment.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_SW_Payment" %>
                        ...
                        <table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1"
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    要款单号：<asp:Label ID="lblYKDH" runat="server"></asp:Label>
                                </td>
                                <td colspan="2" align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="rblState" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Text="未支付" Value="0" Selected="True"></asp:ListItem>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPZ" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="txtCWB" runat="server" Text="" TextMode="MultiLine" Height="40px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
