                        ...
                        <tr>
                            <td align="right">
                                ...
                                <asp:HyperLink ID="hplAddFP" CssClass="hand" runat="server" onClick="javascript:return btnADDSWFP_onclick();">
                                    <asp:Image ID="ImageAdd" ImageUrl="~/assets/images/Add_new_img.gif" border="0" hspace="2" align="absmiddle" runat="server" />添加发票
                                </asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                            </td>
                        </tr>
                        ...
                        <asp:Panel ID="Pal_Query" runat="server">
                            <table width="100%">
                                <tr>
                                    <td>
                                        合同编号:
                                        <asp:TextBox ID="txt_HTBH" runat="server" Width="120px"></asp:TextBox>
                                    </td>
                                    <td>
                                        项目名称:
                                        <asp:TextBox ID="txt_PJNAME" runat="server" Width="150px"></asp:TextBox>
                                    </td>
                                    <td>
                                        开票单位:
                                    ...
                                    <td>
                                        开票时间:
                                        <asp:TextBox ID="kpsta_time" runat="server" Width="80px"></asp:TextBox>
                                        至&nbsp;<asp:TextBox ID="kpend_time" runat="server" Width="80px"></asp:TextBox>
                                    ...
                                    <td>
                                        收票时间:
                                        <asp:TextBox ID="spsta_time" runat="server" Width="80px"></asp:TextBox>
                                        至&nbsp;<asp:TextBox ID="spend_time" runat="server" Width="80px"></asp:TextBox>
