<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master" CodeBehind="CM_Contract_BG.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_Contract_FY" %>
...
<div class="RightContent">
    ...
    <div style="height:8px" class="box_top"></div>
        <div class="box-outer">
            ...
            &nbsp;|&nbsp;<asp:Button ID="btn_DelHT" runat="server" Text="删 除" OnClick="btn_DelHT_Click"  OnClientClick="javascript:return confirm('确定删除吗？')"/>
    ...
    <td>运输单位：<asp:TextBox ID="txt_GHS" runat="server" Width="205px"></asp:TextBox>
    ...
    <td>合同年份：<asp:DropDownList ID="htnf" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_Click"></asp:DropDownList></td>    
            ...
            <Columns>                
                ...
                <asp:BoundField DataField="PCON_CUSTMNAME" HeaderText="运输单位"  ItemStyle-HorizontalAlign="Left" 
              ...
              <%-- <asp:TemplateField HeaderText="是否索赔" ItemStyle-HorizontalAlign="Center"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                ...
                <ItemTemplate>
                 ...
                 ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                <asp:TemplateField HeaderText="合同评审状态" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                 <ItemTemplate>
