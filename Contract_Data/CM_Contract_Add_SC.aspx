<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/PopupBase.Master" AutoEventWireup="true"
    CodeBehind="CM_Contract_Add_SC.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_Contract_Add_SC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CREdit(i) {
            var ID = i.title;
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_CHECKREQUEST.aspx?Action=Edit&autonum=" + autonum + "&contactform=1&CRid=" + ID);
        }
        ...
        function CRView(i) {
            ...
            window.showModalDialog("CM_CHECKREQUEST.aspx?Action=View&contactform=1&CRid=" + ID + "&NoUse=" + seconds, obj, "dialogHeight:800px;dialogWidth:1100px");
        }
        ...
        function View_PurOrder(orderid) {
            var autonum = Math.round(10000 * Math.random());
            window.open("../PM_Data/PM_Xie_list.aspx?autonum=" + autonum + "&TotalOrder=" + orderid + "");
        }
        ...
        function BCXYView(i) {
            var crid = i.title;
            var autonum = Math.round(10000 * Math.random());
            window.open('CM_ContractView_Audit.aspx?Action=view&autonum=' + autonum + '&ID=' + crid + '&Type=8');
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td align="right" style="width: 40%;">
                            <asp:Label ID="lblRemind" runat="server" ForeColor="Red" Text="操作成功！" Visible="false"></asp:Label>
                            &nbsp;
                            <asp:LinkButton ID="Lbtn_ViewOrder" runat="server" OnClick="btn_ViewOrder_Click" OnClientClick="return">
                    ...
                    <asp:Panel ID="palBasicInfo" runat="server">
                        <table class="tabGg" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td class="right_bg">
                                    <asp:TextBox ID="txtPCON_FILLDATE" runat="server" onclick="setday(this);"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="r_bg">
                                ...
                                <td class="right_bg">
                                    <asp:TextBox ID="tb_revid" runat="server" Enabled="false"></asp:TextBox>
                                </td>
                                <td class="r_bg">
                                    市场部合同号:
                                </td>
                                <td class="right_bg">
                                    <asp:TextBox ID="txtPCON_TASK" Text="" runat="server" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="right_bg">
                                    <asp:TextBox ID="txtPCON_ORDERID" runat="server" TextMode="MultiLine" Rows="5" Width="90%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="r_bg">
                                        ...
                                        <asp:Repeater ID="addRep" runat="server" OnItemDataBound="addRep_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                    ...
                                                    <td>
                                                        <asp:Label ID="CM_CONTR" runat="server" Width="100px" Text='<%# Eval("CM_CONTR")%>'
                                                            CssClass="center"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="TSA_ID" runat="server" Width="100px" Text='<%# Eval("TSA_ID")%>' CssClass="center"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="CM_CUS" runat="server" Width="200px" Text='<%# Eval("CM_CUS")%>'
                                                            CssClass="center"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="CM_HEGE" runat="server" Width="50px" Text='<%# Eval("CM_HEGE")%>'
                                                            CssClass="center"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="CM_CONTENT" runat="server" Width="100px" Text='<%# Eval("CM_CONTENT")%>'
                                                            CssClass="center"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="CM_BUJIAN" runat="server" Width="100px" Text='<%# Eval("CM_BUJIAN")%>'
                                                            CssClass="center"></asp:TextBox>
                                                    </td>
                                                    <td>
