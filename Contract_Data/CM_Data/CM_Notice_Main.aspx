<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master" CodeBehind="CM_Notice_Main.aspx.cs" Inherits="ZCZJ_DPF.CM_Data.CM_Notice_Main" %>
      ...
      <tr>
            <td>  
                分类查询： 
                          ...
                          <td align="right"> <asp:Label ID="Label3" runat="server" Text="按项目编号："></asp:Label>
                             
                             </td>
                             <td style="height:42px" valign="top">
                                 <asp:ComboBox ID="ComboBox2" runat="server" AutoCompleteMode="SuggestAppend" 
                                     Width="100px" DropDownStyle="DropDownList"  AutoPostBack="true"
                                     onselectedindexchanged="ComboBox2_SelectedIndexChanged">
                                 </asp:ComboBox>
      
                                 <asp:DropDownList ID="DropDownList1" runat="server" 
                                    AutoPostBack="True" Width="90px"  Visible="false"  >
                            ...
                            <td width="30%" align="right"><asp:HyperLink ID="hpTask"  NavigateUrl="CM_Notice.aspx?action=add"  runat="server">新建联系单</asp:HyperLink></td>
             </tr>
             </table>
         <%--<div class="box-wrapper">
            <div class="box-outer">--%>
             ...
             <asp:Label ID="BSC_ID"  runat="server" Visible="false"  Text='<%#Eval("DCS_ID")%>'></asp:Label>
                ...
                <td ><%#Eval("DCS_PROJECT")%>&nbsp;</td>              
                  <td><%#Eval("DCS_PROJECTID")%> &nbsp;</td> 
                    <td>
                        <asp:Label ID="BCSTYPE" runat="server" Text='<%#Eval("DCS_TYPE")%>' ></asp:Label></td> 
                     <td><%#Eval("DCS_DATE")%> &nbsp;</td> 
                 <td><asp:HyperLink ID="HyperLink1" NavigateUrl='<%#"CM_Notice.aspx?action=update&id="+Eval("DCS_ID") %>'  runat="server" ><asp:Image ID="Image2" ImageUrl="~/assets/images/res.gif" border="0" hspace="2" align="absmiddle" runat="server" />
                     修改</asp:HyperLink>
                 
                 </td> 
                 <td><asp:HyperLink ID="HyperLink2" NavigateUrl='<%#"CM_Notice.aspx?action=view&id="+Eval("DCS_ID") %>'  runat="server" ><asp:Image ID="Image3" ImageUrl="~/assets/images/res.gif" border="0" hspace="2" align="absmiddle" runat="server" />
                     查看详细</asp:HyperLink></td></tr>
