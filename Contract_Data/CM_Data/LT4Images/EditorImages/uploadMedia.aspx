...
break;
case "flv":
document.getElementById("mediaWidth").value="352";
document.getElementById("mediaHeight").value="288";
break;
default:
document.getElementById("mediaWidth").value="300";
document.getElementById("mediaHeight").value="200";
...
<input language="javascript" onclick="window.close();" type="image" onMouseOver="this.className='overcolor'" onMouseOut="this.className=''" src="img/close.gif" title="<%=ResourceManager.GetString("close")%>" /><br /><%=ResourceManager.GetString("width")%>：<input id="mediaWidth" maxlength="10" style="width: 45px" type="text" value="300" />px
&nbsp;<%=ResourceManager.GetString("height")%>：<input
id="mediaHeight" maxlength="10" style="width: 45px" type="text" value="200" />px
&nbsp;
<%=ResourceManager.GetString("volume")%>：<input id="vol" maxlength="100" style="width: 30px" type="text" size="" value="90" />%&nbsp;<input id="loop" type="checkbox" checked="CHECKED" /><%=ResourceManager.GetString("loop")%></td>
