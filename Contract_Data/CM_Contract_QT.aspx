<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master" CodeBehind="CM_Contract_QT.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_Contract_QT" %>
...
<ContentTemplate>  
    ...
    <div style="height:8px" class="box_top"></div>
        <div class="box-outer">
         <table width="100%"> <%--操作按钮--%>
            ...
            &nbsp;|&nbsp;<asp:Button ID="btn_DelHT" runat="server" Text="删 除" OnClick="btn_DelHT_Click"  OnClientClick="javascript:return confirm('删除操作不可逆！确定删除吗？')"/>
            ...
            &nbsp;|&nbsp;<asp:Button ID="btn_Export" runat="server" Text="导 出" OnClick="btn_Export_Click" OnClientClick="javascript:return confirm('导出当前筛选记录吗？')"/>
            </td>
            </tr>
            </table>
          ...
          <table width="100%">
    <tr>
    <td >合同编号：<asp:TextBox ID="txtHTH" runat="server" Width="205px"></asp:TextBox></td>
    <td >合同名称：<asp:TextBox ID="txt_HTNAME" runat="server" Width="205px"></asp:TextBox></td>
    <td >责任部门：<asp:DropDownList ID="dplBM" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dplBM_SelectedIndexChanged">
        </asp:DropDownList></td>
    </tr>
    
    <tr>
    <td>项目名称：<asp:TextBox ID="txt_PJNAME" runat="server" Width="205px"></asp:TextBox></td>
    <td>签订单位：<asp:TextBox ID="txt_GHS" runat="server" Width="205px"></asp:TextBox>
    ...
    <td>负 责 人：<asp:DropDownList ID="dplFZR" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_Click">
        </asp:DropDownList>
    </td>
    </tr>
    
    <tr>     
     <td >签订时间：<asp:TextBox ID="sta_time" runat="server" Width="90px" onchange="dateCheck(this)"></asp:TextBox>
         ...
         <asp:CalendarExtender ID="calender_sta" runat="server" Format="yyyy-MM-dd" DaysModeTitleFormat="MM月,yyyy年"  
                        TodaysDateFormat="yyyy年MM月dd日"  TargetControlID="sta_time"></asp:CalendarExtender>
         <asp:CalendarExtender ID="calender_end" runat="server" Format="yyyy-MM-dd" DaysModeTitleFormat="MM月,yyyy年"  
                        TodaysDateFormat="yyyy年MM月dd日"  TargetControlID="end_time"></asp:CalendarExtender>
     </td>
    <td>付款比例：<asp:DropDownList ID="ddlfkbl" runat="server">
    ...
    <tr>
       <td>合同评审状态：<asp:DropDownList ID="htps_state" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_Click">
    ...
    <td>合同年份：<asp:DropDownList ID="htnf" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_Click"></asp:DropDownList></td>    
    </tr>
    </table>
          </asp:Panel>                    
            ...
            AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333"  ShowFooter="true"  OnRowDataBound="grv_RowDataBound">           
            <Columns>
                <asp:TemplateField HeaderText="序号" ItemStyle-HorizontalAlign="Center"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lbl_rspdepid" runat="server" Text='<%#Eval("PCON_RSPDEPID")%>' Visible="false"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="PCON_CUSTMNAME" HeaderText="公司名称"  ItemStyle-HorizontalAlign="Left" 
                 ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                <asp:BoundField DataField="PCON_JINE" HeaderText="合同金额" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" 
                 ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
               <asp:BoundField DataField="PCON_BALANCEACNT" HeaderText="结算金额" DataFormatString="{0:c}"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false"
                ItemStyle-HorizontalAlign="Right" />
                <asp:TemplateField HeaderText="开票金额" ItemStyle-HorizontalAlign="Right"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:Label ID="lbl_kpje" runat="server" Text=""></asp:Label>
                </ItemTemplate>
                </asp:TemplateField> 
                <asp:BoundField DataField="PCON_YFK" HeaderText="已付金额" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                <asp:TemplateField HeaderText="付款比例" ItemStyle-HorizontalAlign="Right"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="请款金额" ItemStyle-HorizontalAlign="Right"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:Label ID="lbl_qkje" runat="server" Text=""></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>                
                
               <%-- <asp:TemplateField HeaderText="是否索赔" ItemStyle-HorizontalAlign="Center"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:Label ID="lbl_state" runat="server" Text='<%#(Eval("PCON_ERROR").ToString()=="0"?"正常":"索赔")%>' ForeColor='<%#Eval("PCON_ERROR").ToString()=="1"?System.Drawing.Color.Red:System.Drawing.Color.FromName("#333333") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField HeaderText="索赔金额" DataField="PCON_SPJE"  DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" 
                 ItemStyle-Wrap="false" HeaderStyle-Wrap="false" ItemStyle-ForeColor="Red"/>
                <asp:TemplateField HeaderText="合同变更" ItemStyle-HorizontalAlign="Center"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                <ItemTemplate>
                    <asp:Label ID="lbl_change" runat="server" Text='<%#"JE("+Eval("PCON_JECHG").ToString()+")"+"-"+"QT("+Eval("PCON_QTCHG").ToString()+")"%>' ForeColor='<%#Eval("PCON_QTCHG").ToString()!="0"?System.Drawing.Color.Red:Eval("PCON_JECHG").ToString()!="0"?System.Drawing.Color.Red:System.Drawing.Color.Blue %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>--%>
                 <asp:BoundField DataField="PCON_RESPONSER" HeaderText="负责人"  ItemStyle-HorizontalAlign="Center" 
                 ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                  <asp:TemplateField HeaderText="合同评审状态" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                 <ItemTemplate>
            ...
            <FooterStyle BackColor="#A8DCF8" Font-Bold="True" ForeColor="White" />
...
{
  var autonum=Math.round(10000*Math.random()); 
  window.open("CM_CHECKREQUEST.aspx?Action=Add&ConForm="+conform+"&autonum="+autonum+"&condetail_id="+ID);
