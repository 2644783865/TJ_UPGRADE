<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master"
    CodeBehind="CM_Contract_WW.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_Contract_WW" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ViewHT(ID, conform) {
            ...
            window.open("CM_Contract_Add_SC.aspx?Action=View&ConForm=" + conform + "&autonum=" + autonum + "&condetail_id=" + ID);
        }

        //编辑合同
        function EditHT(ID, conform) {
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_Contract_Add_SC.aspx?Action=Edit&ConForm=" + conform + "&autonum=" + autonum + "&condetail_id=" + ID);
        }

        //添加请款
        function Add_QK(ID, conform) {
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_CHECKREQUEST_SC.aspx?Action=Add&ConForm=" + conform + "&autonum=" + autonum + "&condetail_id=" + ID);
        ...
        function Add_HT(conform) {
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_Contract_Add_SC.aspx?Action=Add&autonum=" + autonum + "&ConForm=" + conform);
        }
    </script>
