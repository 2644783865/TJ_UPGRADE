<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master"
    CodeBehind="CM_Contract_CG.aspx.cs" Inherits="ZCZJ_DPF.Contract_Data.CM_Contract_CG" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
                ...
                <div class="box-wrapper">
                    ...
                    <div class="box-outer">
                        ...
                        <asp:Panel ID="Pal_Query" runat="server">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        订 单 号：<asp:TextBox ID="txt_Orderid" runat="server" Width="205px"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        供 货 商：<asp:TextBox ID="txt_GHS" runat="server" Width="205px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        结 算 单：<asp:DropDownList ID="ddl_jsd" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_Click">
                        ...
                        <asp:Panel ID="PanelBody" runat="server" Style="overflow: auto; position: relative;
                            ...
                            <asp:SmartGridView ID="GRV_CON" Width="100%" CssClass="toptable grid" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PCON_BCODE" HeaderText="合同编号" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PCON_ENGTYPE" HeaderText="类别" ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="PCON_PJNAME" HeaderText="项目名称" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false"></asp:BoundField>
                                    <asp:BoundField DataField="PCON_ENGNAME" HeaderText="设备名称" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false"></asp:BoundField>
                                    <asp:BoundField DataField="PCON_CUSTMNAME" HeaderText="单位名称" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_CONTR" HeaderText="市场合同号" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_PROJ" HeaderText="项目名称" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_ENGNAME" HeaderText="设备名称" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_MATERIAL" HeaderText="材质" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_MODEL" HeaderText="规格型号" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_NUMBER" HeaderText="数量" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_ALL" HeaderText="总重量" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="CM_PRICE" HeaderText="单价" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="PCON_FILLDATE" HeaderText="签订日期" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="PCON_DELIVERYDATE" HeaderText="交货日期" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false" />
                                    <asp:BoundField DataField="PCON_JINE" HeaderText="金额（元）" DataFormatString="{0:c}"
                                   ...
                                   <%-- <asp:TemplateField HeaderText="是否索赔" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false"
                                    ...
                                    <asp:BoundField DataField="PCON_RESPONSER" HeaderText="负责人" ItemStyle-Wrap="false"
                                        HeaderStyle-Wrap="false" />
    ...
    <script type="text/javascript">
        ...
        function ViewHT(ID, conform) {
            ...
            window.open("CM_Contract_Add.aspx?Action=View&ConForm=" + conform + "&autonum=" + autonum + "&condetail_id=" + ID);
        }

        //编辑合同
        function EditHT(ID, conform) {
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_Contract_Add.aspx?Action=Edit&ConForm=" + conform + "&autonum=" + autonum + "&condetail_id=" + ID);
        }
        ...
        function Add_HT(conform) {
            var autonum = Math.round(10000 * Math.random());
            window.open("CM_Contract_Add.aspx?Action=Add&autonum=" + autonum + "&ConForm=" + conform);
        }
    </script>
