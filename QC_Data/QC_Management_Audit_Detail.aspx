                    ...
                    <asp:TemplateField HeaderText="问题">
                        <ItemTemplate>
                           <%-- <input id="txtIssue" type="text" runat="server" value='<% #Eval("AU_ISSUE") %>' style="width: 300px" />--%>
                             <textarea id="txtIssue" runat="server" value='<% #Eval("AU_ISSUE") %>' style="width: 300px"></textarea>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="解决措施">
                        <ItemTemplate>
                          <%--  <input id="txtAction" type="text" runat="server" value='<% #Eval("AU_ACTION") %>' style="width: 300px" />--%>
                            <textarea id="txtAction" runat="server" value='<% #Eval("AU_ACTION") %>' style="width: 300px"></textarea>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"  />
                    </asp:TemplateField>
