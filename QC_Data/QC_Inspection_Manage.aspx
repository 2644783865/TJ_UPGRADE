                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td style="white-space: nowrap; width: 20%;" align="left">
                            ...
                            <asp:DropDownList ID="DropDownListDep" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownListDep_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="05">采购部</asp:ListItem>
                    ...
                    <tr>
                        <td style="width: 20%">
                            ...
                            <asp:AutoCompleteExtender ID="gcmc_AutoCompleteExtender" runat="server" DelimiterCharacters=""
                                Enabled="True" FirstRowSelected="True" MinimumPrefixLength="1" ServiceMethod="gcmc"
                                ServicePath="~/Ajax.asmx" TargetControlID="TextBoxEng" UseContextKey="True">
                        ...
                        <td style="white-space: nowrap; width: 20%;" align="left">
                            ...
                            <asp:AutoCompleteExtender ID="aceSearch" runat="server" CompletionSetCount="15" ServiceMethod="GetSUPPLERNM"
                                FirstRowSelected="true" Enabled="true" DelimiterCharacters="" ServicePath="QC_Data.asmx"
                                TargetControlID="TextBoxSUPPLERNM" UseContextKey="True" CompletionInterval="10"
                ...
                <asp:GridView ID="GridView1" Width="100%" CssClass="toptable" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AFI_TSDEP" HeaderText="部门" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="AFI_SUPPLERNM" HeaderText="供应商" HeaderStyle-Wrap="false"
                            ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" />
                        ...
                        <asp:BoundField DataField="AFI_NOTE" HeaderText="备注" HeaderStyle-Wrap="false" ItemStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" />
