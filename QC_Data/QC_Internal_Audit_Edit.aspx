<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="QC_Internal_Audit_Edit.aspx.cs" Inherits="ZCZJ_DPF.QC_Data.QC_Internal_Audit_Edit" %>
            ...
            <table class="tabGg" cellpadding="0" cellspacing="0" width="100%">
                <asp:Panel ID="Panel1" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="right_bg">
                            <asp:CheckBoxList ID="cblDJType" runat="server" RepeatColumns="11">
                                <asp:ListItem Text="内审" Value="0" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="第二方审核" Value="1" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="第三方审核" Value="2" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td class="r_bg">
                            审核依据标准：
                        ...
                        <td class="right_bg">
                            <asp:CheckBoxList ID="cblZRF" runat="server" RepeatColumns="11">
                                <asp:ListItem Text="ISO9001" Value="0" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="ISO14001" Value="1" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="OHSAS18001" Value="2" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td class="r_bg">
                            问题类型：
                        ...
                        <td class="right_bg">
                            <asp:CheckBoxList ID="cblProblemType" runat="server" RepeatColumns="11">
                                <asp:ListItem Text="主要不符合事项" Value="0" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="轻微不符合事项" Value="1" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                                <asp:ListItem Text="观察/建议项" Value="2" onclick="CheckBoxList_Click(this)"></asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="right_bg">
                            <asp:TextBox ID="txtKaidanBH" runat="server" Text=""></asp:TextBox>
                        </td>
                        <td class="r_bg">
                            依据章节号：
                        </td>
                        <td class="right_bg">
                            <asp:TextBox ID="txtYiJuZJH" runat="server" Text=""></asp:TextBox>
                        </td>
                        <td class="r_bg">
                            开单日期：
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="right_bg" colspan="3">
                            <asp:TextBox ID="txtDeadLine" runat="server" class="easyui-datebox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="r_bg">
                    ...
                    <tr>
                        ...
                        <td class="right_bg" colspan="5">
                            <table width="100%">
                                ...
                                <tr>
                                    <td class="right_bg" style="width: 100px">
                                        自查类似问题:
                                    </td>
                                    <td class="right_bg" colspan="3">
                                        <asp:CheckBoxList ID="cblLSProblem" runat="server" RepeatColumns="11">
                            ...
                            <table width="100%">
                                <tr>
                                    <td class="right_bg" colspan="4">
                                         ...
                                         <asp:TextBox runat="server" ID="txtShiShiMX" Width="100%" TextMode="MultiLine" Height="100px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
