                ...
                <table style="width: 100%; height: 24px">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="openLink(0)" CssClass="link">新增内审</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <ItemTemplate>
                    <tr ondblclick="javascript:window.showModalDialog('QC_Internal_Audit_Edit.aspx?action=edit&id=<%#Eval("PRO_ID")%>','','DialogWidth=500px;DialogHeight=185px')">
                        ...
                        <td width="80px" align="center">
                            <asp:HyperLink ID="HyperLinkDetail" runat="server" NavigateUrl='<%#"~/QC_Data/QC_Internal_Audit_Detail.aspx?ProId="+Eval("PRO_ID") %>'>
