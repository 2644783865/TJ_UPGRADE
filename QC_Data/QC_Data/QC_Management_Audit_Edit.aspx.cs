    ...
    public partial class QC_Management_Audit_Edit : System.Web.UI.Page
    {
        ...
        protected void ButCon_Click(object sender, EventArgs e)
        {
            ...
            if (action == "add")
            {
                ...
                sqltext = string.Format("insert into TBQC_INTERNAL_AUDIT(PRO_ID,PRO_NAME,PRO_TIME,PRO_FUJIAN,PRO_NOTE,PRO_TYPE) values('{0}','{1}','{2}','{3}','{4}','3')", id, TxtName.Text.Trim(), TxtTime.Text.Trim(), filename.Text.Trim(), txtBZ.Text.Trim());
            }
            else
            {
