                ...
                <table width="100%">
                    <tr>
                        <td align="center">
                            ...
                            &nbsp;
                            <asp:Label ID="LabelNotes" runat="server" Text="修改质检和重新质检时请勾选需要质检的子项" Visible="false" style="color: #FF3300"></asp:Label>
        ...
        <div style="width: 100%"  >
            <table cellpadding="4" style="margin-right: auto; margin-left: auto">
                <tr>
                    ...
                    <td align="left">
                        <asp:Label ID="LabelEngID" runat="server" Text=""></asp:Label>
                ...
                <tr>
                    ...
                    <td align="left" style="white-space: nowrap">
                        ...
                        <asp:Label ID="Labelpartnm" runat="server" Text="*" ForeColor="Red"  Width="2px" style="display: none;float:right"></asp:Label>
                    </td>
                    <td align="center">
                        供货单位:
                    </td>
                    ...
                    <td align="left">
                        ...
                        <asp:Label ID="Labelsit" runat="server" Text="*" ForeColor="Red" Width="2px" style="display: none;float:right"></asp:Label>
                    </td>
                    <td align="center">
                        报检时间:
                    </td>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:Label ID="LabelContracter" runat="server" Text="*" ForeColor="Red" 
                            Width="2px" style="display: none;float:right"></asp:Label>
                    </td>
                    <td align="center">
                        联系电话:
                    </td>
                    <td align="left">
                        ...
                        <asp:Label ID="LabelTel" runat="server" Text="*" ForeColor="Red" Width="2px" style="display: none;float:right"></asp:Label>
                    </td>
                    <td align="center">
                        需要质检时间:
                    </td>
                    <td align="left">
                        <asp:TextBox ID="TextBoxDate" runat="server" style="float:left"></asp:TextBox><asp:Label ID="LabelDate" runat="server" Text="*" ForeColor="Red" Width="2px" style="display: none;float:right"></asp:Label>
         ...
         <%--   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>--%>
                <div id="div_q">
                    <div class="fakeContainer" id="div">
                        ...
                        <asp:Repeater ID="RepeaterItem" runat="server"  OnItemDataBound="RepeaterItem_ItemDataBound" >
                            ...
                            <ItemTemplate>
                                <tr >
                                    ...
                                    <td>
                                        <div align="center">
                                            <asp:TextBox ID="TextBoxQCMan" runat="server" Text='<%#Eval("QCMANNM")%>'></asp:TextBox></div>
                                    </td>
                                    <td>
                                        <div align="center">
                                            <asp:TextBox ID="TextBoxDate" runat="server" Text='<%#Eval("QCDATE")%>'></asp:TextBox>
                                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBoxDate"
                                                TodaysDateFormat="yyyy-MM-dd" Format="yyyy-MM-dd" FirstDayOfWeek="Monday">
                                            </asp:CalendarExtender>
                                        </div>
                        ...
                        <td width="900">
                            <table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:RadioButtonList ID="RadioButtonListFileType" runat="server" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="ISR_JGREPORT" Selected="True">交工报告</asp:ListItem>
                                            <asp:ListItem Value="ISR_ZJREPORT">自检记录</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>
