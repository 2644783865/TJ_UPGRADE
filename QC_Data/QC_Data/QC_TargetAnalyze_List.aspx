                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="查看" HeaderStyle-Wrap="false"
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "~/QC_Data/QC_TargetAnalyze_Edit.aspx?tarId="+Eval("TARGET_ID")%>'
                                runat="server"> <asp:Image ID="Image11" ImageUrl="~/Assets/images/res.gif" runat="server" border="0"
