...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        function openLink(url) {
            var returnVlue = window.showModalDialog("QC_External_Audit_Edit.aspx?action=add&Id=" + url, '', "dialogHeight:185px;dialogWidth:500px;status:no;scroll:yes;center:yes;toolbar=no;menubar=no");
        }
    </script>
                ...
                <table style="width: 100%; height: 24px">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="openLink(0)" CssClass="link">新增外审</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div>
        <table cellpadding="4" cellspacing="1" class="toptable grid" border="1">
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <tr ondblclick="javascript:window.showModalDialog('QC_Internal_Audit_Edit.aspx?action=edit&id=<%#Eval("PRO_ID")%>','','DialogWidth=500px;DialogHeight=185px')" title="双击修改" style="cursor:pointer">
                        ...
                        <td width="80px" align="center">
                            <asp:HyperLink ID="HyperLinkDetail" runat="server" NavigateUrl='<%#"~/QC_Data/QC_External_Audit_Detail.aspx?ProId="+Eval("PRO_ID") %>'>
