...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <div class="box-inner">        <asp:Label ID="ControlFinder" runat="server" Visible="false"></asp:Label>
        <div class="box_right">
            <div class="box-title">
                <table style="width: 100%; height: 24px">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="openLink(0)"><asp:Image ID="Image1" ImageUrl="~/assets/images/res.gif" border="0" hspace="2" align="absmiddle"
                                            runat="server" />新增管审</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div>
        <table cellpadding="4" cellspacing="1" class="toptable grid" border="1">
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <tr ondblclick="javascript:window.showModalDialog('QC_Management_Audit_Edit.aspx?action=edit&id=<%#Eval("PRO_ID")%>','','DialogWidth=500px;DialogHeight=185px')"
                        ...
                        <td align="center">
                             <asp:LinkButton ID="btnDownLoad" OnClick="btnDownLoad_Click" runat="server" CommandArgument='<%#Eval("PRO_ID")%>'> <%#Eval("PRO_FUJIAN")%></asp:LinkButton>
