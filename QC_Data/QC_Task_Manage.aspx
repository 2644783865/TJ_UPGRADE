                    ...
                    <asp:GridView ID="GridView1" Width="100%" CssClass="toptable grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="行号" HeaderStyle-Wrap="false">
                                <ItemTemplate>
                                    <input id="lblIndex" readonly="readonly" style="border-style: none; width: 20px"
                                        type="text" value="<%# Convert.ToInt32(Container.DataItemIndex +1) %>" />
                            ...
                            <asp:BoundField DataField="MTA_TCCLERKNM" HeaderText="技术负责人" HeaderStyle-Wrap="false"
                                ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="MTA_DUY" HeaderText="调度员" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                                ItemStyle-Wrap="false">
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
