<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true"
    CodeBehind="QC_Internal_Audit.aspx.cs" Inherits="ZCZJ_DPF.QC_Data.QC_INTERNAL_AUDIT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        function openLink(url) {
            //            var returnVlue = window.showModalDialog("QC_Internal_Audit_Edit.aspx?action=add&Id=" + url, '', "dialogHeight:185px;dialogWidth:500px;status:no;scroll:yes;center:yes;toolbar=no;menubar=no");
            //window.open("QC_Internal_Audit_Edit.aspx?action=add&Id=" + url);
            window.location.href = "QC_Internal_Audit_Edit.aspx";
        }
                ...
                <ItemTemplate>
                    <tr ondblclick="javascript:window.showModalDialog('QC_Internal_Audit_Edit.aspx?action=edit&id=<%#Eval("PRO_ID")%>','','DialogWidth=500px;DialogHeight=185px')">
                        ...
                        <td width="80px" align="center">
                            <asp:HyperLink ID="HyperLinkDetail" runat="server" NavigateUrl='<%#"~/QC_Data/QC_Internal_Audit_Edit.aspx?action=view&Id="+Eval("Id") %>'>
                                <asp:Image ID="Image11" ImageUrl="~/Assets/images/res.gif" runat="server" border="0"
                                    hspace="2" align="absmiddle" />查看</asp:HyperLink>
                        </td>
                        <td width="80px" align="center">
                            <asp:HyperLink ID="hpyAudit" runat="server" NavigateUrl='<%#"~/QC_Data/QC_Internal_Audit_Edit.aspx?action=audit&Id="+Eval("Id") %>'>
