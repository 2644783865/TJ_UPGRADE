                ...
                <table width="96%">
                    <tr>
                        <td align="right" width="50px">
                            <asp:Label ID="lb_bm" runat="server" Text="部门："></asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rbl_Depart" runat="server" RepeatDirection="Horizontal"
                                OnSelectedIndexChanged="rbl_Depart_SelectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Value="0" Text="部门查询"></asp:ListItem>
                                <asp:ListItem Value="1" Selected="True" Text="统计部门为当前用户所在部门"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td align="right">
                            ...
                            <asp:Button ID="btnDelete" runat="server" Width="40" Text="删除" OnClick="btnDelete_Click"
                                OnClientClick="return confirm('删除后不可恢复，确认删除？')" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="行号">
                <ItemTemplate>
                    ...
                    <input type="hidden" runat="server" id="hidTarId" value='<%#Eval("TARGET_ID") %>' />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="目标值" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <input id="txtComplete" type="text" runat="server" value='<%# Eval("TARGET_COMPLETE") %>'
                        style="width: 35px" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="统计部门" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList ID="ddlTJDepId" runat="server">
                    </asp:DropDownList>
                    <input type="hidden" id="txtTJDepId" runat="server" value='<%#Eval("TARGET_TJBMID") %>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
