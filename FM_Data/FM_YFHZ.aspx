<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_YFHZ.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_YFHZ" Title="运费汇总" %>
...
<div class="box-inner">
                  <div class="box_right">
                     <div class="box-title">
                        ...
                        <tr>
                            <td align="left">
                                <asp:HyperLink ID="hypyfzgcx" runat="server" NavigateUrl="FM_YFZGCX.aspx"><asp:Image ID="Image2" ImageUrl="~/Assets/images/res.gif" runat="server" />运费暂估查询</asp:HyperLink>
                            </td>
                                            ...
                                            <asp:TemplateField HeaderText="名称">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:DropDownList ID="DropDownListName" runat="server" Width="128px" Style="display: none">
                                                        <asp:ListItem Value="NO" Selected="True" Text=""></asp:ListItem>
                                                        <asp:ListItem Value="YFHZ_JSDH">结算单号</asp:ListItem>
                                                        <asp:ListItem Value="YFHZ_BJBH">图号</asp:ListItem>
                                                        <asp:ListItem Value="YFHZ_BJNAME">设备名称</asp:ListItem>
                                                        <asp:ListItem Value="YFHZ_TSAID">任务号</asp:ListItem>
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                ...
                <asp:Repeater ID="rptProNumCost" runat="server" OnItemDataBound="rptProNumCost_OnItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr class="baseGadget" align="center" onmouseover="this.className='highlight'" onclick="javascript:change(this);"
                            ...
                            <td align="center">
                                <asp:Label ID="lbjsdh" runat="server" Enabled="false" Text='<%#Eval("YFHZ_JSDH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbrwh" runat="server" Enabled="false" Text='<%#Eval("YFHZ_TSAID")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbyearmonth" runat="server" Enabled="false" Text='<%#Eval("YFHZ_YEARMONTH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbsl" runat="server" Enabled="false" Text='<%#Eval("YFHZ_NUM")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbzl" runat="server" Enabled="false" Text='<%#Eval("YFHZ_WIGHT")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbmoney" runat="server" Enabled="false" Text='<%#Eval("YFHZ_MONEY")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbhsmoney" runat="server" Enabled="false" Text='<%#Eval("YFHZ_HSMONEY")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbbjbh" runat="server" Enabled="false" Text='<%#Eval("YFHZ_BJBH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbbjname" runat="server" Enabled="false" Text='<%#Eval("YFHZ_BJNAME")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbgjzt" runat="server" Enabled="false" Text='<%#Eval("YFHZ_GJSTATE")%>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
