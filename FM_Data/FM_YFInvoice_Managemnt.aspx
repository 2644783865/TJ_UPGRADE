<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_YFInvoice_Managemnt.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_YFInvoice_Managemnt" Title="无标题页" %>
            ...
            <asp:HiddenField ID="hfdTotalHSJE" runat="server" />
                ...
                <yyc:SmartGridView ID="grvInv" CssClass="toptable grid" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="发票编号" DataField="YFGI_CODE" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                            ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="供应商" DataField="YFGI_GYSNAME" HeaderStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />                      
                        <asp:BoundField HeaderText="发票号码" DataField="YFGI_FPNUM" HeaderStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="金额" DataField="YFGI_MONEY" HeaderStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="税额" DataField="YFGI_SE" HeaderStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="含税金额" DataField="YFGI_HSMONEY"
                            HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="凭证号" DataField="YFGI_PZH" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                            ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="记账人" DataField="YFGI_JZNAME" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                            ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="制单人" DataField="YFGI_ZDNAME" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="Center"
                            ItemStyle-Wrap="false" />
                        <asp:BoundField HeaderText="登记日期" DataField="YFGI_DATE" DataFormatString="{0:d}" HeaderStyle-Wrap="false"
                            ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" />
                        <asp:TemplateField HeaderText="是否审核" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox12" runat="server" Checked='<%#Eval("YFGI_STATE").ToString()=="0"||Eval("YFGI_STATE").ToString()==""?false:true %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="是否勾稽" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox13" runat="server" Checked='<%#Eval("YFGI_GJFLAG").ToString()=="0"||Eval("YFGI_GJFLAG").ToString()==""?false:true %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="是否核算" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:CheckBox ID="CheckBox14" runat="server" Checked='<%#Eval("YFGJ_HSSTATE").ToString()=="0"||Eval("YFGJ_HSSTATE").ToString()==""?false:true %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="审核" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlContrac1t" Target="_blank" ToolTip="审核" NavigateUrl='<%#"~/FM_Data/FM_YFInvoice.aspx?Action=Audit&YFGI_CODE="+Eval("YFGI_CODE") %>'
                                    Visible='<%#Eval("YFGI_STATE").ToString()=="0"?true:false %>' CssClass="link" runat="server">
                        ...
                        <asp:TemplateField HeaderText="钩稽" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlGJ"  Target="_blank" ToolTip="钩稽" NavigateUrl='<%#"~/FM_Data/FM_YFInvoice.aspx?Action=Trick&YFGI_CODE="+Eval("YFGI_CODE") %>'
                                    Visible='<%#Eval("YFGI_STATE").ToString()=="0"?false:Eval("YFGI_GJFLAG").ToString()=="0"?true:false %>'
                        ...
                        <asp:TemplateField HeaderText="反钩稽" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlFGJ" Target="_blank" ToolTip="反钩稽" NavigateUrl='<%#"~/FM_Data/FM_YFInvoice.aspx?Action=TrickReject&YFGI_CODE="+Eval("YFGI_CODE") %>'
                                    Visible='<%#Eval("YFGI_GJFLAG").ToString()=="0"?false:Eval("YFGJ_HSSTATE").ToString()=="0"?true:false %>'
                                    CssClass="link" runat="server">
                        ...
                        <asp:TemplateField HeaderText="查看" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:HyperLink ID="hlCK" Target="_blank" ToolTip="查看" NavigateUrl='<%#"~/FM_Data/FM_YFInvoice.aspx?Action=View&YFGI_CODE="+Eval("YFGI_CODE") %>'
                                    CssClass="link" runat="server">
