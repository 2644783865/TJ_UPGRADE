<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_WXDIF.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_WXDIF" Title="无标题页" %>
                                            ...
                                            <asp:TemplateField HeaderText="名称">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:DropDownList ID="DropDownListName" runat="server" Width="128px" Style="display: none">
                                                        ...
                                                        <asp:ListItem Value="DIF_JSDH">结算单号</asp:ListItem>
                                                        <asp:ListItem Value="DIF_WXJID">外协件编号</asp:ListItem>
                                                        <asp:ListItem Value="DIF_WXJNAME">外协件名称</asp:ListItem>
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                ...
                <asp:Repeater ID="rptProNumCost" runat="server" OnItemDataBound="rptProNumCost_OnItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr class="baseGadget" align="center" onmouseover="this.className='highlight'" onclick="javascript:change(this);"
                            ...
                            <td align="center">
                                <asp:Label ID="lbrwh" runat="server" Enabled="false" Text='<%#Eval("DIF_TSAID")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbyear" runat="server" Enabled="false" Text='<%#Eval("DIF_YEAR")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbmonth" runat="server" Enabled="false" Text='<%#Eval("DIF_MONTH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbjsddate" runat="server" Enabled="false" Text='<%#Eval("DIF_JSDDATE")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbjsdh" runat="server" Enabled="false" Text='<%#Eval("DIF_JSDH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbjhgzh" runat="server" Enabled="false" Text='<%#Eval("DIF_JHGZH")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbwxjmc" runat="server" Enabled="false" Text='<%#Eval("DIF_WXJNAME")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbwxjbh" runat="server" Enabled="false" Text='<%#Eval("DIF_WXJID")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbjsdje" runat="server" Enabled="false" Text='<%#Eval("DIF_JSDYJE")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbfpje" runat="server" Enabled="false" Text='<%#Eval("DIF_FPJE")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lbce" runat="server" Enabled="false" Text='<%#Eval("DIF_DIFMONEY")%>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
