<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_FromJSD_ToInv.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_FromJSD_ToInv" Title="无标题页" %>
                     ...
                     <div class="box-title">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<%--筛选--%>
                                <asp:Button ID="btnXTFP" runat="server" Text="下推发票" OnClick="btnXTFP_Click"  />                            </td>
                            <td align="right" style="width: 10%">
                                <a href="FM_wxInvoice_Managemnt.aspx" title="返回到外协发票管理界面">
                                    返回</a> &nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                    </table>
                                            ...
                                            <asp:TemplateField HeaderText="名称">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:DropDownList ID="DropDownListName" runat="server" Width="128px" Style="display: none">
                                                        ...
                                                        <asp:ListItem Value="TA_DOCNUM">结算单号</asp:ListItem>
                                                        <asp:ListItem Value="TA_SUPPLYNAME">供应商</asp:ListItem>
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="this.className='highlight'" onclick="javascript:change(this);"
                                ...
                                <td runat="server" align="center">
                                    <asp:Label ID="lbjsdh" runat="server" Text='<%#Eval("TA_DOCNUM")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center" style="background-color:#98FB98">
                                    <asp:Label ID="lbdate" runat="server" Text='<%#Eval("TA_ZDDATE")%>'></asp:Label>
                                </td>
                                <td id="Td1" runat="server" align="center">
                                    <asp:Label ID="lbgysmc" runat="server" Text='<%#Eval("TA_SUPPLYNAME")%>'></asp:Label>
                                </td>
                                <td id="Td2" runat="server" align="center">
                                    <asp:Label ID="lbzdrxm" runat="server" Text='<%#Eval("TA_ZDRNAME")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbjhgzh" runat="server" Text='<%#Eval("TA_PTC")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbrwh" runat="server" Text='<%#Eval("TA_ENGID")%>'></asp:Label>
                                </td>
                                
                                <td runat="server" align="center">
                                    <asp:Label ID="lbtuhao" runat="server" Text='<%#Eval("TA_TUHAO")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbmname" runat="server" Text='<%#Eval("TA_MNAME")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbsl" runat="server" Text='<%#Eval("TA_NUM")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbzl" runat="server" Text='<%#Eval("TA_WGHT")%>'></asp:Label>
                                </td>
                                
                                <td runat="server" align="center">
                                    <asp:Label ID="lbdj" runat="server" Text='<%#Eval("PRICE")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbje" runat="server" Text='<%#Eval("MONEY")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbshuilv" runat="server" Text='<%#Eval("PIC_SHUILV")%>'></asp:Label>
                                </td>
                                
                                
                                <td runat="server" align="center">
                                    <asp:Label ID="lbhsdj" runat="server" Text='<%#Eval("TA_PRICE")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbhsje" runat="server" Text='<%#Eval("TA_MONEY")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbwxtype" runat="server" Text='<%#Eval("TA_WXTYPE")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
