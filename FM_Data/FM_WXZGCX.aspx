<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_WXZGCX.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_WXZGCX" Title="无标题页" %>
                    ...
                    <asp:Repeater ID="rptProNumCost" runat="server" OnItemDataBound="rptProNumCost_OnItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr class="baseGadget" onmouseover="this.className='highlight'" onclick="javascript:change(this);"
                                ...
                                <td runat="server" align="center">
                                    <asp:Label ID="lbfpje" runat="server" Text='<%#Eval("WXGJ_JE")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbfphsje" runat="server" Text='<%#Eval("WXGJ_HSJE")%>'></asp:Label>
                                </td>
                                <td runat="server" align="center">
                                    <asp:Label ID="lbfpbh" runat="server" Text='<%#Eval("WXGJ_FPID")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
