<%@ Page Language="C#" MasterPageFile="~/Masters/NoScollRightCotentMaster.Master" AutoEventWireup="true" CodeBehind="FM_YueMo_ChuKu_Accounting.aspx.cs" Inherits="ZCZJ_DPF.FM_Data.FM_YueMo_ChuKu_Accounting" Title="无标题页" %>
                        ...
                        <table style="width: 98%; height: 24px">
                            <tr>
                                ...
                                <td align="center" width="30%">
                                    <asp:Button ID="btn_hs" runat="server" Text="预出库核算" OnClick="btn_hs_Click" OnClientClick="ClientSideClick(this);" UseSubmitBehavior="False"/>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="box-outer">
                    <asp:GridView ID="GridView1" Width="100%" CssClass="toptable" runat="server" DataKeyNames="OutCode"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Standard" HeaderText="规格型号" ItemStyle-HorizontalAlign="Center" />
