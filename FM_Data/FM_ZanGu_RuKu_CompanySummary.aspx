<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FM_ZanGu_RuKu_CompanySummary.aspx.cs" MasterPageFile="~/Masters/RightCotentMaster.Master"
Inherits="ZCZJ_DPF.FM_Data.FM_ZanGu_RuKu_CompanySummary" Title="暂估单据供应商汇总查询" %>
                        ...
                        <td align="center">
                            ...
                            <%--<asp:HyperLink ID="hlksummary" runat="server" Font-Size="Larger" Target="_blank">
                               <asp:Image ID="InfoImage" ImageUrl="~/Assets/images/read.gif" border="0" hspace="2"
                                                    align="absmiddle" runat="server" />按照供货商汇总查询</asp:HyperLink>&nbsp;--%>
                        </td>
                    </tr>
                </table>
                    ...
                    <asp:GridView ID="GridView1" Width="100%" CssClass="toptable grid" runat="server"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:TemplateField HeaderText="查看">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlTask" CssClass="link" runat="server">
