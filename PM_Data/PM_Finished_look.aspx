<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PM_Finished_look.aspx.cs"
    MasterPageFile="~/Masters/RightCotentMaster.Master" Inherits="ZCZJ_DPF.PM_Data.PM_Finished_look" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        function Czbhgx(){
            var SfCzbfgxint="<%=SfCzbfgx()%>";

            if(SfCzbfgxint)
            {
            if(window.confirm('任务号为'+SfCzbfgxint+'存在未经报检或检验不合格的报检子项,是否继续？')){ 
                return true; 
                }else{  
                return false; 
                } 
                    ...
                    <table width="100%">
                        <tr>
                            <td align="right">
                                ...
                                <asp:Button ID="btn_Audit" runat="server" Text="提交审批"  OnClick="btn_Audit_Click" OnClientClick="return Czbhgx()"/>
                                &nbsp;
                                <asp:Button ID="btn_delete" runat="server" Text="删除" OnClick="btn_delete_click" Visible="false" />
                                &nbsp;
                                <asp:Button ID="btn_save" runat="server" Text="保存" OnClick="btn_save_click" Visible="false" />
...
<%--            <asp:TabPanel runat="server" ID="TabPanel2" HeaderText="超送至">
                <ContentTemplate>
                        ...
                        <asp:Panel runat="server" ID="panCS">
                            <table class="tab">
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBoxList runat="server" ID="cbxlCS" RepeatDirection="Horizontal" RepeatColumns="5">
                                        </asp:CheckBoxList>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:TabPanel ID="Tab_rud" runat="server" HeaderText="成品入库单" TabIndex="1">
                <ContentTemplate>
                    <div class="box-wrapper">
                        <div class="box-wrapper">
                            <%-- <div style="height: 6px" class="box_top">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="text-align: left">
                                            入库单号：
                                            <asp:Label ID="lbl_docnum" runat="server"></asp:Label>
                                        </td>
                                        <%--<td style="width: 33%;" align="left">
                                            &nbsp;&nbsp;&nbsp;任&nbsp;&nbsp;务&nbsp;&nbsp;号
                                            <asp:TextBox ID="tb_tsaid" runat="server" ></asp:TextBox>
                                        </td>--%>
                                        <td style="width: 33%;" align="left">
                                            &nbsp;&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;期：
                                                            ...
                                                            <ItemTemplate>
                                                                <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                                                    <td>
                                                                        ...
                                                                        <asp:Label ID="TFI_FATHERID" runat="server" Text='<%#Eval("TFI_FATHERID")%>' Visible="false"></asp:Label>
                                                                        <asp:Label ID="lab_id" runat="server" Text='<%#Eval("ID")%>' Visible="false"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblProj" runat="server" Text='<%#Eval("TFI_PROJ")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblTsa" runat="server" Text='<%#Eval("TSA_ID")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="TFI_ZONGXU" runat="server" Text='<%#Eval("TFI_ZONGXU")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblEngname" runat="server" Text='<%#Eval("TFI_NAME")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblMap" runat="server" Text='<%#Eval("TFI_MAP")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="lblRknum" runat="server" Text='<%#Eval("TFI_RKNUM")%>'></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblNumber" runat="server" Text='<%#Eval("TFI_NUMBER")%>'></asp:Label>
                                                                        <asp:Label ID="lblsingnum" runat="server" Text='<%#Eval("TFI_SINGNUMBER")%>' Visible="false"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblKu" runat="server" Text='<%#Eval("KU")%>'></asp:Label>
                                                                    </td>
                                                                    <td>
