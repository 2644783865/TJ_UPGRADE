<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.Master" CodeBehind="PM_FINISHED_OUT_Audit.aspx.cs" Inherits="ZCZJ_DPF.PM_Data.PM_FINISHED_OUT_Audit" %>
                ...
                <div class="box-wrapper">
                    <div class="box-outer">
                        <table width="100%" align="center" class="nowrap cptable fullwidth">
                            <asp:Repeater ID="TBMP_FINISHED_OUT_Audit_Repeater" runat="server" OnItemDataBound="TBMP_FINISHED_OUT_Audit_Repeater_ItemDataBound">
                                <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    <tr class="baseGadget" onmouseover="this.className='highlight'" onmouseout="this.className='baseGadget'">
                                        ...
                                        <td>
                                        <asp:Label ID="TFO_BIANHAO" runat="server" Text='<%#Eval("TFO_BIANHAO")%>'> </asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Label ID="TFO_ENGNAME" runat="server" Text='<%#Eval("TFO_ENGNAME")%>'></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="TFO_MAP" runat="server" Text='<%#Eval("TFO_MAP")%>'></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="OUTDATE" runat="server" Text='<%#Eval("OUTDATE")%>'></asp:Label>
                                        </td>
                                        <td>
