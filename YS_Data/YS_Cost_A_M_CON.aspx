...
CodeBehind="YS_Cost_A_M_CON.aspx.cs" Inherits="ZCZJ_DPF.YS_Data.YS_Cost_A_M_CON" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="../Controls/UCPaging.ascx" TagName="UCPaging" TagPrefix="uc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="RightContentTitlePlace" runat="server">
    <asp:Label ID="LabelTitle" runat="server" Text="合同成本分析"></asp:Label>
</asp:Content>
                ...
                <table width="100%">
                    <tr>
                        <td style="width: 250px">
                            合同号：<asp:TextBox ID="txt_search" runat="server" Text="" Width="150px">&nbsp; </asp:TextBox><asp:Button ID="search1" runat="server" Text="查 询" OnClick="btn_search_OnClick" />
                ...
                <asp:GridView ID="GridView1" Width="100%" CssClass="toptable grid nowrap" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="YS_RealCost" HeaderText="实际费用合计" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="false" DataFormatString="{0:N2}" />
                        <asp:BoundField DataField="YS_ZZFY" HeaderText="制造费用" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="false" DataFormatString="{0:N2}" />
                      ...
                      <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="材料费合计(预)" HeaderStyle-ForeColor="Green"
                       ...
                       <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="材料费合计(实)" HeaderStyle-Wrap="false"
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="结算时间" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Brown">
                            <ItemTemplate>
                            <asp:HiddenField ID="hidden_YS_Deadtime" runat="Server" Value='<%#Eval("YS_Deadtime") %>'/>
                                <asp:Label ID="YS_Deadtime" runat="server" Text='<%#Eval("YS_Deadtime") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <%--<asp:BoundField DataField="YS_Deadtime" HeaderText="结算时间" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-Wrap="false" />--%>
