                    ...
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rbl_profit" runat="server" AutoPostBack="true" OnSelectedIndexChanged="btn_search_OnClick"
                                ...
                                <asp:ListItem Text="净利润赤字" Value="1"></asp:ListItem>
                                <asp:ListItem Text="净利润非赤字" Value="0"></asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td align="center">
                            项目名称:
        ...
        <div class="box_right">
            <div class="box-title">
                <table width="100%">
                    <tr>
                        <td>
                            合同编号：<asp:TextBox ID="txt_search" runat="server" Text="ZCZJ.SW.XS." Width="150px">
                ...
                <asp:Panel ID="Pal_condition" runat="server" UpdateMode="Conditional">
                    <table width="100%" style="background-color: #CCCCFF; border: solid 1px black;">
                        ...
                        <tr>
                            <td>
                                净 利 润 ：<asp:DropDownList ID="dpl_all_profit" runat="server">
                                    <asp:ListItem Text="--请选择--" Value="0"></asp:ListItem>
                ...
                <asp:GridView ID="GridView1" Width="100%" CssClass="toptable grid nowrap" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="YS_RealCost" HeaderText="实际费用合计" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="false" DataFormatString="{0:N2}" />
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="利润总额(预)" HeaderStyle-ForeColor="#660066"
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="净利润(预)" HeaderStyle-ForeColor="#660066"
                            ...
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    <asp:HiddenField ID="hidden_PROFIT_TAX" runat="Server" Value='<%#Eval("YS_PROFIT_TAX_BG_hide_percent","{0:N2}") %>' />
                                    <div style="width: 100px; position: static; z-index: 100; top: 4px; text-align: left;">
                                        <asp:Label ID="lab_PROFIT_TAX" runat="Server" Text='<%#Eval("YS_PROFIT_TAX_BG","{0:N2}") %>' />
                                    </div>
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth_YS_AMOUNT(Eval("YS_PROFIT_TAX_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="技术外协(预)" HeaderStyle-ForeColor="#660066"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    ...
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth(Eval("YS_OUT_LAB_MAR_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="加工件(预)" HeaderStyle-ForeColor="Brown"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="班组承包(预)" HeaderStyle-ForeColor="Brown"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="制造费用(预)" HeaderStyle-ForeColor="Brown"
                            ...
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    <asp:HiddenField ID="hidden_MANU_COST" runat="Server" Value='<%#Eval("YS_MANU_COST_BG_hide_percent","{0:N2}") %>' />
                                    <div style="width: 100px; position: static; z-index: 100; top: 4px; text-align: left;">
                                        <asp:Label ID="lab_MANU_COST" runat="server" Text='<%#Eval("YS_MANU_COST_BG","{0:N2}") %>'></asp:Label>
                                    </div>
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth(Eval("YS_MANU_COST_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="销售费用(预)" HeaderStyle-ForeColor="Brown"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    <asp:HiddenField ID="hidden_SELL_COST" runat="Server" Value='<%#Eval("YS_SELL_COST_BG_hide_percent","{0:N2}") %>' />
                                    <div style="width: 100px; position: static; z-index: 100; top: 4px; text-align: left;">
                                        <asp:Label ID="lab_SELL_COST" runat="server" Text='<%#Eval("YS_SELL_COST_BG","{0:N2}") %>'></asp:Label>
                                    </div>
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth(Eval("YS_SELL_COST_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="管理费用(预)" HeaderStyle-ForeColor="Brown"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    <asp:HiddenField ID="hidden_MANAGE_COST" runat="Server" Value='<%#Eval("YS_MANAGE_COST_BG_hide_percent","{0:N2}") %>' />
                                    <div style="width: 100px; position: static; z-index: 100; top: 4px; text-align: left;">
                                        <asp:Label ID="lab_MANAGE_COST" runat="server" Text='<%#Eval("YS_MANAGE_COST_BG","{0:N2}") %>'></asp:Label>
                                    </div>
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth(Eval("YS_MANAGE_COST_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="税金及附加(预)" HeaderStyle-ForeColor="Brown"
                            HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <div style="position: static; width: 100px;">
                                    <asp:HiddenField ID="hidden_Taxes_Cost" runat="Server" Value='<%#Eval("YS_Taxes_Cost_BG_hide_percent","{0:N2}") %>' />
                                    <div style="width: 100px; position: static; z-index: 100; top: 4px; text-align: left;">
                                        <asp:Label ID="lab_Taxes_Cost" runat="server" Text='<%#Eval("YS_Taxes_Cost_BG","{0:N2}") %>'></asp:Label>
                                    </div>
                                    <img alt="" src="/YS_Data/update1.jpg" width="<%#GetIMGWidth(Eval("YS_Taxes_Cost_BG_percent").ToString()) %>"
                                        height="9" /><br />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="运费(预)" HeaderStyle-ForeColor="Brown"
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="利润总额(实)" HeaderStyle-Wrap="false"
                        ...
                        <%--<asp:BoundField DataField="YS_PROFIT" HeaderText="利润总额(实)" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="false" DataFormatString="{0:N2}" />
                        <asp:BoundField DataField="YS_PROFIT_TAX" HeaderText="净利润(实)" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="false" DataFormatString="{0:N2}" />--%>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="技术外协(实)" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Black">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="加工件(实)" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Brown">
                            <ItemTemplate>
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="销售费用(实)" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
                                <asp:Label ID="lab_SELL_COST_R" runat="server" Text='<%#Eval("YS_SELL_COST","{0:N2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="管理费用(实)" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
                                <asp:Label ID="lab_MANAGE_COST_R" runat="server" Text='<%#Eval("YS_MANAGE_COST","{0:N2}") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderText="税金及附加(实)" HeaderStyle-Wrap="false"
                            HeaderStyle-ForeColor="Green">
                            <ItemTemplate>
