<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMasterSession.Master" CodeBehind="TM_BulkEdit.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_BulkEdit" %>
...
<JSR:JSRegister ID="JSRegister1" runat="server" />
   ...
   function checkDelete()
   {
    ...
    function ShowSetting()
    {
       ...
       ClearColumns(2);
       CallfunctionOfReplace(3);
       CallfunctionOfConReplace(3);
    }
...
<ContentTemplate>
    ...
    <div class="box-wrapper">
      ...
      <table width="100%">
       <tr>
        <td>&nbsp;&nbsp;&nbsp;<strong style="color:Red;">批量修改数据:</strong></td>
        <td></td>
        <td></td>
         <td align="left">
             <asp:Button ID="btnSave" runat="server" Visible="false" Text="保存" OnClientClick="return BomCheckMaoPi();" OnClick="btnSave_OnClick" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <yyc:SmartGridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="toptable grid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="图号" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <input id="tuhao" runat="server"  style="border-style: none; width: 150px" onfocus="this.select();" type="text" onkeydown="grControlFocusWithoutHiddden2(this);"
                                value='<%#Eval("BM_TUHAO") %>' />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="物料编码" >
                        <ItemTemplate>
                            <asp:TextBox ID="marid" runat="server" ToolTip="物料编码为空时,表明为部件，部件保存后无法修改物料编码！！！" BorderStyle="None"  CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                onchange="autoMarCode(this)"  onfocus="this.select();"  Text='<%# DataBinder.Eval(Container.DataItem, "BM_MARID")%>'
                    ...
                    <asp:TemplateField HeaderText="总序" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="zongxu" runat="server"   style="border-style: none; color:Gray;
                                width: 90px" type="text"  onfocus="this.select();"   value='<%#Eval("BM_ZONGXU") %>' onkeydown="grControlFocusWithoutHiddden2(this);" readonly="readonly"/>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="中文名称">
                        <ItemTemplate>
                            <input id="ch_name" runat="server" onkeydown="grControlFocusWithoutHiddden2(this);"  style="border-style: none; width: 150px" title="请在输入物料编码后再修改此项！！！"
                                type="text" onfocus="this.select();"  value='<%#Eval("BM_CHANAME") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="单台数量|总数量|计划数量"  ItemStyle-Wrap="false" HeaderStyle-Wrap="false">
                        <ItemTemplate>
                            ...
                            |&nbsp;<input id="total_shuliang" runat="server" tabindex="-1" class="notbrk" title="不能修改"  readonly="readonly"  value='<%#Eval("BM_NUMBER")%>' style="border-style: none;width: 36px" type="text" />
                    ...
                    <asp:TemplateField HeaderText="材料总重" >
                        <ItemTemplate>
                            <input id="cailiaozongzhong"  runat="server"  onfocus="this.select();"  onkeydown="grControlFocusWithoutHiddden2(this);"  style="border-style: none;
                                width: 80px;color:Gray;" type="text" value='<%#Eval("BM_MATOTALWGHT") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="面域|计划面域(m2)" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" >
                        <ItemTemplate>
                            <input id="bgzmy" runat="server" onkeydown="grControlFocusWithoutHiddden2(this);"  onchange="autoMyShpace(this)" title="输入单个数量面域即可！！！" style="border-style: none;
                                width: 60px" type="text"  onfocus="this.select();"  value='<%#Eval("BM_MABGZMY") %>' />
                    ...
                    <asp:TemplateField HeaderText="材质" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="caizhi" runat="server"  onfocus="this.select();" onkeydown="grControlFocusWithoutHiddden2(this);" readonly="readonly" style="border-style: none;
                                width: 50px;color:Gray;" type="text" value='<%#Eval("BM_MAQUALITY") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="材料名称" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="cailiaoname" runat="server"  onfocus="this.select();" onkeydown="grControlFocusWithoutHiddden2(this);"  readonly="readonly" style="border-style: none;
                                width: 70px;color:Gray;" type="text" value='<%#Eval("BM_MANAME") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="材料规格" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="cailiaoguige" runat="server"  onfocus="this.select();" onkeydown="grControlFocusWithoutHiddden2(this);" readonly="readonly" style="border-style: none;
                                width: 120px;color:Gray;" type="text" value='<%#Eval("BM_MAGUIGE") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="理论重量" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="lilunzhl" runat="server"   onfocus="this.select();" readonly="readonly" style="border-style: none;
                                width: 56px;color:Gray;" type="text" value='<%#Eval("BM_THRYWGHT") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="总重" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="zongzhong" runat="server"  onfocus="this.select();" onkeydown="grControlFocusWithoutHiddden2(this);" readonly="readonly" style="border-style: none;
                                width: 80px;color:Gray;" type="text" value='<%#Eval("BM_TOTALWGHT") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="单位" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="labunit" runat="server" onkeydown="grControlFocusWithoutHiddden2(this);"  readonly="readonly" style="border-style: none;
                                width: 32px;color:Gray;"  onfocus="this.select();" type="text" value='<%#Eval("BM_MAUNIT") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="国标" ItemStyle-HorizontalAlign="Center" ItemStyle-BackColor="#EDEDED">
                        <ItemTemplate>
                            <input id="biaozhun" runat="server" onkeydown="grControlFocusWithoutHiddden2(this);"  readonly="readonly" style="border-style: none;
                                width: 150px;color:Gray;"  onfocus="this.select();" type="text" value='<%#Eval("BM_STANDARD") %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="工艺流程">
                        <ItemTemplate>
                            <input id="process" runat="server"  onfocus="this.select();"  onkeydown="grControlFocusWithoutHiddden2(this);" style="border-style: none; width: 100px" type="text"
                    ...
                    <asp:TemplateField HeaderText="定尺" >
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlFixedSize" runat="server" SelectedValue='<%#DataBinder.Eval(Container.DataItem, "BM_FIXEDSIZE") %>'  onchange="autoFixSize(this);">
                                <asp:ListItem Text="N" Value="N" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Y" Value="Y"></asp:ListItem>
                            </asp:DropDownList>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="隐藏字段" Visible="false"  >
                        <ItemTemplate>
                           <asp:Label ID="lblxuhao" runat="server" Text='<%#Eval("BM_XUHAO") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                ...
                <FixRowColumn FixRowType="Header" TableHeight="600px"  TableWidth="100%" FixColumns="" />
            </yyc:SmartGridView>
    </div>
    </div> 
    </ContentTemplate>
