<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TM_MS_ZongXuSplit.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_MS_ZongXuSplit" %>
                ...
                <RowStyle BackColor="#EFF3FB" />
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="材料总重(kg)" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <input ID="cailiaozongzhong" runat="server"  style="color:Gray;width:70px" 
                     ...
                     <asp:TemplateField HeaderText="图纸上单重(kg)" ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="材料总长(mm)">
                          <ItemTemplate>
                              <asp:TextBox ID="txtTotalWidth" runat="server"  style="border-style:solid; width:70px" onchange="FloatCheck(this);" Text='<%#Eval("BM_MATOTALLGTH") %>'></asp:TextBox>
                          </ItemTemplate>
                        </asp:TemplateField>
