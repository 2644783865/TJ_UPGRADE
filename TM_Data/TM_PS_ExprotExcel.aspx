<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TM_PS_ExprotExcel.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_PS_ExprotExcel" %>
    ...
    <div class="box-wrapper" style="text-align:center;">
        ...
        <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
          ...
          <tr>
            ...
            <td align="left">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnMsExport" runat="server" Text="导出" OnClientClick="return PsExport(this);" OnClick="btnMsExport_OnClick"  />
                &nbsp;&nbsp;&nbsp;&nbsp;
