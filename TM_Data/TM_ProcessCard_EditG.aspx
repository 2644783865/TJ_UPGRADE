<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TM_ProcessCard_EditG.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_ProcessCard_EditG" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function btnConfirm() {
            var parameter = "txtName=" + $("#txtName").val() + "&txtBANCI=" + $("#txtBANCI").val() +"&hidGuanLianTime=" + $("#hidGuanLianTime").val() + "&txtBZ=" + $("#txtBZ").val() + "&method=" + $("#method").val() + "&proId=" + $("#proId").val();
//            alert(parameter);
            $.ajax({
