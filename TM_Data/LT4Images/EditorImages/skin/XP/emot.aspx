...
<td>
    ...
    <table width="100%">
        <tr>
            <td style="width: 50%">&gt;<a onclick="parent.popupmenu.hide();parent.openDialog(parent.document.getElementById(Request.QueryString('name')).contentWindow,parent.functionstr+'custom.aspx','250','95','emot');"
        style="cursor: pointer" unselectable="on">&gt;<%=ResourceManager.GetString("insertcustomize")%></a>&nbsp;&nbsp;
    &nbsp;
            </td>
