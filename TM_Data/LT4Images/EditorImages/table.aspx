...
var sEL = $("s_"+what);
if(is_ie){
var arr = showModalDialog("selcolor.aspx", "", "dialogWidth:280px; dialogHeight:270px; status:0; help:0;scroll:no");
if (arr) {
dEL.value=arr;
...
{
window.open("selcolor.aspx",null,"modal=yes,width=280px,height=270px,resizable=no,scrollbars=yes,status=no");
}
}
