<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/RightCotentMaster.master" CodeBehind="TM_MS_TEMP_InitData_Change.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_MS_TEMP_InitData_Change" %>
     ...
     function gotoMSAdjustSetOrg()
     {
       ...
       if(result==true)
       {
            ...
            else
            {
                ...
                frame.width=getWidth();
                frame.height=getHeight(); 
                frame.src = "TM_MSAdjustOrgSetInput.aspx?TaskID=<%=tsaid.Text %>&view_table=<%=view_table() %>&Xuhao="+xuhao;
                $find('ViewModalPopup').show();
...
<div class="box-inner">
    ...
    <div class="box-title">
        ...
        <tr>
            ...
            <td>
            台数:<asp:Label ID="lblNumber" runat="server" Text=""></asp:Label>
            </td>
            <td>
           ...
           <asp:ListItem Text="-请选择-" Value="-请选择-"></asp:ListItem>
            ...
            库：<asp:DropDownList ID="ddlKU" runat="server" OnSelectedIndexChanged="Event_Query" AutoPostBack="true">
                   <asp:ListItem Text="-请选择-" Value="-请选择-"></asp:ListItem>
                   <asp:ListItem Text="库" Value="库"></asp:ListItem>
       ...
       <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid">
        ...
        <tr>
                ...
                <td>
                体现:<asp:DropDownList ID="ddlinMS" runat="server" AutoPostBack="True" onselectedindexchanged="Event_Query">
                  <asp:ListItem Text="-请选择-" Value="-请选择-"></asp:ListItem>
                  <asp:ListItem Text="是" Value="Y"></asp:ListItem>
                  <asp:ListItem Text="否" Value="N"></asp:ListItem>
                </asp:DropDownList>&nbsp;&nbsp;</td>
               <td align="right">
                  <asp:DropDownList ID="ddlXH_ZX" runat="server">
                  ...
                  <td align="left"><asp:TextBox ID="txtXH_ZX" runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button ID="btnQuery" runat="server" Text="查 询" OnClick="Event_Query" />
                  </td>
        </tr>
        </table>
        </td>
            <td align="left" rowspan="2">
                <asp:Button ID="btnAddChange" runat="server" style="width:65px"  Text="变更增加项" OnClientClick="return confirm('变更调整时，快速将全部增加项标识为【变更增加】');" OnClick="btnAddChange_Onclick" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:Button ID="btnDataSave" runat="server"  Text="保 存"   OnClientClick="return CheckMS_IN_KU();"  OnClick="btnDataSave_Onclick" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnsave" runat="server" style="width:60px"  Text="重量计算" ToolTip="根据【序号】计算单重和总重！" onclick="btnSave_onClick"/>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnMS" runat="server" style="width:60px"  OnClientClick="return confirm('进入制作明细生成界面？')" Text="明细预览" OnClick="btnMS_OnClick" />
        ...
        <tr>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="bntClear" type="button" value="更多操作" style="width:60px"  onclick="ShowSetting();" />&nbsp;&nbsp;&nbsp;&nbsp;
               <asp:Button ID="btninsert" runat="server" Text="插 入" ToolTip="插入所选行下方/保存上次操作" OnClientClick="return insert()" onclick="btninsert_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;
               <asp:Button ID="btndelete" runat="server" Text="删 除" ToolTip="只在界面上删除,如果删除记录的变更状态为【增加】,则该记录恢复【正常】！" OnClientClick="return check()" onclick="btndelete_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input id="btnKuBiaoshi" type="button" value="库标识号" style="width:60px" onclick="AddKuBiaoshi();" />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input id="btnMSXuhao" type="button" value="明细序号" style="width:60px" onclick="AddMsXuhao();" />
            </td>
               ...
               <tr>
                ...
                <tr><td colspan="8"><hr style="height:0.2px;" /></td></tr> <tr>
           ...
           <div class="box-wrapper">
                <asp:Panel ID="NoDataPanel" runat="server" HorizontalAlign="Center"><span style="font-size:medium"><br />没有记录!</span></asp:Panel>
                 <yyc:SmartGridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="toptable grid"  OnRowDataBound="GridView1_RowDataBound"   CellPadding="4" ForeColor="#333333" Width="100%">
                <RowStyle BackColor="#EFF3FB" />
                   <FooterStyle BackColor="White" ForeColor="#000066" HorizontalAlign="Center" />
                    ...
                    <asp:TemplateField HeaderText="明细序号" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                        <ItemTemplate>
                            <input ID="MsIndex" onkeydown="grControlFocus(this)" ondblclick="ShowInput(this);" onfocus="AutoMsXuhao(this);this.select();" disabled='<%#Eval("BM_MSSTATUS").ToString()=="1"?true:false %>' runat="server" style="border-style:none; width:60px;" type="text" value='<%#Eval("BM_MSXUHAO") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                    <asp:TemplateField HeaderText="序号" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                        <ItemTemplate>
                            <input ID="Index" onkeydown="grControlFocus(this)"  ondblclick="ShowInput(this);" title="不能为空！！！" disabled='<%#Eval("BM_MSSTATUS").ToString()=="1"?true:false %>' runat="server" onfocus="DefaultXuHao(this);this.select();" onclick="XuHaoSame(this);" onchange="copyXuhao(this)" style="border-style:none;width:90px;"  type="text" value='<%#Eval("BM_XUHAO") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                     <asp:TemplateField HeaderText="图号(标识号)" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                        <ItemTemplate>
                            <input ID="tuhao" onkeydown="grControlFocus(this)" runat="server" ondblclick="ShowInput(this);" style="border-style:none;" onfocus="this.select();"   onblur="msAutoTuHao(this);"
                                    type="text" value='<%#Eval("BM_TUHAO") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                                        
                     <asp:TemplateField HeaderText="总序" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                        <ItemTemplate>
                            <input ID="zongxu" onkeydown="grControlFocus(this)" disabled='<%#Eval("BM_MSSTATUS").ToString()=="1"?true:false %>' runat="server" style="border-style:none;width:90px;"  
                    ...
                    <asp:TemplateField  HeaderText="名称" ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false">
                       <ItemTemplate>
                           <asp:TextBox ID="txtName" runat="server" onkeydown="grControlFocus(this)" ondblclick="ShowInput(this);" onfocus="this.select();"  style="border-style:none;" Text='<%#Eval("BM_CHANAME") %>'></asp:TextBox>
                       </ItemTemplate>
                    </asp:TemplateField>                    

                     <asp:TemplateField ItemStyle-HorizontalAlign="Center"  HeaderText="体现" HeaderStyle-Wrap="false">
                          <ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="库" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false">
                           <ItemTemplate>
                             <input ID="ku" onkeydown="grControlFocus(this)" onfocus="findChoice(this,2,8);this.select();"  onchange="ChangeGYLC(this);"  runat="server" style="border-style:none; width:40px"  type="text" value='<%#Eval("BM_KU") %>' />
                    ...
                    <asp:TemplateField HeaderText="规格" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false">
                           <ItemTemplate>
                             <input ID="guige" runat="server" onkeydown="grControlFocus(this)" ondblclick="ShowInput(this);" onfocus="this.select();" style="border-style:none;width:100px;" type="text" value='<%#Eval("BM_GUIGE") %>' />
                           </ItemTemplate>
                   </asp:TemplateField>                    
                   ...
                   <asp:TemplateField HeaderText="工艺流程" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false">
                           <ItemTemplate>
                             <input ID="process" onkeydown="grControlFocus(this)" onfocus="findChoice(this,3,11);this.select();"  onchange="ChangeGYLC(this);"  runat="server" style="border-style:none;width:80px;"   type="text" value='<%#Eval("BM_PROCESS") %>' />
                           <div  class="hidden" style="position:absolute;background-color:#f3f3f3; cursor:hand; border: #B9D3EE 3px solid; padding:0px; margin:0px;">
                                   <ul   style="list-style-type:square;text-align:left; line-height:normal;"></ul>
                                </div>
                           </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="备注" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false">
                           <ItemTemplate>
                             <input ID="beizhu" onkeydown="grControlFocus(this)" onclick="ShowInput(this);" runat="server" onfocus="this.select();" style="border-style:none;"  type="text" value='<%#Eval("BM_NOTE") %>' />
                           </ItemTemplate>
                   </asp:TemplateField>

                     <asp:TemplateField HeaderText="变更状态"  ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false">
                            <ItemTemplate>
                                <asp:Label ID="lblChangeSta" runat="server"  ForeColor="Red" Text='<%#Eval("BM_MSSTATUS").ToString()=="1"?"删除":Eval("BM_MSSTATUS").ToString()=="2"?"增加":Eval("BM_MSSTATUS").ToString()=="3"?"修改":"" %>'></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    
                    <asp:BoundField DataField="BM_MAQUALITY" HeaderText="材质"  ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false" ItemStyle-Wrap="false" />
                    
                    
                    <asp:BoundField DataField="BM_UNITWGHT"  DataFormatString="{0:f2}" HeaderText="单重(kg)" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"/>

                    <asp:BoundField DataField="BM_TOTALWGHT"  DataFormatString="{0:F2}" HeaderText="总重(kg)" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"/>

                        <asp:BoundField DataField="BM_MASHAPE"  HeaderText="毛坯" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"/>
                        <asp:BoundField DataField="BM_MASTATE"  HeaderText="状态" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"/>

                        <asp:BoundField DataField="BM_STANDARD"  HeaderText="国标" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false"  ItemStyle-Wrap="false" />
                        <asp:BoundField DataField="BM_KEYCOMS"  HeaderText="关键部件" ItemStyle-HorizontalAlign="Center"  HeaderStyle-Wrap="false" />

                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="0">
                           <ItemTemplate>
