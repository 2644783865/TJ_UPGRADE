...
{
    public partial class TM_Gongshi_Edit : System.Web.UI.Page
    {
        string sqlText = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ProId == "0")
                {
                    ...
                    method.Value = "GongShiNew";
                }
                else
                {

                    method.Value = "GongShiEdit";
                    this.InitPage(ProId);
                }
            }
        }
        ...
        private void InitPage(string proid)
        {
            ...
            sqlText = "select * from View_TM_GONGSHI where PRO_ID=" + proid;
