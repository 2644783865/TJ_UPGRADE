<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.master" AutoEventWireup="true" CodeBehind="TM_MS_Detail_Change_Audit.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_MS_Detail_Change_Audit" %>
    ...
    <ContentTemplate>
         <asp:Panel ID="Panel2" runat="server"  style="height:320px; width:100%; position:static">
            <yyc:SmartGridView ID="GridView2" width="100%" CssClass="toptable grid" 
                ...
                <asp:BoundField DataField="MS_TUHAO" HeaderText="图号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_ZONGXU" HeaderText="总序" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_NAME" HeaderText="名称" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"/>
                <asp:BoundField DataField="MS_GUIGE" HeaderText="规格" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_CAIZHI" HeaderText="材质" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px"/>
                <asp:BoundField DataField="MS_UNUM" HeaderText="数量" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_UWGHT" HeaderText="单重" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_TLWGHT" HeaderText="总重" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_PROCESS" HeaderText="工艺流程" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_TIMERQ" HeaderText="箱号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
                <asp:BoundField DataField="MS_ENVREFFCT" HeaderText="说明" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px"/>
    ...
    <ContentTemplate>
        <asp:Panel ID="Panel1" runat="server"  style="height:320px; width:100%;position:static">
            <yyc:SmartGridView ID="GridView1" width="100%" CssClass="toptable grid" 
                ...
                <asp:TemplateField HeaderText="图号" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="100px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_tuhao" runat="server" Width="100px" Text='<%# Eval("MS_TUHAO") %>'></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="100px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="总序" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_zongxu" runat="server" Width="70px" Text='<%# Eval("MS_ZONGXU") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="70px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="名称" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_name" runat="server" Width="60px" Text='<%# Eval("MS_NAME") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"/>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="规格" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_guige" runat="server" Width="60px" Text='<%# Eval("MS_GUIGE") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="材质" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="48px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_caizhi" runat="server" Width="48px" Text='<%# Eval("MS_CAIZHI") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="48px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="数量" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="48px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_num" runat="server" Width="48px" Text='<%# Eval("MS_UNUM") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="48px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="单重" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="60px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_uwght" runat="server" Width="60px" Text='<%# Eval("MS_UWGHT") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="总重" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_tlwght" runat="server" Width="80px" Text='<%# Eval("MS_TLWGHT") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="工艺流程" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_process" runat="server" Width="80px" Text='<%# Eval("MS_PROCESS") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="箱号" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_caseno" runat="server" Width="80px" Text='<%# Eval("MS_TIMERQ") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="80px" />
                    </asp:TemplateField>
                <asp:TemplateField HeaderText="说明" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_explain" runat="server" Width="80px" Text='<%# Eval("MS_ENVREFFCT") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="备注" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <asp:TextBox ID="txt_note" runat="server" Width="80px" Text='<%# Eval("MS_NOTE") %>' BorderStyle="None"></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:TemplateField>  
                </Columns>
