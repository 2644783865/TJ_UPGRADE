<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="TM_GongShi_List.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_GongShi_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function openLinkGen(url) {
            var returnVlue = window.showModalDialog("TM_Gongshi_Edit.aspx?Id=" + url, '', "dialogHeight:240px;dialogWidth:500px;status:no;scroll:yes;center:yes;toolbar=no;menubar=no");
        }
    </script>
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <asp:DropDownList ID="ddlGeneralProCard" runat="server" Height="20px">
                                <asp:ListItem Text="工时名称" Value="PRO_NAME"></asp:ListItem>
                                <asp:ListItem Text="工时版次" Value="PRO_BANCI"></asp:ListItem>
                        ...
                        <td align="right">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="openLinkGen(0)" CssClass="link"> <asp:Image ID="Image1" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                                align="absmiddle" runat="server" />新增工时明细</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <yyc:SmartGridView ID="GridView2" Width="100%" CssClass="toptable grid" runat="server"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="PRO_NAME" HeaderText="工时名称">
                <HeaderStyle Wrap="False" />
                <ItemStyle HorizontalAlign="Center" Wrap="False" />
            </asp:BoundField>
            <asp:BoundField DataField="PRO_BANCI" HeaderText="工时版次">
                <HeaderStyle Wrap="False" />
                <ItemStyle HorizontalAlign="Center" Wrap="False" />
            </asp:BoundField>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                <ItemTemplate>
                    <asp:HyperLink ID="hlTask4" CssClass="link" NavigateUrl='<%#"TM_GongShi_Audit.aspx?Id="+Eval("PRO_ID")%>'
                        runat="server">
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                <ItemTemplate>
                    <asp:HyperLink ID="hlTask5" CssClass="link" NavigateUrl='<%#"TM_GongShi_Audit.aspx?auditId="+Eval("PRO_ID")%>'
                        runat="server">
            ...
            <asp:TemplateField HeaderText="操  作">
                <ItemTemplate>
                    <asp:LinkButton ID="hlDelete1" CssClass="link" runat="server" CausesValidation="False"
                        OnClick="hlDelete_OnClick" CommandArgument='<%#Eval("PRO_ID")%>' OnClientClick="return confirm(&quot;确认删除该条工艺卡片么？&quot;)">
