<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="TM_ProcessCard_List_Gen.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_ProcessCard_List_Gen" %>
    ...
    <yyc:SmartGridView ID="GridView2" Width="100%" CssClass="toptable grid" runat="server"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                <ItemTemplate>
                    <asp:HyperLink ID="hlTask4" CssClass="link" NavigateUrl='<%#"TM_ProcessCard_AuditG.aspx?Id="+Eval("PRO_ID")%>'
                        runat="server">
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                <ItemTemplate>
                    <asp:HyperLink ID="hlTask5" CssClass="link" NavigateUrl='<%#"TM_ProcessCard_AuditG.aspx?auditId="+Eval("PRO_ID")%>'
                        runat="server">
