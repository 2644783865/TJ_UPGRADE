...
{
    public partial class TM_Gongshi_Audit : System.Web.UI.Page
    {
        string sqlText;
        string status;
        string level;
        ...
        private void Iinit()
        {
            ...
            sqlText = "select * from View_TM_GONGSHI where PRO_ID='" + hidProId.Value + "'";
            ...
            if (this.AuditPowerCheck())
            {
                ...
                if (this.CheckSelect(checklevel))
                {
                    ...
                    switch (status)
                    {
                        case "1":
                            #region 提交状态
                            sqlText = "update TBPM_GONGSHI set PRO_SUBMITID='" + Session["UserID"] + "',PRO_REVIEWA='" + firstid.Value + "',PRO_STATE='2',PRO_CHECKLEVEL='" + rblSHJS.SelectedValue + "',PRO_ISSUEDTIME='" + reviewdate + "'  where PRO_ID='" + hidProId.Value + "'";
                        ...
                        case "2":
                            ...
                            if (checklevel == 1)
                            {
                                ...
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='8',PRO_REVIEWAADVC='" + first_opinion.Text.Trim() + "',PRO_REVIEWATIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                    flag = "3";
                                }
                                else if (rblfirst.SelectedIndex == 1)//一级驳回
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='" + rblfirst.SelectedValue + "',PRO_REVIEWAADVC='" + first_opinion.Text.Trim() + "',PRO_REVIEWATIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                    flag = "2";
                                }
                            }
                            else if (checklevel > 1)
                            {
                                ...
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_STATE='" + rblfirst.SelectedValue + "',PRO_REVIEWAADVC='" + first_opinion.Text.Trim() + "',PRO_REVIEWATIME='" + reviewdate + "',PRO_REVIEWB='" + secondid.Value + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                    flag = "1";
                                }
                                else if (rblfirst.SelectedIndex == 1)//一级驳回
                        ...
                        case "4":
                            ...
                            if (checklevel == 2)
                            {
                                ...
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='8',PRO_REVIEWBADVC='" + second_opinion.Text.Trim() + "',PRO_REVIEWBTIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                ...
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='" + rblsecond.SelectedValue + "',PRO_REVIEWBADVC='" + second_opinion.Text.Trim() + "',PRO_REVIEWBTIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                    flag = "2";
                                }
                            }
                            else if (checklevel > 2)
                            {
                                ...
                                {
                                    sqlText = "update TBPM_GONGSHI set PRO_STATE='" + rblsecond.SelectedValue + "',PRO_REVIEWBADVC='" + second_opinion.Text.Trim() + "',PRO_REVIEWBTIME='" + reviewdate + "',PRO_REVIEWC='" + thirdid.Value + "' where PRO_ID='" + hidProId.Value + "'";
                                    list_sql.Add(sqlText);
                                    flag = "1";
                                }
                        ...
                        case "6":
                            ...
                            {
                                sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='8',PRO_REVIEWCADVC='" + third_opinion.Text.Trim() + "',PRO_REVIEWCTIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                list_sql.Add(sqlText);
                            ...
                            {
                                sqlText = "update TBPM_GONGSHI set PRO_ADATE='" + reviewdate + "',PRO_STATE='" + rblthird.SelectedValue + "',PRO_REVIEWCADVC='" + third_opinion.Text.Trim() + "',PRO_REVIEWCTIME='" + reviewdate + "' where PRO_ID='" + hidProId.Value + "'";
                                list_sql.Add(sqlText);
                                flag = "2";
                            }
                            break;
                    ...
                    if (flag == "0")
                    {
                        if (ckbMessage.Checked)
                        {
                            ...
                            _subject = "您有新的【工时管理】需要审批，请及时处理 " + lblName.Text.Trim() + "_" + hidProId.Value.Trim();
                    ...
                    else if (flag == "2")
                    {
                        if (ckbMessage.Checked)
                        {
                          ...
                          + "\r\n编    号：" + hidProId.Value
                            ...
                            _subject = "工时卡片已驳回: " + lblName.Text.Trim() + "_" + hidProId.Value.Trim() + "";
                            DBCallCommon.SendEmail(_emailto, null, null, _subject, _body);
                        }
                    ...
                    else if (flag == "3")
                    {
                        if (ckbMessage.Checked)
                        {
                          ...
                          + "\r\n编    号：" + hidProId.Value
                            ...
                            _subject = "工时卡片已经审核通过: " + lblName.Text.Trim() + "_" + hidProId.Value.Trim() + "";
                            DBCallCommon.SendEmail(_emailto, null, null, _subject, _body);
                        }
