<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMaster.master" AutoEventWireup="true" CodeBehind="TM_Notice_Detail.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_Notice_Detail" %>
...
<div class="RightContent">
     <div class="box-inner">
         <div class="box_right">
             <div class="box-title">
                 <table width="100%" >
                    <tr><td> 任务信息(带<span class="red">*</span>号的为必填项)</td></tr>
                 </table>
             </div>
         </div>
     </div>
        ...
        <div class="box-outer">
           <table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1">
                ...
                <tr>
                    ...
                    <td class="tdright">
                    <asp:TextBox ID="remark" runat="server" TextMode="MultiLine" Rows="3" Width="500px"></asp:TextBox></td>
                </tr>
