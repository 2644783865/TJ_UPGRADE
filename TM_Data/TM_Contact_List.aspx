<%@ Page Language="C#" validateRequest="false" AutoEventWireup="true" CodeBehind="TM_Contact_List.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_Contact_List" %>
 ...
 <form id="form1" runat="server">
       <div class="RightContentTop">
        ...
        <div class="RightContentTitle">
            <table width="100%">
                <tr>
                    <td width="15">
                        <asp:Image ID="Image2" AlternateText="关闭左边管理菜单" 
                        style="CURSOR: hand" onClick="switchBar(this)"  CssClass="CloseImage" 
                        ImageUrl="~/Assets/images/bar_hide.gif" runat="server" />
                    </td>
                    <td>部门联系单管理</td>
                    <td width="15">
                        <asp:Image ID="Image3" ImageUrl="~/Assets/images/bar_up.gif" 
                        AlternateText="隐藏" style="CURSOR: hand" onClick="switchTop(this)" runat="server" />
                    </td>
                </tr>
            </table>
       </div> 
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
       ...
       <table width="96%">
        ...
        <tr align="center">
            <td style=" font-size:large; text-align:center;" colspan="4">
                联系单
            </td>
        </tr>
        <tr align="center">
        <td align="right">项目名称：</td>
        <td align="left" style="height:42px" valign="top">
            <asp:ComboBox ID="ComboBox1" runat="server" Width="60px" AutoPostBack="true" 
                onselectedindexchanged="ComboBox1_SelectedIndexChanged">
            </asp:ComboBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="tbproject" runat="server" Width="100px" Enabled="false" ></asp:TextBox>
        </td>
        
        <td align="right">工程名称：</td>
        <td align="left" style="height:42px" valign="top">
            <asp:ComboBox ID="ComboBox2" runat="server" Width="120px" AutoPostBack="true" 
                onselectedindexchanged="ComboBox2_SelectedIndexChanged">
            </asp:ComboBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="engname" runat="server" Enabled="false" ></asp:TextBox>
        </td>
