<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RightCotentMaster.Master"
    AutoEventWireup="true" CodeBehind="TM_ProcessCard_AuditP.aspx.cs" Inherits="ZCZJ_DPF.TM_Data.TM_ProcessCard_AuditP" %>
        ...
        <div class="box-outer">
            <table align="center" width="100%" cellpadding="4" cellspacing="1" class="toptable grid"
                ...
                <tr>
                    ...
                    <td style="width: 40%">
                        <asp:Label ID="lblEngname" runat="server" Width="100%" />
                    </td>
                    <td style="width: 10%" align="center">
                        设备型号
                    </td>
                    <td style="width: 40%">
                        <asp:Label ID="lblEngType" runat="server" Width="100%" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 10%" align="center">
                    ...
                    <td style="width: 40%">
                        <asp:Label ID="lblPartName" runat="server" Width="100%" />
                    </td>
                    <td style="width: 10%" align="center">
                        图号
                    </td>
