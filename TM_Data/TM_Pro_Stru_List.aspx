<%@ Page Language="C#" MasterPageFile="~/Masters/RightCotentMasterSession.Master"
    EnableEventValidation="false" AutoEventWireup="true" CodeBehind="TM_Pro_Stru_List.aspx.cs"
    Inherits="ZCZJ_DPF.TM_Data.TM_Pro_Stru_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrimaryContent" runat="server">
    ...
    <script type="text/javascript">
       ...
       function clyl(input){
            ...
            tr[index].getElementsByTagName("td")[17].getElementsByTagName("input")[0].value = num * parseInt(tr[index].getElementsByTagName("td")[11].getElementsByTagName("input")[0].value);
           }
...
//                    tr[index].getElementsByTagName("td")[13].getElementsByTagName("input")[0].value = lilunzl * num * parseInt(tr[index].getElementsByTagName("td")[11].getElementsByTagName("input")[0].value);
                    tr[index].getElementsByTagName("td")[14].getElementsByTagName("input")[0].value = lilunzl;
                    tr[index].getElementsByTagName("td")[15].getElementsByTagName("input")[0].value = lilunzl * num * parseInt(tr[index].getElementsByTagName("td")[11].getElementsByTagName("input")[0].value);
                    ...
                    if (child_marid == "01.09") {
                       ...
                       else if (child_marid == "01.17") {
                        tr[index].getElementsByTagName("td")[20].getElementsByTagName("input")[0].value = "协";
                        tr[index].getElementsByTagName("td")[2].getElementsByTagName("input")[0].value = marids[9];
                        tr[index].getElementsByTagName("td")[17].getElementsByTagName("input")[0].value = num;
                    }
...
//                    tr[index].getElementsByTagName("td")[13].getElementsByTagName("input")[0].value = lilunzl * num * parseInt(tr[index].getElementsByTagName("td")[11].getElementsByTagName("input")[0].value);
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
                    ...
                    <div class="box-title">
                        <table width="96%">
                            <tr>
                                ...
                                <td>
                                    数量:<asp:TextBox ID="lblNumber" runat="server" Width="40px" onblur='var pattem=/^\d{1,3}?$/; if(!pattem.test(this.value)){alert("请输入正确的数值！！！");this.value="1";this.foucs();}'></asp:TextBox>
                                </td>
                                <td align="right">
            ...
            <div>
                <table width="100%" align="center" cellpadding="4" cellspacing="1" class="toptable grid">
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="HyperLink4" CssClass="hand" runat="server">
                                <asp:Image ID="Image3" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                                    align="absmiddle" runat="server" />快捷操作</asp:HyperLink>
                            <input id="lblshortcut" runat="server" readonly="readonly" style="color: Red; background-color: Transparent;
                                border-style: none; width: 100px;" value="(当前:序)" type="text" />
                            <asp:HyperLink ID="HyperLink5" CssClass="hand" runat="server" onclick="ShowSetting();">
                                <asp:Image ID="Image4" ImageUrl="~/Assets/images/create.gif" border="0" hspace="2"
                                    align="absmiddle" runat="server" />设置...</asp:HyperLink>
                            <cc1:HoverMenuExtender ID="HoverMenuExtender6" TargetControlID="HyperLink4" OffsetX="0"
                                OffsetY="20" PopupControlID="Panel6" runat="server">
                            </cc1:HoverMenuExtender>
                            <asp:Panel ID="Panel6" runat="server" Style="display: none;" Width="200">
                                <table style='background-color: #f3f3f3; border: #B9D3EE 3px solid; font-size: 10pt;
                                    font-family: Verdana;' cellspacing='0' cellpadding='3'>
                                    <tr>
                                        <td>
                                            自动添加图号:<input id="ckbTuhao" type="checkbox" runat="server" onclick="Fast_Op(this);"
                                                title="勾选后,将鼠标放置到要复制的单元格中,按“↓”键复制至下一单元格" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            连接前缀图号:<input id="ckbJZTuhao" type="checkbox" runat="server" onclick="Fast_Op(this);" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            自动添加序号:<input id="ckbXuhao" type="checkbox" runat="server" onclick="Fast_Op(this);"
                                                checked="checked" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            连接前缀序号:<input id="ckbJZXuhao" type="checkbox" runat="server" onclick="Fast_Op(this);" />
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
                        ...
                        <td>
                            <input id="btnImprotTip" type="button" onclick="ShowProTip();" style="color: Red;
                                width: 60px" value="重要提示" />
                        </td>
                        <td align="center">
                            <asp:Button ID="btnsave" runat="server" Text="保存" Width="40" OnClientClick="BomInputCheck();"
                                OnClick="btnsave_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;<input id="btnCheck" type="button" visible="false" style="display: none;"
                                onclick="alert('此功能正在开发！！！');" value="数据检查" />
                        </td>
                        <%-- <td>
                            <input id="btnPreOne" runat="server" type="button" onclick="ShowLastFive();" style="width: 60px;"
                                value="最近输入" />
                        </td>--%>
                        <td>
                        ...
                        <%--  <td>
                            <asp:HyperLink ID="hkoutside" runat="server" Target="_blank">
                                <asp:Image ID="AddImage1" ImageUrl="~/Assets/images/create.gif" border="0" hspace="0"
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;<asp:HyperLink ID="hylClear" runat="server">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBoxList ID="ckbClearColumns" RepeatColumns="3" RepeatDirection="Horizontal"
                                                ...
                                                <asp:ListItem Text="材料长度/总长" Value="8-cailiaocd,29-cailiaozongchang"></asp:ListItem>
                                                <asp:ListItem Text="数量" Value="11-shuliang"></asp:ListItem>
                                                <asp:ListItem Text="总序" Value="3-zongxu"></asp:ListItem>
                                                <asp:ListItem Text="材料宽度" Value="9-cailiaokd"></asp:ListItem>
                                                <asp:ListItem Text="图纸单重/图纸总重" Value="13-dzh,15-zongzhong"></asp:ListItem>
                                                <asp:ListItem Text="面域" Value="19-bgzmy"></asp:ListItem>
                                                <asp:ListItem Text="材料单重/总重" Value="16-cailiaodzh,17-cailiaozongzhong"></asp:ListItem>
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div id="clear_div" class="hidden" style="position: relative; background-color: #f3f3f3;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <strong>前缀图号:</strong><input id="txtJZTuhao" style="width: 100px;" runat="server"
                                type="text" />
                        </td>
                        <td>
                            <strong>前缀序号:</strong><input id="txtJZXuhao" style="width: 100px;" runat="server"
                                type="text" />
                        </td>
                        <td>
                            &nbsp;&nbsp;&nbsp;<input id="btnClose" type="button" onclick="CloseDiv();" value="关 闭" />
                        </td>
                        <td id="td_select">
                        </td>
                    ...
                    <tr>
                        <td align="center">
                            <strong>倍乘数量:</strong><input id="txtXiShu" style="width: 20px;" value="1" type="text"
                                onblur='var pattem=/^\d{1,2}?$/; if(!pattem.test(this.value)){alert("请输入正确的数值！！！");this.value="1";this.foucs();}' />
                        </td>
                        <td>
            ...
            <asp:CheckBoxList ID="cklHiddenShow" runat="server" RepeatDirection="Horizontal"
                RepeatColumns="16" OnSelectedIndexChanged="cklHiddenShow_OnSelectedIndexChanged"
                ...
                <yyc:SmartGridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="toptable grid"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="下料备注">
                            <ItemTemplate>
                                <input id="note" runat="server" style="border-style: none; width: 300px" type="text"
                        ...
                        <asp:TemplateField HeaderText="单台数量|总数量|计划数量" HeaderStyle-Wrap="false" ItemStyle-Wrap="false">
                            <ItemTemplate>
                                <input id="shuliang" runat="server" onchange="autoshuliang(this)" class="notbrk"
                                    ...
                                    onfocus="this.select();" onkeydown="grControlFocus(this)" onkeyup="clyl(this)" />
                        ...
                        <asp:TemplateField HeaderText="图纸总重(kg)">
                            <ItemTemplate>
                                <input id="tuzhiZZ" runat="server" title="kg" style="border-style: none; width: 50px"
                                    type="text" value='<%#Eval("BM_TUUNITTOTALWGHT") %>' onfocus="this.select();"
                                    onkeydown="grControlFocus(this)" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="备注" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false">
                            <ItemTemplate>
                                <input id="zongbeizhu" runat="server" onfocus="this.select();" onkeydown="grControlFocus(this)"
                                    style="border-style: none; width: 300px;" type="text" value='<%#Eval("BM_ALLBEIZHU") %>' /><br />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
            ...
            <div>
                ...
                <input id="hidSave" type="hidden" runat="server" value="1" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
